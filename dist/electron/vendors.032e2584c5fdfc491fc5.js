  ...
  [371, 32],
  {
    2703: function (e, t, s) {
      ...
      (function (e) {
        ...
        const g = "Bitcoin gold",
          m = "BTG",
          p = "m/44'/156'/0'/0/0",
          w = 8,
          k = "0",
          v = 2,
          { BITCOINJS: y } = a.LIB_NAME_INDEX;
        var x = new WeakMap();
        class BTGCoin extends (0, l.BitcoinJSMixin)(
          ...
          constructor(e) {
            ...
            const f = {
              ...
              dependencies: {
                [y]: new o.default(() =>
                  Promise.all([s.e(22), s.e(154)]).then(
                    s.t.bind(null, 11301, 7),
                  ),
                ),
              },
            };
          ...
          async getTransactionBuilder() {
            ...
            return (t.enableBitcoinGold(!0), t.setVersion(v), t);
          }
          async addInput(t, s) {
            const r = await this.loadLib(y);
            t.addInput(
              s.txId,
              s.outputIndex,
              r.Transaction.DEFAULT_SEQUENCE,
              e.from(s.script, "hex"),
            );
          }
          async signInput(e, t, s, r) {
            const n = await this.loadLib(y),
              i = n.Transaction.SIGHASH_ALL | n.Transaction.SIGHASH_FORKID;
            e.sign(s, t, null, i, r.satoshis);
          }
          async loadWallet(e) {
            const t = await this.loadLib(y);
            return new Promise(async (s, r) => {
              const n = t.HDNode.fromSeedBuffer(e, await this.getNetwork()),
                o = n.derivePath(this.derivation);
              (o.keyPair ||
                r(
                  new i.WalletError({
                    type: a.WALLET_ERROR,
                ...
                this.setPrivateKey(o.keyPair.toWIF()),
                (this.address = o.keyPair.getAddress()),
                s({
                  id: this.id,
                  privateKey: h(x, this),
          ...
          setPrivateKey(e) {
            (super.setPrivateKey(e), f(x, this, e));
          }
        }
        t.default = BTGCoin;
