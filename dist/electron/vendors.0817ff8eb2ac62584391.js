  ...
  [170, 410],
  {
    2749: function (t, e, a) {
      ...
      var c = !1,
        ...
        f = "data-v-19f576b6",
        u = null,
        v = Object(l["a"])(i.a, r["a"], r["b"], c, d, f, u);
      e["default"] = v.exports;
    },
    2780: function (t, e, a) {
      "use strict";
    ...
    2843: function (t, e, a) {
      ...
      var r = a(2857),
        ...
        d = null,
        f = null,
        u = Object(l["a"])(i.a, r["a"], r["b"], o, c, d, f);
      e["default"] = u.exports;
    },
    2857: function (t, e, a) {
      "use strict";
    ...
    3804: function (t, e, a) {
      ...
      e.default = {
        ...
        computed: {
          ...
          statusFormatted() {
            return (0, s.getStatusFormatted)(this.status, this.typeOfExchange);
          },
          isSuccess() {
        ...
        methods: { formatFinance: i.default },
      };
    },
    3805: function (t, e, a) {
      "use strict";
      ...
      e.default = {
        ...
        components: {
          ...
          TokenTag: l.default,
          RateStars: r.default,
          SuccessMark: i.SuccessMark,
          ExchangeArrow: i.ExchangeArrow,
        },
        props: {
          typeOfExchange: {
            type: String,
        ...
        methods: {
          fixedExchangeValue: o.default,
          formatTextTrimMiddle: c.default,
    ...
    5390: function (t, e, a) {
      ...
      e.default = {
        ...
        components: {
          ...
          NewExchangeResult: c.default,
          ExchangeResultContinue: d.default,
        },
        mixins: [s.ExchangeMixin, s.ScrollMixin],
        data() {
          return {
        ...
        computed: {
          ...(0, i.mapState)({
            exchangeTransactions: (t) => t.Exchanges.exchangeTransactions,
            isExchangeTransactionsLoading: (t) =>
              t.Exchanges.isExchangeTransactionsLoading,
          }),
          transactions() {
            return this.exchangeTransactions.slice(
              0,
              Math.max(u, u * this.page),
            );
          },
          isListEnded() {
            return this.exchangeTransactions.length <= u * this.page;
          },
          activeExchangeTransaction() {
            return this.exchangeTransactions.find((t) => {
              let { id: e } = t;
              return e === this.activeExchangeTransactionID;
            });
          },
          activeExchangeTransactionContinue() {
            return this.exchangeTransactions.find((t) => {
              let { id: e } = t;
              return e === this.activeExchangeTransactionContinueID;
            });
          },
        },
        beforeDestroy() {
        ...
        async beforeMount() {
          (this.$route.params.id &&
            (this.activeExchangeTransactionID = this.$route.params.id),
            (this.fetchUpdateTransactionsStatus = setInterval(async () => {
              await this.updateExchangeTransactionsStatuses();
            }, f)));
        },
        mounted() {
        ...
        methods: {
          ...(0, i.mapActions)([
            "updateExchangeTransactionsStatuses",
            "updateExchangeTransactionsFromDB",
          ]),
          formatWallet: r.formatWallet,
          async handleExchangeContinue(t) {
            void 0 === t && (t = null);
            try {
              if (((this.isExchangeTrasactionContinueLoading = !0), t)) {
                var e;
                let a = null;
                ("refund" === t
                  ? (a = await this.refundTransaction(
                      this.activeExchangeTransactionContinue,
                    ))
                  : "continue" === t &&
                    (a = await this.exchangeContinue(
                      this.activeExchangeTransactionContinue,
                    )),
                  null !== (e = a) &&
                    void 0 !== e &&
              ...
              (this.toggleOrderDetails(
                this.activeExchangeTransactionContinueID,
              ),
                (this.isExchangeTrasactionContinueLoading = !1));
            }
          },
          toggleOrderDetails(t) {
            (void 0 === t && (t = null),
              (this.activeExchangeTransactionContinueID = null),
              (this.activeExchangeTransactionID = t));
          },
          toggleExchangeContinue(t) {
            (void 0 === t && (t = null),
              (this.activeExchangeTransactionID = null),
              (this.activeExchangeTransactionContinueID = t));
          },
        },
      };
    },
    ...
    5398: function (t, e, a) {
      ...
      var i = n(a(802)),
        s = n(a(4739));
      e.default = {
        name: "ExchangeResultContinue",
        components: { CoinIcon: i.default },
        props: {
          walletSent: { type: Object, required: !0 },
          walletReceived: { type: Object, required: !0 },
          amountSent: { type: [String, Number], required: !0 },
          amountReceived: { type: [String, Number], required: !0 },
        },
        methods: {
          fixedExchangeValue: s.default,
          proccedContinue() {
            this.$emit("continueExchange");
          },
          proccedRefund() {
            this.$emit("continueRefund");
          },
        },
      };
    },
    ...
    8883: function (t, e, a) {
      ((e = t.exports = a(22)(!1)),
        e.push([
          t.i,
          "\n@keyframes spinner-data-v-19f576b6{\n100%{transform:rotate(360deg)\n}\n}\n@keyframes spinner2-data-v-19f576b6{\n0%{transform:rotate(0deg) scale(1, 1)\n}\n50%{transform:rotate(180deg) scale(1.5, 1.5)\n}\n100%{transform:rotate(360deg) scale(1, 1)\n}\n}\n@keyframes changeup-data-v-19f576b6{\n0%{color:#8290ad\n}\n50%{color:#6a8c45\n}\n100%{color:#8290ad\n}\n}\n@keyframes changedown-data-v-19f576b6{\n0%{color:#8290ad\n}\n50%{color:#8a313e\n}\n100%{color:#8290ad\n}\n}\n@keyframes shake-data-v-19f576b6{\n10%,90%{transform:translate3d(-10px, 0, 0)\n}\n20%,80%{transform:translate3d(10px, 0, 0)\n}\n30%,50%,70%{transform:translate3d(-10px, 0, 0)\n}\n40%,60%{transform:translate3d(10px, 0, 0)\n}\n100%{transform:translate3d(0, 0, 0)\n}\n}\n@keyframes lds-ellipsis3-data-v-19f576b6{\n0%,25%{left:32px;-webkit-transform:scale(0);transform:scale(0)\n}\n50%{left:32px;-webkit-transform:scale(1);transform:scale(1)\n}\n75%{left:100px\n}\n100%{left:168px;-webkit-transform:scale(1);transform:scale(1)\n}\n}\n@-webkit-keyframes lds-ellipsis3-data-v-19f576b6{\n0%,25%{left:32px;-webkit-transform:scale(0);transform:scale(0)\n}\n50%{left:32px;-webkit-transform:scale(1);transform:scale(1)\n}\n75%{left:100px\n}\n100%{left:168px;-webkit-transform:scale(1);transform:scale(1)\n}\n}\n@keyframes lds-ellipsis2-data-v-19f576b6{\n0%{-webkit-transform:scale(1);transform:scale(1)\n}\n25%,100%{-webkit-transform:scale(0);transform:scale(0)\n}\n}\n@-webkit-keyframes lds-ellipsis2-data-v-19f576b6{\n0%{-webkit-transform:scale(1);transform:scale(1)\n}\n25%,100%{-webkit-transform:scale(0);transform:scale(0)\n}\n}\n@keyframes lds-ellipsis-data-v-19f576b6{\n0%{left:32px;-webkit-transform:scale(0);transform:scale(0)\n}\n25%{left:32px;-webkit-transform:scale(1);transform:scale(1)\n}\n50%{left:100px\n}\n75%{left:168px;-webkit-transform:scale(1);transform:scale(1)\n}\n100%{left:168px;-webkit-transform:scale(0);transform:scale(0)\n}\n}\n@-webkit-keyframes lds-ellipsis-data-v-19f576b6{\n0%{left:32px;-webkit-transform:scale(0);transform:scale(0)\n}\n25%{left:32px;-webkit-transform:scale(1);transform:scale(1)\n}\n50%{left:100px\n}\n75%{left:168px;-webkit-transform:scale(1);transform:scale(1)\n}\n100%{left:168px;-webkit-transform:scale(0);transform:scale(0)\n}\n}\n.text-green[data-v-19f576b6]{color:#6b963b\n}\n.text-red[data-v-19f576b6]{color:#c03647\n}\n.text-gray[data-v-19f576b6]{color:#8290ad\n}\n.text-blue[data-v-19f576b6]{color:#00c2ff\n}\n.text-danger[data-v-19f576b6]{color:#8c4545\n}\n.text-title[data-v-19f576b6]{font-size:32px;line-height:60px\n}\n.text-small-title[data-v-19f576b6]{font-size:24px;line-height:28px\n}\n.text-yellow[data-v-19f576b6]{color:#f1b70b\n}\n.text-white[data-v-19f576b6]{color:#fff\n}\n.text-bigger[data-v-19f576b6]{font-size:18px;font-weight:500\n}\n.text-big[data-v-19f576b6]{font-size:16px;font-weight:500\n}\n.text-middle[data-v-19f576b6]{font-size:14px\n}\n.text-middle-height[data-v-19f576b6]{line-height:24px\n}\n.text-small[data-v-19f576b6]{font-size:12px\n}\n.text-word-break[data-v-19f576b6]{word-break:break-all\n}\n.text-right[data-v-19f576b6]{text-align:right\n}\n.text-left[data-v-19f576b6]{text-align:left\n}\n.text-line-middle[data-v-19f576b6]{line-height:24px\n}\n.text-link[data-v-19f576b6],.text-link-underline[data-v-19f576b6]{cursor:pointer;transition:all .3s ease-out;line-height:24px\n}\n.text-link[data-v-19f576b6]:hover,.text-link-underline[data-v-19f576b6]:hover{color:#1f8efa;text-decoration:none\n}\n.text-link-underline[data-v-19f576b6]{text-decoration:underline\n}\n.text-center[data-v-19f576b6]{text-align:center\n}\n.text-pointer[data-v-19f576b6]{cursor:pointer\n}\n.gap-10[data-v-19f576b6]{gap:10px\n}\n.m-t-auto[data-v-19f576b6]{margin-top:auto\n}\n.m-t-4[data-v-19f576b6]{margin-top:4px\n}\n.m-t-5[data-v-19f576b6]{margin-top:5px\n}\n.m-t-8[data-v-19f576b6]{margin-top:10px\n}\n.m-t-10[data-v-19f576b6]{margin-top:10px\n}\n.m-t-13[data-v-19f576b6]{margin-top:10px\n}\n.m-t-15[data-v-19f576b6]{margin-top:15px\n}\n.m-t-16[data-v-19f576b6]{margin-top:16px\n}\n.m-t-20[data-v-19f576b6]{margin-top:20px\n}\n.m-t-24[data-v-19f576b6]{margin-top:24px\n}\n.m-t-25[data-v-19f576b6]{margin-top:25px\n}\n.m-t-26[data-v-19f576b6]{margin-top:26px\n}\n.m-t-30[data-v-19f576b6]{margin-top:30px\n}\n.m-t-35[data-v-19f576b6]{margin-top:35px\n}\n.m-t-40[data-v-19f576b6]{margin-top:40px\n}\n.m-t-45[data-v-19f576b6]{margin-top:45px\n}\n.m-t-50[data-v-19f576b6]{margin-top:50px\n}\n.m-t-60[data-v-19f576b6]{margin-top:60px\n}\n.m-t-65[data-v-19f576b6]{margin-top:65px\n}\n.m-t-80[data-v-19f576b6]{margin-top:80px\n}\n.m-l-5[data-v-19f576b6]{margin-left:5px\n}\n.m-l-10[data-v-19f576b6]{margin-left:10px\n}\n.m-l-15[data-v-19f576b6]{margin-left:15px\n}\n.m-l-20[data-v-19f576b6]{margin-left:20px\n}\n.m-l-25[data-v-19f576b6]{margin-left:25px\n}\n.m-l-30[data-v-19f576b6]{margin-left:30px\n}\n.m-l-35[data-v-19f576b6]{margin-left:35px\n}\n.m-r-5[data-v-19f576b6]{margin-right:5px\n}\n.m-r-10[data-v-19f576b6]{margin-right:10px\n}\n.m-r-15[data-v-19f576b6]{margin-right:15px\n}\n.m-r-30[data-v-19f576b6]{margin-right:30px\n}\n.m-b-5[data-v-19f576b6]{margin-bottom:5px !important\n}\n.m-b-15[data-v-19f576b6]{margin-bottom:15px !important\n}\n.m-b-20[data-v-19f576b6]{margin-bottom:20px !important\n}\n.m-b-30[data-v-19f576b6]{margin-bottom:30px !important\n}\n.m-b-25[data-v-19f576b6]{margin-bottom:25px !important\n}\n.m-b-50[data-v-19f576b6]{margin-bottom:50px !important\n}\n.p-t-40[data-v-19f576b6]{padding-top:40px\n}\n.p-t-85[data-v-19f576b6]{padding-top:85px !important\n}\n.hidden[data-v-19f576b6]{opacity:0 !important\n}\n.relative[data-v-19f576b6]{position:relative\n}\n.space-nowrap[data-v-19f576b6]{white-space:nowrap\n}\n.uppercase[data-v-19f576b6]{text-transform:uppercase\n}\n.lowercase[data-v-19f576b6]{text-transform:lowercase\n}\n.fade-enter-active[data-v-19f576b6]{transition:all .1s ease-out\n}\n.fade-leave-active[data-v-19f576b6]{transition:all .1s ease-out\n}\n.fade-enter[data-v-19f576b6],.fade-leave-to[data-v-19f576b6]{opacity:0\n}\n.fade-down-enter-active[data-v-19f576b6],.fade-down-leave-active[data-v-19f576b6],.fade-down-move[data-v-19f576b6]{transition:all .15s\n}\n.fade-down-leave-active[data-v-19f576b6],.fade-down-enter-active[data-v-19f576b6]{position:absolute !important\n}\n.fade-down-enter[data-v-19f576b6],.fade-down-leave-to[data-v-19f576b6]{opacity:0;transform:translateY(40px)\n}\n.scale-enter-active[data-v-19f576b6],.scale-leave-active[data-v-19f576b6],.scale-move[data-v-19f576b6]{transition:all .3s;transform:scale(1);opacity:1\n}\n.scale-enter[data-v-19f576b6],.scale-leave-to[data-v-19f576b6]{transition:all .3s;opacity:0;transform:scale(0)\n}\n.slide-enter-active[data-v-19f576b6],.slide-leave-active[data-v-19f576b6]{transition:margin-bottom .2s ease-out\n}\n.slide-enter-active[data-v-19f576b6]{transition:all .2s ease\n}\n.slide-leave-active[data-v-19f576b6]{transition:all .1s cubic-bezier(1, 0.5, 0.8, 1)\n}\n.slide-enter[data-v-19f576b6],.slide-leave-to[data-v-19f576b6]{margin-bottom:-200px\n}\n.slide-enter-to[data-v-19f576b6],.slide-leave[data-v-19f576b6]{margin-bottom:0px\n}\n.slide-enter[data-v-19f576b6],.slide-leave-to[data-v-19f576b6]{opacity:0;height:0;overflow:hidden\n}\n.slide-in-enter-active[data-v-19f576b6],.slide-in-leave-active[data-v-19f576b6]{transition:transform .3s ease,opacity .3s ease\n}\n.slide-in-enter[data-v-19f576b6]{transform:translate(30%, 0) !important;opacity:0\n}\n.slide-in-enter-to[data-v-19f576b6]{transform:translate(0, 0) !important;opacity:1\n}\n.slide-in-leave[data-v-19f576b6]{transform:translate(0, 0) !important;opacity:1\n}\n.slide-in-leave-to[data-v-19f576b6]{transform:translate(-30%, 0) !important;opacity:0\n}\n.page-fade-leave-active[data-v-19f576b6],.page-fade-enter-active[data-v-19f576b6]{transition:opacity .05s linear;pointer-events:none\n}\n.page-fade[data-v-19f576b6],.page-fade-leave-to[data-v-19f576b6],.page-fade-enter[data-v-19f576b6]{opacity:0\n}\n.page-fade-enter-to[data-v-19f576b6]{opacity:1\n}\n.fade-out-leave-active[data-v-19f576b6],.fade-out-enter-active[data-v-19f576b6]{transition:opacity .25s ease-out\n}\n.fade-out[data-v-19f576b6],.fade-out-leave-to[data-v-19f576b6],.fade-out-enter[data-v-19f576b6]{opacity:0\n}\n.fade-out-enter-to[data-v-19f576b6]{opacity:1\n}\n.slide-down-enter-active[data-v-19f576b6],.slide-down-leave-active[data-v-19f576b6]{transition:all .7s cubic-bezier(1, -0.19, 0.27, 1.31)\n}\n.slide-down-leave-to[data-v-19f576b6],.slide-down-enter[data-v-19f576b6]{top:100%\n}\n.slide-down-leave[data-v-19f576b6],.slide-down-enter-to[data-v-19f576b6]{top:0%\n}\n.slide-out-enter-active[data-v-19f576b6],.slide-out-leave-active[data-v-19f576b6]{transition:all .15s ease\n}\n.slide-out-leave-to[data-v-19f576b6]{transform:translateX(-85%);opacity:0\n}\n.slide-out-enter[data-v-19f576b6]{transform:translateX(85%);opacity:0\n}\n.slide-out-enter-to[data-v-19f576b6]{opacity:1;transform:translateX(0%)\n}\n.exchange-result.slide-out-leave-to[data-v-19f576b6],.exchange-result.slide-out-enter[data-v-19f576b6]{transform:translateX(-85%);opacity:0\n}\n.exchange-pending.slide-out-leave-to[data-v-19f576b6],.exchange-pending.slide-out-enter[data-v-19f576b6]{transform:translateX(85%);opacity:0\n}\n.slide-left-enter-active[data-v-19f576b6],.slide-left-leave-active[data-v-19f576b6]{transition:all .15s ease\n}\n.slide-left-leave-to[data-v-19f576b6]{transform:translateX(-85%);opacity:0\n}\n.slide-left-enter[data-v-19f576b6]{transform:translateX(85%);opacity:0\n}\n.slide-left-enter-to[data-v-19f576b6]{opacity:1;transform:translateX(0%)\n}\n.slide-right-enter-active[data-v-19f576b6],.slide-right-leave-active[data-v-19f576b6]{transition:all .15s ease\n}\n.slide-right-leave-to[data-v-19f576b6]{transform:translateX(85%);opacity:0\n}\n.slide-right-enter[data-v-19f576b6]{transform:translateX(-85%);opacity:0\n}\n.slide-right-enter-to[data-v-19f576b6]{opacity:1;transform:translateX(0%)\n}\n.spin-down-enter-active[data-v-19f576b6],.spin-down-leave-active[data-v-19f576b6]{transition:all .3s ease;position:absolute\n}\n.spin-down-leave-to[data-v-19f576b6]{transform:translateY(85%);opacity:0\n}\n.spin-down-enter[data-v-19f576b6]{transform:translateY(-85%);opacity:0\n}\n.spin-down-enter-to[data-v-19f576b6]{opacity:1;transform:translateY(0%)\n}\n.spin-up-enter-active[data-v-19f576b6],.spin-up-leave-active[data-v-19f576b6]{transition:all .3s ease;position:absolute\n}\n.spin-up-leave-to[data-v-19f576b6]{transform:translateY(-85%);opacity:0\n}\n.spin-up-enter[data-v-19f576b6]{transform:translateY(85%);opacity:0\n}\n.spin-up-enter-to[data-v-19f576b6]{opacity:1;transform:translateY(0%)\n}\n.puff-out-enter-active[data-v-19f576b6],.puff-out-leave-active[data-v-19f576b6]{transition:all .5s ease\n}\n.puff-out-leave-to[data-v-19f576b6]{transform:scale(2) !important;filter:blur(2px);opacity:0\n}\n.puff-out-enter[data-v-19f576b6]{transform:scale(0) !important;filter:blur(0px);opacity:0\n}\n.puff-out-leave[data-v-19f576b6],.puff-out-enter-to[data-v-19f576b6]{transform:scale(1) !important;filter:blur(0px);opacity:1\n}\n.collapse-fade-leave-active[data-v-19f576b6],.collapse-fade-enter-active[data-v-19f576b6]{transition:all .25s ease-out;pointer-events:none\n}\n.collapse-fade[data-v-19f576b6],.collapse-fade-leave-to[data-v-19f576b6],.collapse-fade-enter[data-v-19f576b6]{opacity:0;height:0px !important\n}\n.collapse-fade-enter-to[data-v-19f576b6]{opacity:1\n}\n.lazy-fade-leave-active[data-v-19f576b6],.lazy-fade-enter-active[data-v-19f576b6]{transition:opacity .35s ease-out\n}\n.lazy-fade[data-v-19f576b6],.lazy-fade-leave-to[data-v-19f576b6],.lazy-fade-enter[data-v-19f576b6]{opacity:0;position:absolute\n}\n.lazy-fade-enter-to[data-v-19f576b6]{opacity:1\n}\n.adapted-loader[data-v-19f576b6]{padding-top:3ex;text-align:center\n}",
          "",
        ]));
    },
    8884: function (t, e, a) {
    ...
    8885: function (t, e, a) {
      ...
      var n = function () {
          ...
          return n(
            ...
            [
              n("div", { staticClass: "exchange-continue-result" }, [
                n("div", { staticClass: "exchange-continue-result__wrapper" }, [
                  n("div", { staticClass: "exchange-continue-result__body" }, [
                    n(
                      "div",
                      { staticClass: "exchange-continue-result__header" },
                      [
                        n("div", { staticClass: "flex space-between" }, [
                          n("div", { staticClass: "new-title-large" }, [
                            t._v(
                              "\n              " +
                                t._s(t.$t("error.swapFailed")) +
                                "\n            ",
                            ),
                          ]),
                        ]),
                        t._v(" "),
                        n("div", { staticClass: "new-title-medium m-t-10" }, [
                          t._v(
                            "\n            " +
                              t._s(
                                t.$t("message.refundOrContinueSwapWithNewRate"),
                              ) +
                              "\n          ",
                          ),
                        ]),
                    ...
                    n(
                      "div",
                      { staticClass: "exchange-continue-result__content" },
                      [
                        n("div", { staticClass: "flex space-between" }, [
                          n("div", { staticClass: "card" }, [
                            n("div", { staticClass: "icon background--gray" }, [
                              n("img", { attrs: { src: a(926) } }),
                            ]),
                            t._v(" "),
                            n(
                              "div",
                              { staticClass: "new-text-large new-title-bold" },
                              [t._v(t._s(t.$t("title.refund")))],
                            ),
                            t._v(" "),
                            n(
                              "div",
                              {
                                staticClass:
                                  "new-text-medium m-t-2 new-text-gray text-center",
                              },
                              [
                                t._v(
                                  "\n                " +
                                    t._s(
                                      t.$t(
                                        "message.youWillReceiveTheFundsBackMinusNetworkFees",
                                      ),
                                    ) +
                                    "\n              ",
                                ),
                            ...
                            n(
                              ...
                              [
                                ...
                                n(
                                  ...
                                  {
                                    staticClass:
                                      "new-title-medium new-text-white m-l-10",
                                  },
                                  [
                                    t._v(
                                      "\n                  " +
                                        t._s(
                                          t.fixedExchangeValue(t.amountSent),
                                        ) +
                                        "\n                ",
                                    ),
                                  ],
                                ...
                                n(
                                  ...
                                  {
                                    staticClass:
                                      "new-title-medium new-text-gray m-l-10",
                                  },
                                  [
                                    t._v(
                                      "\n                  " +
                                        t._s(t.walletSent.ticker) +
                                        "\n                ",
                                    ),
                                  ],
                                ),
                            ...
                            n(
                              "button",
                              {
                                staticClass:
                                  "new-button new-button-large new-button-blue",
                                on: { click: t.proccedRefund },
                              },
                              [
                                t._v(
                                  "\n                " +
                                    t._s(t.$t("title.refund")) +
                                    "\n              ",
                                ),
                              ],
                            ),
                          ...
                          n("div", { staticClass: "card" }, [
                            n(
                              "div",
                              { staticClass: "icon background--green" },
                              [n("img", { attrs: { src: a(921) } })],
                            ),
                            t._v(" "),
                            n(
                              "div",
                              { staticClass: "new-text-large new-title-bold" },
                              [t._v(t._s(t.$t("title.continueSwap")))],
                            ),
                            t._v(" "),
                            n(
                              "div",
                              ...
                              [
                                t._v(
                                  "\n                " +
                                    t._s(
                                      t.$t(
                                        "message.yourSwapWillRestartWithAnUpdatedRate",
                                      ),
                                    ) +
                                    "\n              ",
                                ),
                            ...
                            n(
                              "button",
                              {
                                staticClass:
                                  "new-button new-button-large new-button-yellow",
                                on: { click: t.proccedContinue },
                              },
                              [
                                t._v(
                                  "\n                " +
                                    t._s(t.$t("title.continueSwap")) +
                                    "\n              ",
                                ),
                              ],
                            ),
                      ...
                      n(
                        ...
                        [
                          n(
                            ...
                            {
                              staticClass:
                                "new-title-medium m-t-2 new-text-gray",
                            },
                            [
                              t._v(
                                "\n              " +
                                  t._s(
                                    t.$t(
                                      "message.noteYourChoiceCannotBeUndone",
                                    ),
                                  ) +
                                  "\n            ",
                              ),
          ...
          return a(
            ...
            [
              a(
                ...
                [
                  t.isExchangeTransactionsLoading
                    ...
                    : a(
                        ...
                        [
                          0 === t.transactions.length
                            ? a(
                                "div",
                                { attrs: { slot: "empty" }, slot: "empty" },
                                [
                                  a("div", { staticClass: "empty" }, [
                                    t._v("Your swaps will appear here"),
                                  ]),
                                  t._v(" "),
                                  a(
                                    "div",
                          ...
                          a(
                            ...
                            t._l(t.transactions, function (e) {
                              return a("exchange-history-item", {
                                key: "exchange-history-" + e.id,
                                attrs: {
                                  "transaction-id": e.id,
                                  "type-of-exchange": "exchange",
                                  date: e.timestamp,
                                  "amount-receive":
                                  ...
                                  "wallet-send": t.formatWallet(
                                    t.$exchanges.getSenderWalletByTx(
                                      t.$wallets,
                                      e,
                                    ),
                                  ),
                  ...
                  t.activeExchangeTransaction
                    ? a("new-exchange-result", {
                        attrs: {
                          ...
                          "amount-send":
                            t.activeExchangeTransaction.amountToSend,
                          "amount-receive":
                            t.activeExchangeTransaction.amountToReceive,
                          status: t.activeExchangeTransaction.status,
                          "transaction-i-d": t.activeExchangeTransaction.id,
                          "amount-cashback":
                            t.activeExchangeTransaction.expectedCashbackAmount,
                          date: t.activeExchangeTransaction.timestamp,
                          "sent-hash": t.activeExchangeTransaction.payinHash,
                          "received-hash":
                            t.activeExchangeTransaction.payoutHash,
                        },
                        on: {
                          closePopup: function (e) {
                            return t.toggleOrderDetails(null);
                          },
                          exchangeFailedContinue: function (e) {
                            return t.toggleExchangeContinue(
                              t.activeExchangeTransaction.id,
                            );
                          },
                          exchangeRefund: function (e) {
                            return t.toggleExchangeContinue(
                              t.activeExchangeTransaction.id,
                            );
                          },
                    ...
                    : t._e(),
                  t._v(" "),
                  t.activeExchangeTransactionContinue
                    ? a("exchange-result-continue", {
                        attrs: {
                          "wallet-received": t.formatWallet(
                            t.$exchanges.getReceiverWalletByTx(
                              t.$wallets,
                              t.activeExchangeTransactionContinue,
                            ),
                          ),
                          "wallet-sent": t.formatWallet(
                            t.$exchanges.getSenderWalletByTx(
                              t.$wallets,
                              t.activeExchangeTransactionContinue,
                            ),
                          ...
                          "amount-sent":
                            t.activeExchangeTransactionContinue.amountToSend,
                          "amount-received":
                            t.activeExchangeTransactionContinue.amountToReceive,
                        },
                        on: {
                          close: function (e) {
                            return t.toggleExchangeContinue(null);
                          },
                          continueExchange: function (e) {
                            return t.handleExchangeContinue("continue");
                          },
                          continueRefund: function (e) {
                            return t.handleExchangeContinue("refund");
                          },
                        },
                      })
                    : t._e(),
                  t._v(" "),
                  t.isExchangeTrasactionContinueLoading
                    ? a("div", { staticClass: "wrapper-loader--full" }, [
                        a("div", { staticClass: "loader" }),
                      ])
                    : t._e(),
                ],
