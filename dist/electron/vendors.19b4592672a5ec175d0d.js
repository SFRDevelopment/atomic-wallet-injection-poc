  ...
  [352, 32],
  {
    2670: function (e, t, s) {
      ...
      const c = "Doge",
        ...
        f = 8,
        h = "0",
        { BITCOINJS: T } = i.LIB_NAME_INDEX;
      class DOGECoin extends (0, l.BitcoinJSMixin)(
        (0, l.BitcoinLikeFeeMixin)(a.default),
      ) {
        constructor(e) {
          let {
            alias: t,
          ...
          const m = {
            ...
            k = {
              ...
              socket: p,
              dependencies: {
                [T]: new n.default(() => s.e(19).then(s.t.bind(null, 3218, 7))),
              },
            };
          (super(k),
            (this.derivation = u),
            this.setExplorersModules([o.default]),
            this.loadExplorers(k),
            this.setFeeData(a),
            (this.network = m.livenet));
        }
        setFeeData(e) {
          (void 0 === e && (e = {}),
            super.setFeeData(e),
            (this.feePerByte = String(e.feePerByte)));
        }
        async getFee(e) {
          let t = await super.getFee(e);
          const s = new this.BN(1e5),
            r = new this.BN(1e6);
          return (t.lt(s) && (t = s), t.lt(r) && (t = t.add(r)), t);
        }
        updateCoinParamsFromServer(e) {
          super.updateCoinParamsFromServer(e);
          const t = e.explorers.find((e) => {
            let { className: t } = e;
            return -1 !== this.explorer.constructor.name.indexOf(t);
          });
          t &&
            this.explorer.baseUrl !== t.baseUrl &&
            (this.explorer.baseUrl = t.baseUrl);
        }
      }
      t.default = DOGECoin;
    ...
    7187: function (e, t, s) {
      ...
      var n = s(27),
        a = r(s(2858));
      class BlockbookV3Explorer extends a.default {
        async sendTransaction(e) {
          const t = await this.request(
            this.getSendTransactionUrl(e),
            this.getSendTransactionMethod(),
            n.SEND_TRANSACTION_TYPE,
            this.getSendOptions(),
          );
          return this.modifySendTransactionResponse(t);
        }
        getSendTransactionUrl(e) {
          return `${this.getApiPrefix()}sendtx/${e}`;
        }
        getSendTransactionMethod() {
          return "get";
        }
      }
      t.default = BlockbookV3Explorer;
    },
  },
]);
