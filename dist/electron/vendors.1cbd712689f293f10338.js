(this["webpackJsonp"] = this["webpackJsonp"] || []).push([
  [48],
  {
      ...
      (function (e) {
        ...
        function w(t, r, n) {
          ...
          if ("number" === typeof n && r.length !== n)
            throw new Error(
              "Invalid " + t + ", buffer must be " + n + " bytes",
            );
          return r;
        }
        function g(t) {
          ...
          return t
            ? ("string" === typeof t.salt &&
                (t.salt = e.from(m("salt", t.salt), "hex")),
              "string" === typeof t.iv &&
                (t.iv = e.from(m("iv", t.iv, 32), "hex")),
              "string" === typeof t.uuid &&
                (t.uuid = e.from(m("uuid", t.uuid, 32), "hex")),
        ...
        var k = (function () {
          ...
          return (
            (t.generate = function (e) {
              if ((void 0 === e && (e = !1), !e)) return new t(v(32));
              var r = new l.BN("088f924eeceeda7fe92e1f5b0fffffffffffffff", 16);
              while (1) {
                var n = v(32);
                if (new l.BN((0, l.privateToAddress)(n)).lte(r))
                  return new t(n);
              }
            }),
            (t.generateVanityAddress = function (e) {
              e instanceof RegExp || (e = new RegExp(e));
              while (1) {
                var r = v(32),
                  n = (0, l.privateToAddress)(r);
                if (e.test(n.toString("hex"))) return new t(r);
              }
            }),
            (t.fromPublicKey = function (e, r) {
              return (
                void 0 === r && (r = !1),
                r && (e = (0, l.importPublic)(e)),
                new t(void 0, e)
              );
            }),
            (t.fromExtendedPublicKey = function (e) {
              if ("xpub" !== e.slice(0, 4))
                throw new Error("Not an extended public key");
              var r = y.decode(e).slice(45);
              return t.fromPublicKey(r, !0);
            }),
            (t.fromPrivateKey = function (e) {
              return new t(e);
            }),
            (t.fromExtendedPrivateKey = function (e) {
              if ("xprv" !== e.slice(0, 4))
                throw new Error("Not an extended private key");
              var r = y.decode(e);
              if (0 !== r[45]) throw new Error("Invalid extended private key");
              return t.fromPrivateKey(r.slice(46));
            }),
            (t.fromV1 = function (r, n) {
              return s(this, void 0, void 0, function () {
                ...
                return u(this, function (u) {
                  switch (u.label) {
                    case 0:
                      if (
                        ((i = "object" === typeof r ? r : JSON.parse(r)),
                        "1" !== i.Version)
                      )
                        throw new Error("Not a V1 Wallet");
                      if ("scrypt" !== i.Crypto.KeyHeader.Kdf)
                    ...
                    case 1:
                      if (
                        ((a = u.sent()),
                        (s = e.from(i.Crypto.CipherText, "hex")),
                        (c = (0, l.keccak256)(e.concat([a.slice(16, 32), s]))),
                        c.toString("hex") !== i.Crypto.MAC)
                      )
                        throw new Error(
                          "Key derivation failed - possibly wrong passphrase",
                        );
                      return (
                        (p = f.createDecipheriv(
                          "aes-128-cbc",
                          (0, l.keccak256)(a.slice(0, 16)).slice(0, 16),
                          e.from(i.Crypto.IV, "hex"),
                        )),
                        (d = E(p, s)),
                        [2, new t(d)]
                      );
                    ...
                    switch (u.label) {
                      ...
                      case 2:
                        if ("pbkdf2" !== o.crypto.kdf)
                          throw new Error("Unsupported key derivation scheme");
                        if (((s = o.crypto.kdfparams), "hmac-sha256" !== s.prf))
                      ...
                      case 3:
                        if (
                          ((c = e.from(o.crypto.ciphertext, "hex")),
                          (p = (0, l.keccak256)(
                            e.concat([e.from(a.slice(16, 32)), c]),
                          )),
                          p.toString("hex") !== o.crypto.mac)
                        )
                          throw new Error(
                            "Key derivation failed - possibly wrong passphrase",
                          );
                        return (
                          (d = f.createDecipheriv(
                            o.crypto.cipher,
                            a.slice(0, 16),
                            e.from(o.crypto.cipherparams.iv, "hex"),
                          )),
                          (y = E(d, c)),
                          [2, new t(y)]
                        );
            ...
            (t.fromEthSale = function (r, n) {
              var i = "object" === typeof r ? r : JSON.parse(r),
                o = e.from(i.encseed, "hex"),
                a = f.pbkdf2Sync(n, n, 2e3, 32, "sha256").slice(0, 16),
                s = f.createDecipheriv("aes-128-cbc", a, o.slice(0, 16)),
                u = E(s, o.slice(16)),
                c = new t((0, l.keccak256)(u));
            ...
            Object.defineProperty(t.prototype, "pubKey", {
              get: function () {
                return (
                  P(this.publicKey) ||
                    (this.publicKey = (0, l.privateToPublic)(this.privateKey)),
                  this.publicKey
                );
              },
              enumerable: !1,
            ...
            Object.defineProperty(t.prototype, "privKey", {
              get: function () {
                if (!P(this.privateKey))
              ...
              return s(this, void 0, void 0, function () {
                ...
                return u(this, function (u) {
                  switch (u.label) {
                    ...
                    case 5:
                      if (
                        ((c = f.createCipheriv(i.cipher, a.slice(0, 16), i.iv)),
                        !c)
                      )
                      ...
                      return (
                        (p = E(c, this.privKey)),
                        (d = (0, l.keccak256)(
                          e.concat([e.from(a.slice(16, 32)), e.from(p)]),
                        )),
                        [
                          2,
                          {
            ...
            (t.prototype.getV3Filename = function (e) {
            ...
            (t.prototype.toV3String = function (e, t) {
              return s(this, void 0, void 0, function () {
                var r, n;
        ...
        function E(t, r) {
          return e.concat([t.update(r), t.final()]);
        }
        function P(e) {
    ...
    3156: function (e, t, r) {
      ...
      (Object.defineProperty(t, "__esModule", { value: !0 }),
        (t.default = void 0));
      for (var i = n(r(3157)), o = [], a = 0; a < 256; ++a)
    ...
    3590: function (e, t, r) {
      ...
      var s = (t.DNS = "6ba7b810-9dad-11d1-80b4-00c04fd430c8"),
    ...
    4477: function (e, t, r) {
      ...
      var i = n(r(229)),
        ...
        l = 2147483648,
        h = 78,
        p = { private: 76066276, public: 76067358 };
      function d(e) {
        ((this.versions = e || p),
          (this.depth = 0),
          (this.index = 0),
      ...
      (Object.defineProperty(d.prototype, "fingerprint", {
        ...
        Object.defineProperty(d.prototype, "privateKey", {
          ...
          set: function (e) {
            (i.equal(e.length, 32, "Private key must be 32 bytes."),
              i(!0 === u.privateKeyVerify(e), "Invalid private key"),
              (this._privateKey = e),
        ...
        Object.defineProperty(d.prototype, "publicKey", {
          ...
          set: function (e) {
            (i(
              ...
              i(!0 === u.publicKeyVerify(e), "Invalid public key"),
        ...
        (d.prototype.deriveChild = function (e) {
          ...
          if ((n.writeUInt32BE(e, 0), r)) {
            ...
            var o = this.privateKey,
              a = c.alloc(1, 0);
            ((o = c.concat([a, o])), (t = c.concat([o, n])));
          } else t = c.concat([this.publicKey, n]);
          var f = s.createHmac("sha512", this.chainCode).update(t).digest(),
            h = f.slice(0, 32),
            p = f.slice(32),
            y = new d(this.versions);
          if (this.privateKey)
            try {
              y.privateKey = u.privateKeyTweakAdd(this.privateKey, h);
            } catch (v) {
              return this.deriveChild(e + 1);
            }
          else
            try {
              y.publicKey = u.publicKeyTweakAdd(this.publicKey, h, !0);
            } catch (v) {
              return this.deriveChild(e + 1);
            }
          return (
        ...
        (d.fromMasterSeed = function (e, t) {
          var r = s.createHmac("sha512", f).update(e).digest(),
            n = r.slice(0, 32),
            i = r.slice(32),
            o = new d(t);
    ...
    4478: function (e, t, r) {
      ...
      (function (e) {
        ...
        var n = r(4479),
          i = r(4480);
        ((t.createHmac = r(2828)), (t.randomBytes = r(377)));
        var o = (function () {
          function t(e) {
    ...
    4481: function (e, t, r) {
      ...
      (Object.defineProperty(t, "__esModule", { value: !0 }), n(r(4482)));
    },
    4482: function (e, t, r) {
      "use strict";
      (function (e) {
        ...
        function a(t, r) {
          return (void 0 === r && (r = !0), e.from(i.publicKeyCreate(t, r)));
        }
        function s(e) {
          return i.publicKeyVerify(e);
        }
        function u(t, r) {
          return (void 0 === r && (r = !0), e.from(i.publicKeyConvert(t, r)));
        }
        function c(t, r) {
          return e.from(i.privateKeyTweakAdd(e.from(t), r));
        }
        function f(t, r, n) {
          return (
            void 0 === n && (n = !0),
            e.from(i.publicKeyTweakAdd(e.from(t), r, n))
          );
        }
        function l(t, r) {
          var n = i.ecdsaSign(t, r);
          return { signature: e.from(n.signature), recovery: n.recid };
        }
        function h(e, t, r) {
          return i.ecdsaVerify(t, e, r);
        }
        ((t.privateKeyVerify = o),
          (t.publicKeyCreate = a),
          (t.publicKeyVerify = s),
          (t.publicKeyConvert = u),
          (t.privateKeyTweakAdd = c),
          (t.publicKeyTweakAdd = f),
          (t.sign = l),
          (t.verify = h));
      }).call(this, r(2).Buffer);
    },
    4483: function (e, t, r) {
      ...
      (function (e) {
        ...
        var v = { count: 1, keysize: 16, ivsize: 16, digest: "md5" };
        function b(e) {
          return e
            ? {
                count: e.count || v.count,
                keysize: e.keysize || v.keysize,
                ivsize: e.ivsize || v.ivsize,
                digest: e.digest || v.digest,
              }
            : v;
        }
        function m(t, r, n) {
          var i = b(n);
          function o(e) {
            var n = c.createHash(i.digest);
            (n.update(e), n.update(t), n.update(r), (e = n.digest()));
            for (var o = 1, a = i.count; o < a; o++)
              ((n = c.createHash(i.digest)), n.update(e), (e = n.digest()));
            return e;
          }
          var a = [],
            s = 0;
          while (e.concat(a).length < i.keysize + i.ivsize)
            ((a[s] = o(0 === s ? e.alloc(0) : a[s - 1])), s++);
          var u = e.concat(a);
          return {
            key: u.slice(0, i.keysize),
            iv: u.slice(i.keysize, i.keysize + i.ivsize),
          };
        }
        function w(t) {
        ...
        function g(t, r) {
          ...
          if (i.locked) {
            ...
            var o = i.encrypted ? i.private.slice(0, 128) : i.private,
              a = w(o);
            if (!a.salt) throw new Error("Unsupported EtherWallet key format");
            var s = m(e.from(r), a.salt, { keysize: 32, ivsize: 16 }),
              u = c.createDecipheriv("aes-256-cbc", s.key, s.iv);
            ((n = y(u, e.from(a.ciphertext))),
              (n = e.from(p.decode(n.toString()), "hex")));
          } else {
            if (64 !== i.private.length)
              throw new Error("Invalid private key length");
            n = e.from(i.private, "hex");
          }
          var f = new h.default(n);
          if (f.getAddressString() !== i.address)
            throw new Error("Invalid private key or address");
          return f;
        }
        function _(t) {
          return new h.default((0, f.keccak256)(e.from(t)));
        }
        function K(t, r) {
          return a(this, void 0, void 0, function () {
            function n(t) {
              ...
              for (var n = "", i = "", o = 0; o < t.length; o++)
                t[o] <= 127
                  ? ((n += r(i) + String.fromCharCode(t[o])), (i = ""))
                  : (i += "%" + t[o].toString(16));
              return e.from(n + r(i));
            }
            var i, o, a, u, c, p, y;
              ...
              switch (s.label) {
                case 0:
                  return (
                    ...
                    "d" !== i
                      ? [3, 1]
                      : ((o = (0, f.sha256)((0, f.toBuffer)(t))), [3, 4])
                  );
                case 1:
                  if ("q" !== i) return [3, 3];
                  if ("string" !== typeof r)
                  ...
                  return (
                    (a = (0, f.sha256)(e.from(t.slice(0, 30)))),
                    (u = t.slice(30, 46)),
                    (c = n(a)),
                    [4, (0, l.scrypt)(e.from(r, "utf8"), c, 16384, 8, 1, 32)]
                  );
                case 2:
                  if (
                    ((p = s.sent()),
                    (y = new d.ModeOfOperation.ecb(p)),
                    (o = e.concat([
                      e.from(y.decrypt(a.slice(0, 16))),
                      e.from(y.decrypt(a.slice(16, 32))),
                    ])),
                    u.length > 0 &&
                      u !==
                        (0, f.sha256)((0, f.sha256)(o))
                          .slice(0, 8)
                          .toString("hex"))
                  )
                    throw new Error(
        ...
        function k(e, t) {
          ...
          var r = e + t,
            n = c.pbkdf2Sync(r, r, 2e3, 32, "sha256");
          return new h.default(n);
        }
        ((t.fromEtherWallet = g),
          (t.fromEtherCamp = _),
          (t.fromKryptoKit = K),
          (t.fromQuorumWallet = k));
        var E = {
          fromEtherWallet: g,
          fromEtherCamp: _,
          fromKryptoKit: K,
      ...
      (function (t) {
        ...
        ((x.prototype._prepare = function () {
          ...
          (x.prototype.encrypt = function (e) {
            ...
            for (i = 0; i < 4; i++)
              ((s = this._Ke[t][i]),
                (u[4 * i] = 255 & (l[(n[i] >> 24) & 255] ^ (s >> 24))),
                (u[4 * i + 1] =
                  255 & (l[(n[(i + 1) % 4] >> 16) & 255] ^ (s >> 16))),
                (u[4 * i + 2] =
                  255 & (l[(n[(i + 2) % 4] >> 8) & 255] ^ (s >> 8))),
                (u[4 * i + 3] = 255 & (l[255 & n[(i + 3) % 4]] ^ s)));
            return u;
          }),
          (x.prototype.decrypt = function (e) {
            ...
            for (i = 0; i < 4; i++)
              ((s = this._Kd[t][i]),
                (u[4 * i] = 255 & (h[(n[i] >> 24) & 255] ^ (s >> 24))),
                (u[4 * i + 1] =
                  255 & (h[(n[(i + 3) % 4] >> 16) & 255] ^ (s >> 16))),
                (u[4 * i + 2] =
                  255 & (h[(n[(i + 2) % 4] >> 8) & 255] ^ (s >> 8))),
                (u[4 * i + 3] = 255 & (h[255 & n[(i + 1) % 4]] ^ s)));
            return u;
          }));
        var S = function (e) {
        ...
        ((S.prototype.encrypt = function (e) {
          ...
          (S.prototype.decrypt = function (e) {
            ...
            for (var t = o(e.length), r = o(16), n = 0; n < e.length; n += 16)
              (a(e, r, 0, n, n + 16), (r = this._aes.decrypt(r)), a(r, t, n));
            return t;
          }));
        var C = function (e, t) {
          ...
          ((this._lastCipherblock = i(t, !0)), (this._aes = new x(e)));
        };
        ...
        var z = {
          AES: x,
          Counter: A,
          ModeOfOperation: { ecb: S, cbc: C, cfb: O, ofb: j, ctr: I },
          utils: { hex: u, utf8: s },
          padding: { pkcs7: { pad: M, strip: U } },
          _arrayTest: { coerceArray: i, createArray: o, copyArray: a },
        };
        e.exports = z;
      })();
    },
    ...
    4486: function (e, t, r) {
      ...
      function f(e, t, r) {
        ...
        if (null == l || null == h) {
          var p = e.random || (e.rng || a.default)();
          (null == l && (l = i = [1 | p[0], p[1], p[2], p[3], p[4], p[5]]),
        ...
        if (
          ...
          (v < 0 || d > u) && void 0 === e.nsecs && (y = 0),
          y >= 1e4)
        )
          throw new Error("uuid.v1(): Can't create more than 10M uuids/sec");
        ((u = d), (c = y), (o = h), (d += 122192928e5));
        ...
        ((f[n++] = (m >>> 8) & 255),
          ...
          (f[n++] = (h >>> 8) | 128),
          (f[n++] = 255 & h));
        for (var w = 0; w < 6; ++w) f[n + w] = l[w];
        return t || (0, s.default)(f);
      }
      t.default = f;
    },
    4487: function (e, t, r) {
    ...
    4489: function (e, t, r) {
      ...
      function a(e, t) {
        ...
        for (
          ...
          var c = r,
            ...
            y = i,
            v = a;
          ((r = l(r, n, i, a, e[s], 7, -680876936)),
            (a = l(a, r, n, i, e[s + 1], 12, -389564586)),
            (i = l(i, a, r, n, e[s + 2], 17, 606105819)),
            (n = l(n, i, a, r, e[s + 3], 22, -1044525330)),
            (r = l(r, n, i, a, e[s + 4], 7, -176418897)),
            (a = l(a, r, n, i, e[s + 5], 12, 1200080426)),
            (i = l(i, a, r, n, e[s + 6], 17, -1473231341)),
            (n = l(n, i, a, r, e[s + 7], 22, -45705983)),
            (r = l(r, n, i, a, e[s + 8], 7, 1770035416)),
            (a = l(a, r, n, i, e[s + 9], 12, -1958414417)),
            (i = l(i, a, r, n, e[s + 10], 17, -42063)),
            (n = l(n, i, a, r, e[s + 11], 22, -1990404162)),
            (r = l(r, n, i, a, e[s + 12], 7, 1804603682)),
            (a = l(a, r, n, i, e[s + 13], 12, -40341101)),
            (i = l(i, a, r, n, e[s + 14], 17, -1502002290)),
            (n = l(n, i, a, r, e[s + 15], 22, 1236535329)),
            (r = h(r, n, i, a, e[s + 1], 5, -165796510)),
            (a = h(a, r, n, i, e[s + 6], 9, -1069501632)),
            (i = h(i, a, r, n, e[s + 11], 14, 643717713)),
            (n = h(n, i, a, r, e[s], 20, -373897302)),
            (r = h(r, n, i, a, e[s + 5], 5, -701558691)),
            (a = h(a, r, n, i, e[s + 10], 9, 38016083)),
            (i = h(i, a, r, n, e[s + 15], 14, -660478335)),
            (n = h(n, i, a, r, e[s + 4], 20, -405537848)),
            (r = h(r, n, i, a, e[s + 9], 5, 568446438)),
            (a = h(a, r, n, i, e[s + 14], 9, -1019803690)),
            (i = h(i, a, r, n, e[s + 3], 14, -187363961)),
            (n = h(n, i, a, r, e[s + 8], 20, 1163531501)),
            (r = h(r, n, i, a, e[s + 13], 5, -1444681467)),
            (a = h(a, r, n, i, e[s + 2], 9, -51403784)),
            (i = h(i, a, r, n, e[s + 7], 14, 1735328473)),
            (n = h(n, i, a, r, e[s + 12], 20, -1926607734)),
            (r = p(r, n, i, a, e[s + 5], 4, -378558)),
            (a = p(a, r, n, i, e[s + 8], 11, -2022574463)),
            (i = p(i, a, r, n, e[s + 11], 16, 1839030562)),
            (n = p(n, i, a, r, e[s + 14], 23, -35309556)),
            (r = p(r, n, i, a, e[s + 1], 4, -1530992060)),
            (a = p(a, r, n, i, e[s + 4], 11, 1272893353)),
            (i = p(i, a, r, n, e[s + 7], 16, -155497632)),
            (n = p(n, i, a, r, e[s + 10], 23, -1094730640)),
            (r = p(r, n, i, a, e[s + 13], 4, 681279174)),
            (a = p(a, r, n, i, e[s], 11, -358537222)),
            (i = p(i, a, r, n, e[s + 3], 16, -722521979)),
            (n = p(n, i, a, r, e[s + 6], 23, 76029189)),
            (r = p(r, n, i, a, e[s + 9], 4, -640364487)),
            (a = p(a, r, n, i, e[s + 12], 11, -421815835)),
            (i = p(i, a, r, n, e[s + 15], 16, 530742520)),
            (n = p(n, i, a, r, e[s + 2], 23, -995338651)),
            (r = d(r, n, i, a, e[s], 6, -198630844)),
            (a = d(a, r, n, i, e[s + 7], 10, 1126891415)),
            (i = d(i, a, r, n, e[s + 14], 15, -1416354905)),
            (n = d(n, i, a, r, e[s + 5], 21, -57434055)),
            (r = d(r, n, i, a, e[s + 12], 6, 1700485571)),
            (a = d(a, r, n, i, e[s + 3], 10, -1894986606)),
            (i = d(i, a, r, n, e[s + 10], 15, -1051523)),
            (n = d(n, i, a, r, e[s + 1], 21, -2054922799)),
            (r = d(r, n, i, a, e[s + 8], 6, 1873313359)),
            (a = d(a, r, n, i, e[s + 15], 10, -30611744)),
            (i = d(i, a, r, n, e[s + 6], 15, -1560198380)),
            (n = d(n, i, a, r, e[s + 13], 21, 1309151649)),
            (r = d(r, n, i, a, e[s + 4], 6, -145523070)),
            (a = d(a, r, n, i, e[s + 11], 10, -1120210379)),
            (i = d(i, a, r, n, e[s + 2], 15, 718787259)),
            (n = d(n, i, a, r, e[s + 9], 21, -343485551)),
            (r = u(r, c)),
            (n = u(n, f)),
            (i = u(i, y)),
            (a = u(a, v)));
      ...
      function s(e) {
        ...
        for (
          var t = 8 * e.length, r = new Uint32Array(o(t)), n = 0;
          n < t;
          n += 8
        )
    ...
    4490: function (e, t, r) {
      ...
      function a(e, t, r) {
        e = e || {};
        var n = e.random || (e.rng || i.default)();
    ...
    4492: function (e, t, r) {
      ...
      function o(e) {
        ...
        for (var p = 0; p < u; ++p) {
          for (var d = new Uint32Array(80), y = 0; y < 16; ++y) d[y] = c[p][y];
          for (var v = 16; v < 80; ++v)
            d[v] = i(d[v - 3] ^ d[v - 8] ^ d[v - 14] ^ d[v - 16], 1);
          for (
            var b = r[0], m = r[1], w = r[2], g = r[3], _ = r[4], K = 0;
            K < 80;
            ++K
          ) {
            var k = Math.floor(K / 20),
              E = (i(b, 5) + n(k, m, w, g) + _ + t[k] + d[K]) >>> 0;
            ((_ = g), (g = w), (w = i(m, 30) >>> 0), (m = b), (b = E));
          }
          ((r[0] = (r[0] + b) >>> 0),
            (r[1] = (r[1] + m) >>> 0),
            (r[2] = (r[2] + w) >>> 0),
