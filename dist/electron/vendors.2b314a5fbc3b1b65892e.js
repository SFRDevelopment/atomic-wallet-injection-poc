  ...
  [100],
  {
    ...
    107: function (e, t, r) {
      var f,
        ...
        i = r(1259),
        c = r(1260);
      "undefined" !== typeof ArrayBuffer && (f = r(1261));
      var s =
      ...
      function m(e, r, f) {
        ...
        return (
          (a.onload = function () {
            t.encodePacket({ type: e.type, data: a.result }, r, !0, f);
          }),
      ...
      ((t.encodePacket = function (e, t, r, f) {
        ("function" === typeof t && ((f = t), (t = !1)),
        ...
        if ("undefined" !== typeof ArrayBuffer && a instanceof ArrayBuffer)
          return v(e, t, f);
        if ("undefined" !== typeof l && a instanceof l) return g(e, t, f);
        if (a && a.base64) return y(e, f);
        var d = u[e.type];
        return (
          void 0 !== e.data &&
            (d += r
        ...
        (t.encodeBase64Packet = function (e, r) {
          var f,
            a = "b" + t.packets[e.type];
          if ("undefined" !== typeof l && e.data instanceof l) {
          ...
          try {
            ...
            for (
              var n = new Uint8Array(e.data), i = new Array(n.length), c = 0;
              c < n.length;
              c++
            )
              i[c] = n[c];
        ...
        (t.decodePacket = function (e, r, f) {
          ...
          if ("string" === typeof e) {
            ...
            if (f && ((e = w(e)), !1 === e)) return p;
            var a = e.charAt(0);
            return Number(a) == a && h[a]
              ? e.length > 1
                ? { type: h[a], data: e.substring(1) }
                : { type: h[a] }
              : p;
          }
        ...
        (t.decodeBase64Packet = function (e, t) {
          var r = h[e.charAt(0)];
          if (!f) return { type: r, data: { base64: !0, data: e.substr(1) } };
          var a = f.decode(e.substr(1));
          return ("blob" === t && l && (a = new l([a])), { type: r, data: a });
        }),
        (t.encodePayload = function (e, r, f) {
          ...
          if (r && a)
            return l && !b
              ? t.encodePayloadAsBlob(e, f)
              : t.encodePayloadAsArrayBuffer(e, f);
        ...
        (t.decodePayload = function (e, r, f) {
          ...
          var a;
          if (("function" === typeof r && ((f = r), (r = null)), "" === e))
            return f(p, 0, 1);
          for (var d, n, i = "", c = 0, s = e.length; c < s; c++) {
            var o = e.charAt(c);
            if (":" === o) {
              if ("" === i || i != (d = Number(i))) return f(p, 0, 1);
              if (((n = e.substr(c + 1, d)), i != n.length)) return f(p, 0, 1);
              if (n.length) {
                if (
                  ((a = t.decodePacket(n, r, !1)),
                  p.type === a.type && p.data === a.data)
                )
                  return f(p, 0, 1);
                var b = f(a, c + d, s);
                if (!1 === b) return;
        ...
        (t.encodePayloadAsArrayBuffer = function (e, r) {
          ...
          S(e, f, function (e, t) {
            var f = t.reduce(function (e, t) {
                var r;
                return (
                  (r = "string" === typeof t ? t.length : t.byteLength),
            ...
            return (
              t.forEach(function (e) {
                ...
                if (t) {
                  for (
                    var f = new Uint8Array(e.length), n = 0;
                    n < e.length;
                    n++
                  )
                    f[n] = e.charCodeAt(n);
                ...
                a[d++] = 255;
                for (f = new Uint8Array(r), n = 0; n < f.length; n++)
                  a[d++] = f[n];
              }),
              r(a.buffer)
            );
          ...
          function f(e, r) {
            t.encodePacket(e, !0, !0, function (e) {
              ...
              if (((t[0] = 1), "string" === typeof e)) {
                for (var f = new Uint8Array(e.length), a = 0; a < e.length; a++)
                  f[a] = e.charCodeAt(a);
                ((e = f.buffer), (t[0] = 0));
              }
              var d = e instanceof ArrayBuffer ? e.byteLength : e.size,
                n = d.toString(),
                i = new Uint8Array(n.length + 1);
              for (a = 0; a < n.length; a++) i[a] = parseInt(n[a]);
              if (((i[n.length] = 255), l)) {
                var c = new l([t.buffer, i.buffer, e]);
                r(null, c);
              }
            });
          }
        ...
        (t.decodePayloadAsBinary = function (e, r, f) {
          ...
          while (a.byteLength > 0) {
            for (
              var i = new Uint8Array(a), c = 0 === i[0], s = "", o = 1;
              ;
              o++
            ) {
              if (255 === i[o]) break;
              if (s.length > 310) return f(p, 0, 1);
              s += i[o];
            }
            ((a = n(a, 2 + s.length)), (s = parseInt(s)));
            var b = n(a, 0, s);
            if (c)
              try {
                ...
                b = "";
                for (o = 0; o < u.length; o++) b += String.fromCharCode(u[o]);
              }
            (d.push(b), (a = n(a, s)));
          }
          var h = d.length;
    ...
    1252: function (e, t, r) {
      ((e.exports = r(1253)), (e.exports.parser = r(107)));
    },
    1253: function (e, t, r) {
      var f = r(467),
        a = r(262),
        d = r(172)("engine.io-client:socket"),
        n = r(471),
        i = r(107),
        c = r(463),
        s = r(170);
      ...
      ((e.exports = o),
        ...
        (o.prototype.probe = function (e) {
                ...
                if (!r)
                  if ("pong" === a.type && "probe" === a.data) {
                    if (
                      ...
                      return;
                    ((o.priorWebsocketSuccess = "websocket" === t.name),
          ...
          function i(r) {
            ...
            ((a.transport = t.name),
              n(),
              d('probe transport "%s" failed because of error: %s', e, r),
          ...
          function b(e) {
            t &&
              e.name !== t.name &&
              (d('"%s" works - aborting "%s"', e.name, t.name), n());
          }
          function u() {
        ...
        (o.prototype.sendPacket = function (e, t, r, f) {
          if (
            ("function" === typeof t && ((f = t), (t = void 0)),
            "function" === typeof r && ((f = r), (r = null)),
            "closing" !== this.readyState && "closed" !== this.readyState)
          ) {
            ((r = r || {}), (r.compress = !1 !== r.compress));
            var a = { type: e, data: t, options: r };
        ...
        (o.prototype.filterUpgrades = function (e) {
          for (var t = [], r = 0, f = e.length; r < f; r++)
            ~n(this.transports, e[r]) && t.push(e[r]);
          return t;
        }));
    },
    1255: function (e, t, r) {
      var f = r(260),
        ...
        d = r(262),
        n = r(171),
        i = r(172)("engine.io-client:polling-xhr");
      function c() {}
      function s(e) {
        if (
          (a.call(this, e),
      ...
      if (
        ...
        (s.prototype.doWrite = function (e, t) {
          var r = "string" !== typeof e && void 0 !== e,
            f = this.request({ method: "POST", data: e, isBinary: r }),
            a = this;
          (f.on("success", t),
          ...
          try {
            ...
            try {
              if (this.extraHeaders)
                for (var a in (t.setDisableHeaderCheck &&
                  t.setDisableHeaderCheck(!0),
                this.extraHeaders))
                  this.extraHeaders.hasOwnProperty(a) &&
                    t.setRequestHeader(a, this.extraHeaders[a]);
            } catch (d) {}
            if ("POST" === this.method)
              try {
                this.isBinary
    ...
    1260: function (e, t) {
      ...
      function h(e) {
        ...
        if (192 == (224 & t)) {
          if (((d = u()), (s = ((31 & t) << 6) | d), s >= 128)) return s;
          throw Error("Invalid continuation byte");
        }
        if (224 == (240 & t)) {
          if (
      ...
      function p(e, t) {
        ...
        var c,
          s = [];
        while (!1 !== (c = h(d))) s.push(c);
        return i(s);
      }
      e.exports = { version: "2.1.2", encode: b, decode: p };
    },
    1263: function (e, t, r) {
      function f(e) {
        var r,
        ...
        function a() {
          if (a.enabled) {
            var e = a,
              f = +new Date(),
              d = f - (r || f);
            ((e.diff = d), (e.prev = r), (e.curr = f), (r = f));
            ...
            var s = a.log || t.log || console.log.bind(console);
            s.apply(e, n);
          }
        }
        return (
    ...
    1264: function (e, t) {
      ...
      e.exports = function (e, t) {
        ...
        if ("number" === r && !1 === isNaN(e)) return t.long ? s(e) : c(e);
        throw new Error(
    ...
    1266: function (e, t, r) {
      (function (t) {
        var f,
          ...
          c = r(171),
          s = r(470),
          o = r(172)("engine.io-client:websocket");
        if ("undefined" !== typeof WebSocket) f = WebSocket;
        else if ("undefined" !== typeof self)
          f = self.WebSocket || self.MozWebSocket;
        else
          try {
            a = r(1267);
          } catch (h) {}
        ...
        function u(e) {
          ...
          (t && (this.supportsBinary = !1),
            ...
            this.usingBrowserWebSocket || (b = a),
            d.call(this, e));
        }
        ((e.exports = u),
          c(u, d),
          ...
          (u.prototype.write = function (e) {
            var r = this;
            this.writable = !1;
            for (var f = e.length, a = 0, d = f; a < d; a++)
              (function (e) {
                n.encodePacket(e, r.supportsBinary, function (a) {
                  if (!r.usingBrowserWebSocket) {
                    var d = {};
                    if (
                      (e.options && (d.compress = e.options.compress),
                      r.perMessageDeflate)
                    ) {
                      var n =
                        "string" === typeof a ? t.byteLength(a) : a.length;
                      n < r.perMessageDeflate.threshold && (d.compress = !1);
                    }
                  }
                  try {
                    r.usingBrowserWebSocket ? r.ws.send(a) : r.ws.send(a, d);
                  } catch (h) {
          ...
          (u.prototype.check = function () {
            return (
              !!b && !("__initialize" in b && this.name === u.prototype.name)
            );
          }));
    ...
    172: function (e, t, r) {
      (function (f) {
        ...
        function c() {
          ...
          return (
            !e && "undefined" !== typeof f && "env" in f && (e = f.env.DEBUG),
            e
          );
        }
        function s() {
      ...
      ((e.exports = c),
        ...
        (c.prototype._fixedNafMul = function (e, t) {
          ...
          for (n = 0; n < f.length; n += r.step) {
            c = 0;
            for (var o = n + r.step - 1; o >= n; o--) c = (c << 1) + f[o];
            s.push(c);
          }
          for (
            ...
            for (n = 0; n < s.length; n++)
              ((c = s[n]),
                c === h
                  ? (u = u.mixedAdd(r.points[n]))
                  : c === -h && (u = u.mixedAdd(r.points[n].neg())));
            b = b.add(u);
          }
          return b.toP();
        }),
        (c.prototype._wnafMul = function (e, t) {
          ...
          for (
            var a = f.points,
              n = d(t, r, this._bitLength),
              c = this.jpoint(null, null, null),
              s = n.length - 1;
            s >= 0;
            s--
          ) {
            for (var o = 0; s >= 0 && 0 === n[s]; s--) o++;
        ...
        (c.prototype._wnafMulAdd = function (e, t, r, f, a) {
          ...
          for (i = f - 1; i >= 1; i -= 2) {
            ...
            if (1 === o[l] && 1 === o[y]) {
              ...
              0 === t[l].y.cmp(t[y].y)
                ? ((v[1] = t[l].add(t[y])),
                  (v[2] = t[l].toJ().mixedAdd(t[y].neg())))
                : 0 === t[l].y.cmp(t[y].y.redNeg())
                  ? ((v[1] = t[l].toJ().mixedAdd(t[y])),
                    (v[2] = t[l].add(t[y].neg())))
                  : ((v[1] = t[l].toJ().mixedAdd(t[y])),
                    (v[2] = t[l].toJ().mixedAdd(t[y].neg())));
              ...
              ((u[l] = d(r[l], o[l], this._bitLength)),
                (u[y] = d(r[y], o[y], this._bitLength)),
                (h = Math.max(u[l].length, h)),
                (h = Math.max(u[y].length, h)));
          }
          ...
          for (i = h; i >= 0; i--) {
            ...
            while (i >= 0) {
              var I = !0;
              for (c = 0; c < f; c++)
                ((A[c] = 0 | u[c][i]), 0 !== A[c] && (I = !1));
              if (!I) break;
              (C++, i--);
            }
            if ((i >= 0 && C++, (x = x.dblp(C)), i < 0)) break;
            for (c = 0; c < f; c++) {
              var M = A[c];
              0 !== M &&
                (M > 0
                  ? (s = b[c][(M - 1) >> 1])
                  : M < 0 && (s = b[c][(-M - 1) >> 1].neg()),
                (x = "affine" === s.type ? x.mixedAdd(s) : x.add(s)));
            }
          }
        ...
        (c.prototype.decodePoint = function (e, t) {
          ...
          if (
            ...
            6 === e[0]
              ? i(e[e.length - 1] % 2 === 0)
              : 7 === e[0] && i(e[e.length - 1] % 2 === 1);
            var f = this.point(e.slice(1, 1 + r), e.slice(1 + r, 1 + 2 * r));
            return f;
          }
    ...
    1907: function (e, t, r) {
      ...
      try {
        ...
        if (
          ...
          "object" !== typeof s ||
          !("code" in s) ||
          "ERR_PROTO_ACCESS" !== s.code
        )
          throw s;
      }
      var n = !!f && d && d(Object.prototype, "__proto__"),
        i = Object,
        c = i.getPrototypeOf;
      e.exports =
      ...
      (d(c, n),
          ...
          if (this.zeroA && this.g && this.n && 1 === this.p.modn(3)) {
            ...
            if (e.lambda) r = new a(e.lambda, 16);
              ...
              0 === this.g.mul(n[0]).x.cmp(this.g.x.redMul(t))
                ? (r = n[0])
                : ((r = n[1]),
                  i(0 === this.g.mul(r).x.cmp(this.g.x.redMul(t))));
            }
            return (
              (f = e.basis
        ...
        (c.prototype._getEndoRoots = function (e) {
          var t = e === this.p ? this.red : a.mont(e),
            ...
            n = f.redAdd(d).fromRed(),
            i = f.redSub(d).fromRed();
          return [n, i];
        }),
        (c.prototype._getEndoBasis = function (e) {
          ...
          while (0 !== u.cmpn(0)) {
            var g = h.div(u);
            ((s = h.sub(g.mul(u))), (o = y.sub(g.mul(p))));
            var w = v.sub(g.mul(l));
            if (!f && s.cmp(b) < 0)
              ((t = c.neg()), (r = p), (f = s.neg()), (d = o));
            else if (f && 2 === ++m) break;
            ((c = s), (h = u), (u = s), (y = p), (p = o), (v = l), (l = w));
          }
          ((n = s.neg()), (i = o));
        ...
        (c.prototype._endoWnafMulAdd = function (e, t, r) {
          for (
            var f = this._endoWnafT1, a = this._endoWnafT2, d = 0;
            d < e.length;
            d++
          ) {
            var n = this._endoSplit(t[d]),
              i = e[d],
              c = i._getBeta();
            (n.k1.negative && (n.k1.ineg(), (i = i.neg(!0))),
          ...
          for (
            var s = this._wnafMulAdd(1, f, a, 2 * d, r), o = 0;
            o < 2 * d;
            o++
          )
            ((f[o] = null), (a[o] = null));
          ...
          if (this.curve.endo) {
            ...
            if (e) {
              ...
              ((e.beta = t),
                (t.precomputed = {
                  beta: null,
                  naf: e.naf && { wnd: e.naf.wnd, points: e.naf.points.map(f) },
                  doubles: e.doubles && {
                    step: e.doubles.step,
        ...
        (Point.prototype.mulAdd = function (e, t, r) {
          ...
          return this.curve.endo
            ? this.curve._endoWnafMulAdd(f, a)
            : this.curve._wnafMulAdd(1, f, a, 2);
        }),
        (Point.prototype.jmulAdd = function (e, t, r) {
          var f = [this, t],
            a = [e, r];
          return this.curve.endo
            ? this.curve._endoWnafMulAdd(f, a, !0)
            : this.curve._wnafMulAdd(1, f, a, 2, !0);
        }),
        ...
        (Point.prototype.neg = function (e) {
          ...
          if (e && this.precomputed) {
            ...
            t.precomputed = {
              naf: r.naf && { wnd: r.naf.wnd, points: r.naf.points.map(f) },
              doubles: r.doubles && {
                step: r.doubles.step,
        ...
        (s.prototype.add = function (e) {
          ...
          var s = i.redSqr(),
            o = s.redMul(i),
            b = f.redMul(s),
            u = c.redSqr().redIAdd(o).redISub(b).redISub(b),
            h = c.redMul(b.redISub(u)).redISub(d.redMul(o)),
        ...
        (s.prototype.mixedAdd = function (e) {
          ...
          var c = n.redSqr(),
            s = c.redMul(n),
            o = r.redMul(c),
            b = i.redSqr().redIAdd(s).redISub(o).redISub(o),
            u = i.redMul(o.redISub(b)).redISub(a.redMul(s)),
            h = this.z.redMul(n);
        ...
        (s.prototype.dblp = function (e) {
          ...
          for (t = 0; t < e; t++) {
            var o = d.redSqr(),
              b = s.redSqr(),
              u = b.redSqr(),
              h = o.redAdd(o).redIAdd(o).redIAdd(f.redMul(c)),
              p = d.redMul(b),
            ...
            var m = s.redMul(i);
            (t + 1 < e && (c = c.redMul(u)), (d = l), (i = m), (s = v));
          }
          return this.curve.jpoint(d, s.redMul(a), i);
        }),
        ...
        (s.prototype._zeroDbl = function () {
          ...
          if (this.zOne) {
            ...
            ((s = s.redIAdd(s)),
              (s = s.redIAdd(s)),
              (e = c),
              (t = i.redMul(n.redISub(c)).redISub(s)),
              (r = this.y.redAdd(this.y)));
          } else {
            var o = this.x.redSqr(),
              b = this.y.redSqr(),
              u = b.redSqr(),
              h = this.x.redAdd(b).redSqr().redISub(o).redISub(u);
            h = h.redIAdd(h);
            ...
            ((y = y.redIAdd(y)),
              (y = y.redIAdd(y)),
              (e = l.redISub(h).redISub(h)),
              (t = p.redMul(h.redISub(e)).redISub(y)),
        ...
        (s.prototype._threeDbl = function () {
          ...
          if (this.zOne) {
            ...
            var o = this.z.redSqr(),
              b = this.y.redSqr(),
              u = this.x.redMul(b),
              h = this.x.redSub(o).redMul(this.x.redAdd(o));
            h = h.redAdd(h).redIAdd(h);
            var p = u.redIAdd(u);
            p = p.redIAdd(p);
            var l = p.redAdd(p);
            ((e = h.redSqr().redISub(l)),
              (r = this.y.redAdd(this.z).redSqr().redISub(b).redISub(o)));
            var y = b.redSqr();
            ((y = y.redIAdd(y)),
              (y = y.redIAdd(y)),
              (y = y.redIAdd(y)),
              (t = h.redMul(p.redISub(e)).redISub(y)));
          }
          return this.curve.jpoint(e, t, r);
        }),
        ...
        (s.prototype.trpl = function () {
          ...
          var s = a.redIAdd(n).redSqr().redISub(d).redISub(i).redISub(c),
            o = t.redMul(s);
          ((o = o.redIAdd(o)), (o = o.redIAdd(o)));
          var b = this.x.redMul(i).redISub(o);
          ((b = b.redIAdd(b)), (b = b.redIAdd(b)));
          var u = this.y.redMul(s.redMul(c.redISub(s)).redISub(n.redMul(i)));
          ((u = u.redIAdd(u)), (u = u.redIAdd(u)), (u = u.redIAdd(u)));
      ...
      (a(i, d),
        ...
        (Point.prototype.dbl = function () {
          var e = this.x.redAdd(this.z),
            ...
            a = t.redSub(f),
            d = t.redMul(f),
            n = a.redMul(f.redAdd(this.curve.a24.redMul(a)));
          return this.curve.point(d, n);
        }),
        ...
        (Point.prototype.diffAdd = function (e, t) {
          var r = this.x.redAdd(this.z),
            ...
            n = d.redMul(r),
            i = a.redMul(f),
            c = t.z.redMul(n.redAdd(i).redSqr()),
            s = t.x.redMul(n.redISub(i).redSqr());
          return this.curve.point(c, s);
        }),
        (Point.prototype.mul = function (e) {
          for (
            var t = e.clone(),
              r = this,
              f = this.curve.point(null, null),
              a = this,
              d = [];
            0 !== t.cmpn(0);
            t.iushrn(1)
          ...
          for (var n = d.length - 1; n >= 0; n--)
            0 === d[n]
              ? ((r = r.diffAdd(f, a)), (f = f.dbl()))
              : ((f = r.diffAdd(f, a)), (r = r.dbl()));
          return f;
        }),
      ...
      function Point(e, t, r, f, d) {
        (n.BasePoint.call(this, e, "projective"),
          null === t && null === r && null === f
            ...
            : ((this.x = new a(t, 16)),
              (this.y = new a(r, 16)),
              (this.z = f ? new a(f, 16) : this.curve.one),
              (this.t = d && new a(d, 16)),
              this.x.red || (this.x = this.x.toRed(this.curve.red)),
              this.y.red || (this.y = this.y.toRed(this.curve.red)),
              this.z.red || (this.z = this.z.toRed(this.curve.red)),
      ...
      (d(c, n),
        ...
        (Point.prototype._projDbl = function () {
          ...
          if (this.curve.twisted) {
            f = this.curve._mulA(i);
            var s = f.redAdd(c);
            this.zOne
              ? ((e = n.redSub(i).redSub(c).redMul(s.redSub(this.curve.two))),
                (t = s.redMul(f.redSub(c))),
                (r = s.redSqr().redSub(s).redSub(s)))
              : ((a = this.z.redSqr()),
                (d = s.redSub(a).redISub(a)),
                (e = n.redSub(i).redISub(c).redMul(d)),
                (t = s.redMul(f.redSub(c))),
                (r = s.redMul(d)));
          } else
            ((f = i.redAdd(c)),
              (a = this.curve._mulC(this.z).redSqr()),
              (d = f.redSub(a).redSub(a)),
              (e = this.curve._mulC(n.redISub(f)).redMul(d)),
              (t = this.curve._mulC(f).redMul(i.redISub(c))),
              (r = f.redMul(d)));
        ...
        (Point.prototype._extAdd = function (e) {
          var t = this.y.redSub(this.x).redMul(e.y.redSub(e.x)),
            ...
            b = d.redMul(c),
            u = n.redMul(i);
          return this.curve.point(s, o, u, b);
        }),
        (Point.prototype._projAdd = function (e) {
          var t,
            ...
            o = this.x
              ...
              .redISub(d)
              .redISub(n),
            b = f.redMul(c).redMul(o);
          return (
            this.curve.twisted
              ? ((t = f.redMul(s).redMul(n.redSub(this.curve._mulA(d)))),
                (r = c.redMul(s)))
              : ((t = f.redMul(s).redMul(n.redSub(d))),
    ...
    1921: function (e, t, r) {
      ...
      ((e.exports = b),
        ...
        (b.prototype._truncateToN = function (e, t, r) {
          var a;
          if (f.isBN(e) || "number" === typeof e)
            ((e = new f(e, 16)), (a = e.byteLength()));
          else if ("object" === typeof e) ((a = e.length), (e = new f(e, 16)));
          else {
            var d = e.toString();
            ((a = (d.length + 1) >>> 1), (e = new f(d, 16)));
          }
          "number" !== typeof r && (r = 8 * a);
          var n = r - this.n.bitLength();
          return (
            n > 0 && (e = e.ushrn(n)),
        ...
        (b.prototype.sign = function (e, t, r, d) {
          if (
            ("object" === typeof r && ((d = r), (r = null)),
            d || (d = {}),
            "string" !== typeof e && "number" !== typeof e && !f.isBN(e))
          ) {
            (c(
          ...
          ((t = this.keyFromPrivate(t, r)),
            (e = this._truncateToN(e, !1, d.msgBitLength)),
            c(!e.isNeg(), "Can not sign a negative message"));
          var i = this.n.byteLength(),
            s = t.getPrivate().toArray("be", i),
            b = e.toArray("be", i);
          c(new f(b).eq(e), "Can not sign message");
          for (
            var u = new a({
                hash: this.hash,
                entropy: s,
            ...
            var l = d.k ? d.k(p) : new f(u.generate(this.n.byteLength()));
            if (
              ...
              if (!y.isInfinity()) {
                ...
                if (0 !== m.cmpn(0)) {
                  ...
                  if (((g = g.umod(this.n)), 0 !== g.cmpn(0))) {
                    var w =
                      (y.getY().isOdd() ? 1 : 0) | (0 !== v.cmp(m) ? 2 : 0);
                    return (
                      d.canonical &&
                        g.cmp(this.nh) > 0 &&
                        ((g = this.n.sub(g)), (w ^= 1)),
                      new o({ r: m, s: g, recoveryParam: w })
                    );
                  }
                }
              }
        ...
        (b.prototype.verify = function (e, t, r, f, a) {
          (a || (a = {}),
          ...
          return this.curve._maxwellTrick
            ? ((i = this.g.jmulAdd(s, r.getPublic(), b)),
              !i.isInfinity() && i.eqXToP(d))
            : ((i = this.g.mulAdd(s, r.getPublic(), b)),
              !i.isInfinity() && 0 === i.getX().umod(this.n).cmp(d));
        }),
        (b.prototype.recoverPubKey = function (e, t, r, a) {
          ...
          var d = this.n,
            ...
            b = 1 & r,
            u = r >> 1;
          if (i.cmp(this.curve.p.umod(this.curve.n)) >= 0 && u)
            throw new Error("Unable to find sencond key candinate");
          i = u
            ? this.curve.pointFromX(i.add(this.curve.n), b)
            : this.curve.pointFromX(i, b);
          var h = t.r.invm(d),
        ...
        (b.prototype.getKeyRecoveryParam = function (e, t, r, f) {
          if (((t = new o(t, f)), null !== t.recoveryParam))
    ...
    1922: function (e, t, r) {
      ...
      ((e.exports = n),
          ...
          if (e.x || e.y)
            return (
              "mont" === this.ec.curve.type
                ? d(e.x, "Need x coordinate")
                : ("short" !== this.ec.curve.type &&
                    "edwards" !== this.ec.curve.type) ||
                  d(e.x && e.y, "Need both x and y coordinate"),
        ...
        (n.prototype.derive = function (e) {
          return (
            e.validate() || d(e.validate(), "public point not validated"),
    ...
    1923: function (e, t, r) {
      ...
      function c(e, t) {
        ...
        for (var a = 0, d = 0, n = t.place; d < f; d++, n++)
          ((a <<= 8), (a |= e[n]), (a >>>= 0));
      ...
      ((e.exports = n),
        (n.prototype._importDER = function (e, t) {
          ...
          if (0 !== (128 & e[r.place])) return !1;
          var b = e.slice(r.place, o + r.place);
          if (0 === s[0]) {
            if (!(128 & s[1])) return !1;
            s = s.slice(1);
          }
        ...
        (n.prototype.toDER = function (e) {
          ...
          var f = [2];
          (o(f, t.length), (f = f.concat(t)), f.push(2), o(f, r.length));
          var d = f.concat(r),
            n = [48];
          return (o(n, d.length), (n = n.concat(d)), a.encode(n, e));
        }));
    },
    1924: function (e, t, r) {
      "use strict";
      ...
      ((e.exports = o),
        (o.prototype.sign = function (e, t) {
          ...
          return this.makeSignature({ R: a, S: c, Rencoded: d });
        }),
        ...
        (o.prototype.keyFromPublic = function (e) {
          return c.fromPublic(this, e);
        }),
        (o.prototype.keyFromSecret = function (e) {
          return c.fromSecret(this, e);
        }),
        (o.prototype.makeSignature = function (e) {
          return e instanceof s ? e : new s(this, e);
        }),
        (o.prototype.encodePoint = function (e) {
        ...
        (o.prototype.decodePoint = function (e) {
          e = d.parseBytes(e);
          var t = e.length - 1,
        ...
        (o.prototype.encodeInt = function (e) {
          return e.toArray("le", this.encodingLength);
        }),
        (o.prototype.decodeInt = function (e) {
          return d.intFromLE(e);
        }),
        (o.prototype.isPoint = function (e) {
    ...
    260: function (e, t, r) {
      ...
      e.exports = function (e) {
        var t = e.xdomain,
          ...
          a = e.enablesXDR;
        try {
          if ("undefined" !== typeof XMLHttpRequest && (!t || f))
    ...
    261: function (e, t, r) {
      ...
      ((e.exports = d),
        a(d.prototype),
        (d.prototype.onError = function (e, t) {
          var r = new Error(e);
          return (
    ...
    262: function (e, t, r) {
      ...
      ((e.exports = f),
        ...
        (f.prototype.emit = function (e) {
          ...
          if (r) {
            r = r.slice(0);
            for (var f = 0, a = r.length; f < a; ++f) r[f].apply(this, t);
          }
          return this;
        }),
      ...
      function i(e) {
        ...
        if ("undefined" !== typeof location) {
          var c = "https:" === location.protocol,
            s = location.port;
          (s || (s = c ? 443 : 80),
            (r = e.hostname !== location.hostname || s !== e.port),
            (n = e.secure !== c));
        }
        if (
          ((e.xdomain = r),
    ...
    468: function (e, t, r) {
      var f = r(261),
        ...
        n = r(171),
        i = r(470),
        c = r(172)("engine.io-client:polling");
      e.exports = o;
      var s = (function () {
        var e = r(260),
          t = new e({ xdomain: !1 });
      ...
      function o(e) {
        var t = e && e.forceBase64;
        ((s && !t) || (this.supportsBinary = !1), f.call(this, e));
      }
      (n(o, f),
        ...
        (o.prototype.onData = function (e) {
          ...
          var r = function (e, r, f) {
            if (("opening" === t.readyState && t.onOpen(), "close" === e.type))
              return (t.onClose(), !1);
            t.onPacket(e);
          };
          (d.decodePayload(e, this.socket.binaryType, r),
            "closed" !== this.readyState &&
              ((this.polling = !1),
        ...
        (o.prototype.uri = function () {
          var e = this.query || {},
            ...
            r = "";
          (!1 !== this.timestampRequests && (e[this.timestampParam] = i()),
    ...
    54: function (e, t, r) {
      ...
      function i(e, t, r) {
        var f,
          a = new Array(Math.max(e.bitLength(), r) + 1);
        for (f = 0; f < a.length; f += 1) a[f] = 0;
        var d = 1 << (t + 1),
          n = e.clone();
