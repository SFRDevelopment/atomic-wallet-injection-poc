(this["webpackJsonp"] = this["webpackJsonp"] || []).push([
  [212, 410],
  {
    ...
    3633: function (t, e, n) {
      ...
      e.default = {
        name: "AtomicSelect",
        components: { SelectArrow: i.SelectArrow },
        props: {
    ...
    3975: function (t, e, n) {
      t.exports = n.p + "imgs/atomic-man-like--static.png";
    },
    4899: function (t, e, n) {
      "use strict";
      n.r(e);
    ...
    4901: function (t, e, n) {
      ...
      e.default = {
        name: "SupportPopup",
        components: { AtomicSelect: r.default },
        data: () => ({
          tags: [],
          userTopic: "",
          userEmail: "",
        ...
        mounted() {
          this.$bus.$on("openSupportPopup", (t) => {
            const e =
              null !== t && void 0 !== t && t.isNotText ? "" : "\n\n\n\n";
            ((this.userComment =
              null !== t && void 0 !== t && t.additionalText
                ? `${e}${t.additionalText}`
                : ""),
              (this.isSupportPopup = !0),
              null !== t && void 0 !== t && t.tags && (this.tags = t.tags),
              null !== t &&
                void 0 !== t &&
                t.subject &&
                this.setSelect(t.subject),
              null !== t &&
                void 0 !== t &&
                t.topic &&
                (this.userTopic = t.topic));
          });
        },
        methods: {
          resetFormState() {
            ((this.isValidEmail = !0),
              (this.isValidSubject = !0),
          ...
          validateForm() {
            return (
              ...
              this.isValidComment && this.isValidEmail && this.isValidSubject
            );
          },
          sendResult() {
            if (this.validateForm()) {
              ...
              (this.tags.length > 0 && (n.tags = this.tags),
                this.userTopic && (n.topic = this.userTopic),
                this.$reviews.sendReview(n),
                (this.isSupportPopup = !1),
                setTimeout(() => {
                  ((this.isSupportPopup = !0),
                    (this.isSendSuccess = !0),
                    setTimeout(() => this.closeSupportPopup(), s));
                }, u));
            }
          },
        },
          ...
          return i("transition", { attrs: { name: "fade", appear: "" } }, [
            i(
              "div",
              {
                ...
                class: { "rate-popup_show": t.isSupportPopup },
                attrs: { "data-test-id": "contact_support" },
              },
              [
                i(
                  "div",
                    ...
                    t.isSendSuccess
                      ...
                      : i(
                          "div",
                          {
                            ...
                            attrs: { "data-test-id": "contact_close" },
                            on: { click: t.closeSupportPopup },
                          },
                          [t._v("\n        ✕\n      ")],
                        ),
                    t._v(" "),
                    t.isSendSuccess
                      ? i("p", { staticClass: "rate-popup__title-big" }, [
                          t._v(
                            "\n        " +
                              t._s(t.$t("supportPopup.wereOnIt")) +
                              "\n      ",
                          ),
                        ])
                      : i("p", { staticClass: "rate-popup__title-big" }, [
                          t._v(
                            "\n        " +
                              t._s(t.$t("supportPopup.contactSupport")) +
                              "\n      ",
                          ),
                        ]),
                    t._v(" "),
                    t.isSendSuccess
                      ? i("div", { staticClass: "m-t-20" }, [
                          i("p", { staticClass: "rate-popup__text" }, [
                            t._v(
                              "\n          " +
                                t._s(t.$t("supportPopup.messageSent")) +
                                "\n        ",
                            ),
                          ]),
                          t._v(" "),
                      ...
                      : i(
                          ...
                          [
                            i("div", { staticClass: "rate-popup__row" }, [
                              i("input", {
                                directives: [
                                  {
                                    name: "model",
                              ...
                              !t.isValidEmail && t.userEmail
                                ? i("p", { staticClass: "rate-popup__error" }, [
                                    t._v(
                                      "\n            " +
                            ...
                            i("AtomicSelect", {
                              attrs: {
                                ...
                                label:
                                  t.userSubject ||
                                  t.$reviews.settings.selectTitle,
