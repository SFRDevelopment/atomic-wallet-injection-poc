  ...
  [26, 16, 32, 48],
  {
        ...
        function m(t) {
          ...
          return t
            ? ("string" === typeof t.salt &&
                (t.salt = e.from(w("salt", t.salt), "hex")),
              "string" === typeof t.iv &&
                (t.iv = e.from(w("iv", t.iv, 32), "hex")),
              "string" === typeof t.uuid &&
                (t.uuid = e.from(w("uuid", t.uuid, 32), "hex")),
              t.salt && g("salt", t.salt),
              t.iv && g("iv", t.iv, 16),
              t.uuid && g("uuid", t.uuid, 16),
              n(n({}, r), t))
            : r;
        }
        function _(e) {
    ...
    3263: function (e, t, r) {
      ...
      e.exports = function (e) {
        ...
        return { encode: t, decode: a, decodeUnsafe: o };
      };
    },
    3589: function (e, t, r) {
      "use strict";
      ...
      (function (e) {
        ...
        function m(t, r) {
          ...
          if (i.locked) {
            ...
            var s = w(e.from(r), a.salt, { keysize: 32, ivsize: 16 }),
    ...
    4492: function (e, t, r) {
      ...
      function o(e) {
        ...
        for (var p = 0; p < u; ++p) {
          ...
          for (
            var b = r[0], w = r[1], g = r[2], m = r[3], _ = r[4], K = 0;
            K < 80;
            ++K
          ) {
            var k = Math.floor(K / 20),
              E = (i(b, 5) + n(k, w, g, m) + _ + t[k] + d[K]) >>> 0;
            ((_ = m), (m = g), (g = i(w, 30) >>> 0), (w = b), (b = E));
          }
          ((r[0] = (r[0] + b) >>> 0),
            (r[1] = (r[1] + w) >>> 0),
            (r[2] = (r[2] + g) >>> 0),
