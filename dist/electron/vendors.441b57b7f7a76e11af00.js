      ...
      (function (r) {
        ...
        for (
          var e = [null, 0, {}],
            ...
            l = a * c,
            p = function (t, r) {
              ((this.codepoint = t), (this.feature = r));
            },
            C = {},
            g = [],
            v = 0;
        ...
        function B(t, r, e) {
          return e ? t(r, e) : new p(r, null);
        }
        function m(t, r, e) {
          var n;
          if (r < o || (o + a <= r && r < i) || i + l < r) return t(r, e);
          if (o <= r && r < o + a) {
            var C = {},
              g = (r - o) * f;
            for (n = 0; n < f; ++n) C[s + n] = i + h * (n + g);
            return new p(r, [, , C]);
          }
          var v = r - i,
            w = v % h,
            d = [];
          if (0 !== w) d[0] = [i + v - w, u + w];
          else
            for (
              d[0] = [o + Math.floor(v / c), s + Math.floor((v % c) / h)],
                d[2] = {},
                n = 1;
              n < h;
              ++n
        ...
        function F(t, r, n) {
          return r < 60 || (13311 < r && r < 42607) ? new p(r, e) : t(r, n);
        }
        var y = [F, w, B, m, d];
        ((p.fromCharCode = y.reduceRight(function (t, r) {
          return function (e, n) {
            return r(t, e, n);
          };
        }, null)),
          (p.isHighSurrogate = function (t) {
            return t >= 55296 && t <= 56319;
          }),
          (p.isLowSurrogate = function (t) {
        ...
        N.prototype.next = function () {
          if (this.str && this.cursor < this.str.length) {
            var t,
              r = this.str.charCodeAt(this.cursor++);
            return (
              p.isHighSurrogate(r) &&
                this.cursor < this.str.length &&
                p.isLowSurrogate((t = this.str.charCodeAt(this.cursor))) &&
                ((r = 1024 * (r - 55296) + (t - 56320) + 65536), ++this.cursor),
              p.fromCharCode(r)
            );
          }
        ...
        var b = function (t, r) {
          ((this.it = t), (this.canonical = r), (this.resBuf = []));
        };
        b.prototype.next = function () {
          function t(r, e) {
            var n = e.getDecomp();
            if (!n || (r && e.isCompatibility())) return [e];
            for (var i = [], o = 0; o < n.length; ++o) {
              var s = t(r, p.fromCharCode(n[o]));
              i = i.concat(s);
            }
            return i;
          }
        ...
        S.prototype.next = function () {
          ...
          if (0 === this.resBuf.length)
            do {
              ...
              if (0 !== t)
                for (; e > 0; --e) {
                  var n = this.resBuf[e - 1],
                    i = n.getCanonicalClass();
                  if (i <= t) break;
                }
              this.resBuf.splice(e, 0, r);
            } while (0 !== t);
          return this.resBuf.shift();
        };
        var x = function (t) {
          ...
          while (0 === this.resBuf.length) {
            ...
            if (0 === this.procBuf.length)
              ...
              var r = this.procBuf[0],
                e = r.getComposite(t),
                n = t.getCanonicalClass();
              e && (this.lastClass < n || 0 === this.lastClass)
                ? (this.procBuf[0] = e)
                : (0 === n &&
                    ((this.resBuf = this.procBuf), (this.procBuf = [])),
                  (this.lastClass = n),
        ...
        var k = function (t, r) {
            switch (t) {
              case "NFD":
                return new S(new b(new N(r), !0));
              case "NFKD":
                return new S(new b(new N(r), !1));
              case "NFC":
                return new x(new S(new b(new N(r), !0)));
              case "NFKC":
                return new x(new S(new b(new N(r), !1)));
            }
            throw t + " is invalid";
          },
          D = function (t, r) {
        ...
        var M = { nfc: z, nfd: K, nfkc: E, nfkd: A };
        ((t.exports = M),
          (M.shimApplied = !1),
          String.prototype.normalize ||
            (Object.defineProperty(String.prototype, "normalize", {
              ...
              value: function () {
                var t = "" + this,
                  r = void 0 === arguments[0] ? "NFC" : arguments[0];
                if (null === this || void 0 === this)
                  throw new TypeError(
                    "Cannot call method on " +
                      Object.prototype.toString.call(this),
                  );
                if ("NFC" === r) return M.nfc(t);
                if ("NFD" === r) return M.nfd(t);
                if ("NFKC" === r) return M.nfkc(t);
                if ("NFKD" === r) return M.nfkd(t);
