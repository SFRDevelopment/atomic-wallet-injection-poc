(this["webpackJsonp"] = this["webpackJsonp"] || []).push([
  [312, 32],
  {
    2667: function (e, t, a) {
      ...
      (function (e) {
        ...
        const D = new C.default(() =>
          ...
          p = new C.default(() => a.e(48).then(a.t.bind(null, 2655, 7))),
          F = "Flare",
          L = "FLR",
          P = "m/44'/0'/0'/0/0",
          S = 18,
          ...
          G = 14,
          O = 1e9,
          I = "0xbdd5468D969e585E38B5a0EEADDb56D5B76814ff",
          U = "150000",
          M = "21000",
          _ = "55000",
          H = "pending",
          X = "0x0",
          V = "0x1D80c49BbBCd1C0911346656B529DF9E5c2F783d",
          W = "0x85627d71921AE25769f5370E482AdA5E1e418d37",
          K = "50250000000000000";
        var J = new WeakMap(),
          Y = new WeakSet();
        class FLRCoin extends (0, x.StakingMixin)(
          (0, x.Web3Mixin)(
            (0, x.HasProviders)((0, x.HasTokensMixin)(c.default)),
          ),
        ) {
          constructor(e) {
            var t;
            ...
            (super({
              ...e,
              name: null !== a && void 0 !== a ? a : F,
              ticker: null !== i && void 0 !== i ? i : L,
              decimal: null !== r && void 0 !== r ? r : S,
              unspendableBalance:
                null !== (t = c.unspendableBalance) && void 0 !== t ? t : R,
            }),
              w(this, Y),
              T(this, J, void 0),
              (this.derivation = P),
              this.setExplorersModules([k.default, v.default]),
          ...
          setFeeData(e) {
            (void 0 === e && (e = {}),
              super.setFeeData(e),
              (this.gasLimit = e.gasLimit || M),
              (this.stakingGasLimit = e.stakingGasLimit || U),
              (this.gasLimitCoefficient = e.gasLimitCoefficient),
              (this.gasPriceCoefficient = e.gasPriceCoefficient),
              (this.defaultGasPrice = new this.BN(e.defaultGasPrice * O)),
              (this.defaultMaxGasPrice = e.defaultMaxGasPrice),
              (this.autoClaimGasLimit = e.autoClaimGasLimit || _),
              (this.reservedForStake = e.reservedForStake || K),
              (this.stakingContract = e.stakingContract || V),
              (this.rewardsContract = e.rewardsContract || W),
          ...
          loadWallet(e) {
            return new Promise(async (t, a) => {
              const [{ default: i }, { hdkey: r }] = await Promise.all([
                D.get(),
                p.get(),
              ]);
              this.coreLibrary = new i(this.baseUrl);
              const c = r.fromMasterSeed(e),
                n = c.getWallet(),
                s = await this.coreLibrary.eth.accounts.privateKeyToAccount(
                  n.getPrivateKeyString(),
                );
              s
                ? (N(J, this, s.privateKey),
                ...
                : a(new Error(L + " cant get a wallet!"));
            });
          }
          getAddress() {
            try {
              N(
                J,
                this,
                this.coreLibrary.eth.accounts.privateKeyToAccount(E(J, this))
                  .address,
              );
            } catch (e) {
            ...
            let t,
              {
                ...
                multiplier: d = this.gasPriceCoefficient,
              } = e;
            if ((await this.getNonce(), !n)) {
              const e = await this.getGasPrice();
              t = Number(e.toString()) * d;
            }
            const o = {
              to: a,
              value: i,
              gas: s,
              chainId: G,
              gasPrice: new this.BN(n || t),
              nonce: c || this.nonce.toNumber(),
            };
            "" !== r && null !== r && (o.data = r);
          ...
          async createTokenTransaction(e) {
            ...
            return this.createTransaction({
              ...
              paymentData: o,
              userGasPrice: r,
              gasLimit: c || (await this.estimateGas(a, t)),
              multiplier: s,
              nonce: d,
            });
          }
          ...
          async getMaxFeePerGas(e) {
            ...
            if (!t)
              throw new h.ExternalError({
                type: g.EXTERNAL_ERROR,
                error: "Failed to get getMaxFeePerGas",
                instance: this,
              });
            return t.mul(new r.default(e)).toString();
          }
          async estimateGasForSendNft(e, t, a, i, r) {
            void 0 === r && (r = 1);
            try {
              const c = await this.getProvider("nft-send").estimateGas(
                e,
                t,
                a,
                i,
              );
              return Math.ceil(c * r).toString();
            } catch (c) {
              throw (
                console.warn(c),
                new h.ExternalError({
          ...
          async getNftTransferGasParams(e, t, a) {
            let { userGasPrice: i, userGasLimit: c } = a;
            const {
                address: n,
                nftGasPriceCoefficient: s,
                nftGasLimitCoefficient: d,
              ...
              b = d || l,
              h = [
                new r.default(m).mul(new r.default(u)).toString(),
                Math.ceil(Number(f) * b).toString(),
              ],
              g = (await this.getNonce()).toNumber(),
              [y, k] = await Promise.allSettled([
                i || this.getMaxFeePerGas(u),
                c || this.estimateGasForSendNft(n, e, g, t, b),
              ]).then((e) =>
                e.map((e, t) => ("fulfilled" === e.status ? e.value : h[t])),
              );
            return { gasLimit: k, gasPrice: y, nonce: g };
          }
          async getNftFee(e) {
            let {
              contractAddress: t,
            ...
            try {
              const e = await this.getProvider("nft-send").getNftContractData(
                ...
                { gasLimit: s, gasPrice: d } =
                  await this.getNftTransferGasParams(c, e, n);
              return new r.default(d).mul(new r.default(s));
            } catch (s) {
              throw new h.ExternalError({
                type: g.EXTERNAL_ERROR,
                error: s,
          ...
          async getNonce() {
            return (
              (this.nonce = new this.BN(
                await this.coreLibrary.eth.getTransactionCount(this.address, H),
              )),
              this.nonce
            );
          }
          async getFee(e) {
            ...
            const c = t || (await this.getGasPrice());
            return new r.default(String(c)).mul(
              new this.BN(a || this.gasLimit).mul(new this.BN(i)),
            );
          }
          async getGasPrice(e) {
            if ((void 0 === e && (e = !1), e)) return this.defaultGasPrice;
            const t = new this.BN(this.gasPriceCoefficient),
              a = new this.BN(Number(this.defaultGasPrice) / O),
              i = a.add(t);
            return new this.BN(Number(i) * O);
          }
          async estimateGas(e, t, a, i) {
            ...
            return c ? Math.round(c * this.gasLimitCoefficient).toString() : i;
          }
          ...
          async getInfo(e) {
            ...
            try {
              ...
              f.default.error({ instance: this, error: a });
            }
            return { balance: t.balance, balances: this.balances };
          }
          createToken(e) {
            return new n.FLRToken({ parent: this, ...e });
          }
          ...
          async getTokenList() {
            ...
            try {
              e = await u.default.get(b.ConfigKey.FlareTokens);
            } catch (t) {
          ...
          async getBannedTokenList() {
            let e;
            try {
              e = await u.default.get("flare-tokens-banned");
            } catch (t) {
              f.default.error({ instance: this, error: t });
            }
            return e || [];
          ...
          async setPrivateKey(e) {
            ...
            ((this.coreLibrary = new t(this.baseUrl)), N(J, this, e));
          }
          getGasRange(e) {
          ...
          async createStakeTransaction(e) {
            let { amount: t, validator: a } = e;
            const i = Object.keys(this.getValidators()).length > 0,
              r = await this.createDepositTransaction({ amount: t });
            return i
              ? r
              : (await this.sendTransaction(r),
                await this.getNonce(),
                this.createDelegationTransaction({ validator: a }));
          }
          createUnstakeTransaction(e) {
            let { amount: t } = e;
            const a = this.createSmartContractCall({
              smartContractAddress: this.stakingContract,
              action: "unstake",
          ...
          createDelegationTransaction(e) {
            let { validator: t } = e;
            const a = "10000",
              i = this.createSmartContractCall({
                smartContractAddress: this.stakingContract,
                action: "delegate",
                args: [t, a],
              });
          ...
          async createClaimTransaction(e) {
            ...
            const { manager: a, address: i } = await B(Y, this, q).call(this),
              r = await a.methods.getEpochsWithUnclaimedRewards(t).call(),
              c = Math.max(...r) || 0,
              n = a.methods
                .claim(this.address, this.address, c, !0)
                .encodeABI();
            return this.createTransaction({
              address: i,
              paymentData: n,
          ...
          calculateTotal(e) {
            let { balance: t, staked: a, rewards: i } = e;
            return new y.default(t.toBN().add(a.toBN()).add(i.toBN()), this);
          }
          async calculateAvailableForStake(e) {
            let { balance: t } = e;
            const a = await this.getFee({ gasLimit: this.stakingGasLimit }),
              i = new this.BN(this.reservedForStake),
              r = t.toBN().sub(a).sub(i);
            return new y.default(r.isNeg() ? "0" : r, this);
          }
          async createAutoClaimTransaction() {
            const { manager: e } = await B(Y, this, q).call(this),
              t = await e.methods.claimSetupManager().call(),
              a = await u.default.get(b.ConfigKey.FlareClaimExecutors),
              i = a.map((e) => {
                let { address: t } = e;
                return t;
              }),
              r = a
                .reduce((e, t) => {
                  let { fee: a } = t;
                  return ((e = e.add(new this.BN(this.toMinimalUnit(a)))), e);
                }, new this.BN("0"))
                .toString(),
              c = new this.coreLibrary.eth.Contract(o.default, t),
              n = c.methods.setClaimExecutors(i).encodeABI();
            return this.createTransaction({
              address: t,
              paymentData: n,
              amount: r,
          ...
          async getActiveAutoClaim() {
            const { manager: e } = await B(Y, this, q).call(this),
              t = await e.methods.claimSetupManager().call(),
              a = new this.coreLibrary.eth.Contract(o.default, t);
            return a.methods.claimExecutors(this.address).call();
          }
          async fetchDelegations(e) {
            void 0 === e && (e = this.address);
            const t = new this.coreLibrary.eth.Contract(
                s.default,
                V,
              ).methods.delegatesOf(e),
              { _delegateAddresses: a, _bips: i } = await t.call();
            return { providers: a, delegatePercentage: i };
          }
          async fetchUnclaimedRewards(e) {
            void 0 === e && (e = this.address);
            let t = new this.coreLibrary.eth.Contract(
              d.default,
              this.rewardsContract,
            );
            const a = await t.methods.newFtsoRewardManager().call();
            a &&
              Number(a) > 0 &&
              (t = new this.coreLibrary.eth.Contract(d.default, a));
            const i = await t.methods.getEpochsWithUnclaimedRewards(e).call();
            return Promise.all(
              i.map((a) => t.methods.getStateOfRewards(e, a).call()),
            );
          }
          calculateDelegatedVotes(e) {
            return Object.values(e).reduce((e, t) => {
              let { delegatedVotes: a } = t;
              return ((e = e.add(a.toBN())), e);
            }, new this.BN("0"));
          }
          calculateAvailableVotes(e) {
            let { staked: t, delegatedVotes: a } = e;
            return t.toBN().sub(a.toBN());
          }
          calculateRewards(e) {
            return e
              ? e.reduce((e, t) => {
                  let { _rewardAmounts: a } = t;
                  return (
                    (e = e.add(
                      a.reduce(
                        (e, t) => ((e = e.add(new this.BN(t))), e),
                        new this.BN("0"),
                      ),
                    )),
                    e
          ...
          async fetchStakingInfo() {
            var e, t;
            const a = new y.default(
                null !==
                  (e =
                    null === (t = this.tokens[V.toLowerCase()]) || void 0 === t
                      ? void 0
                      : t.balance) && void 0 !== e
                  ? e
                  : "0",
              ...
              { providers: i = [], delegatePercentage: r = [] } =
                await this.fetchDelegations();
            let c;
            try {
              c = await this.fetchUnclaimedRewards();
            } catch (g) {
              f.default.error({ instance: this, error: g });
            }
            const n = i.reduce(
                (e, t, i) => (
                  (e[t] = {
                    delegatedVotes: new y.default(
                      a
                        .toBN()
                        .div(new this.BN(100))
                        .mul(new this.BN(r[i] / 100))
                        .toString(),
                      this,
                    ),
                  }),
              ...
              s = await this.getActiveAutoClaim(),
              d = new y.default(this.calculateDelegatedVotes(n), this),
              o = this.calculateAvailableVotes({
                staked: a,
                delegatedVotes: d,
              }),
              l = new y.default(this.calculateRewards(c), this),
              m = await u.default.get(b.ConfigKey.FlareClaimExecutors),
              h = m.reduce((e, t) => {
                let { fee: a } = t;
                return ((e = e.add(new this.BN(this.toMinimalUnit(a)))), e);
              }, new this.BN("0"));
            return {
              staked: a,
              validators: n,
              availableVotes: new y.default(o.isNeg() ? "0" : o, this),
              delegatedVotes: d,
              availableWithdrawals: a,
              rewards: l,
              additional: {
                autoClaimExecutors: s,
                autoClaimFee: h,
                activeAutoClaim: s && s.length > 0,
              },
            };
          }
          getNextDropDate() {
            const e = new Date();
            return l.default.reduce((t, a) => {
              const i = t - e;
              return i > 0 && i < a - e ? t : a;
            });
          }
          signData(e) {
            return this.coreLibrary.eth.accounts.sign(e, E(J, this));
          }
          signWithCustomSigner(t) {
            let { data: a, signer: i } = t;
            return i({ ...a, privateKey: e.from(E(J, this).slice(2), "hex") });
          }
        }
        async function q() {
          let e = new this.coreLibrary.eth.Contract(
            d.default,
            this.rewardsContract,
          );
          const t = await e.methods.newFtsoRewardManager().call(),
            a = t && Number(t) > 0;
          return (
            a && (e = new this.coreLibrary.eth.Contract(d.default, t)),
            { manager: e, address: a ? t : this.rewardsContract }
          );
        }
        t.default = FLRCoin;
    ...
    4919: function (e, t, a) {
      ...
      class BlockscoutExplorer extends c.default {
        getAllowedTickers() {
          return ["ETH", "ETC", "FLR"];
        }
        async request(e, t, a, i) {
          (void 0 === t && (t = "get"),
            void 0 === a && (a = {}),
            void 0 === i && (i = n.UNDEFINED_OPERATION_ERROR));
          const r = await super.request(e, t, a, i);
          if ("0" === r.status) {
            if ([f, n.GET_TRANSACTIONS_TYPE].includes(i)) return [];
        ...
        async getTokensInfo(e, t) {
          ...
          return this.modifyInfoResponse({ tokens: a });
        }
        ...
        getTransactionsParams(e, t, a) {
          return { module: "account", action: "txlist", address: e };
        }
        getTransferParams(e, t, a) {
          return { module: "account", action: "tokentx", address: e };
        }
        async getTransactions(e) {
          let { address: t, offset: a = 0, limit: i = this.defaultTxLimit } = e;
          try {
            var r;
            const e = await this.request(
                this.getTransactionsUrl(t),
                this.getTransactionsMethod(),
                this.getTransactionsParams(t, a, i),
                n.GET_TRANSACTIONS_TYPE,
              ).catch(() => []),
              c = ["ETH", "FLR"].includes(this.wallet.ticker)
                ? await this.request(
                    this.getTransactionsUrl(t),
                    this.getTransactionsMethod(),
                    this.getTransferParams(t, a, i),
                    n.GET_TRANSACTIONS_TYPE,
                  ).catch(() => [])
                : [],
              s = this.modifyTokenTransactionsResponse(
                null !==
                  (r = null === c || void 0 === c ? void 0 : c.reverse()) &&
                  void 0 !== r
                  ? r
                  : [],
                t,
        ...
        async getTokenList() {
          let e;
          try {
            e = await r.default.get("ethereum-tokens");
          } catch (t) {
        ...
        getTxFee(e) {
          const t = new this.wallet.BN(e.gasUsed),
            a = new this.wallet.BN(e.gasPrice),
            i = new this.wallet.BN(this.wallet.feeCoefficient || 1),
            r = i.mul(t.mul(a)).toString();
    ...
    7180: function (e) {
      e.exports = JSON.parse(
        "[1679011200000,1681603200000,1684195200000,1686787200000,1689379200000,1691971200000,1694563200000,1697155200000,1699747200000,1702339200000,1704931200000,1707523200000,1710115200000,1712707200000,1715299200000,1717891200000,1720483200000,1723075200000,1725667200000,1728259200000,1730851200000,1733443200000,1736035200000,1738627200000,1741219200000,1743811200000,1746403200000,1748995200000,1751587200000,1754179200000,1756771200000,1759363200000,1761955200000,1764547200000,1767139200000,1769731200000]",
      );
    },
    7181: function (e) {
      e.exports = JSON.parse(
        '[{"name":"Wrapped Flare","ticker":"WFLR","contract":"0x1D80c49BbBCd1C0911346656B529DF9E5c2F783d","decimal":"18","visibility":true}]',
      );
    },
  },
]);
