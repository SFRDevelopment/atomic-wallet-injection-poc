  ...
  [368, 32],
  {
    2701: function (e, t, s) {
      ...
      var n = r(s(230)),
        ...
        o = s(27),
        l = s(2806);
      const { BITCORE: c } = o.LIB_NAME_INDEX,
        u = "Bitcoin Cash",
        d = "BCH",
        f = "m/44'/145'/0'/0/0",
        h = 8,
        T = "0";
      class BCHCoin extends (0, l.HasProviders)(
        (0, l.BitcoreMixin)(
          (0, l.BitcoreBitcoinCashMixin)((0, l.BitcoinLikeFeeMixin)(n.default)),
        ),
      ) {
        constructor(e) {
          let {
          ...
          const p = {
            ...
            ticker: d,
            decimal: h,
            unspendableBalance: T,
            socket: m,
            dependencies: {
              [c]: new a.default(() =>
                Promise.all([s.e(43), s.e(55)]).then(s.t.bind(null, 6883, 7)),
              ),
            },
            explorers: o,
            txWebUrl: l,
