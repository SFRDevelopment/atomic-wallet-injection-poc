  ...
  [219, 410],
  {
    2663: function (t, e, n) {
      ...
      var s = n(7026),
        ...
        c = null,
        d = null,
        f = Object(u["a"])(a.a, s["a"], s["b"], l, o, c, d);
      e["default"] = f.exports;
    },
    2780: function (t, e, n) {
      "use strict";
    ...
    4902: function (t, e, n) {
      ...
      e.default = {
        name: "UpdatesPopup",
        components: { CoinIcon: i.default, ClockIcon: s.ClockIcon },
        data: () => ({
          percent: 0,
          status: "available",
          isUpdateAvailable: !1,
        ...
        mounted() {
          (this.$electron.ipcRenderer.send("checking-for-update"),
            this.$electron.ipcRenderer.on("update-available", () => {
              ((this.status = "available"), (this.isUpdateAvailable = !0));
            }),
            this.$electron.ipcRenderer.on("download-progress", (t) => {
              ((this.status = "downloading"),
                this.$nextTick(() => {
                  this.percent = Math.min(u, t);
                }));
            }),
        ...
        methods: {
          close() {
            "downloading" === this.status || "restart" === this.status
              ? (this.isMinimumScreen = !0)
              : (this.isUpdateAvailable = !1);
          },
          download() {
            ((this.status = "downloading"),
              this.$electron.ipcRenderer.send("download-initiated"));
          },
          restart() {
            this.$electron.ipcRenderer.send("restart-initiated");
          },
          async fetchSettings() {
            try {
              this.releaseNotes = await a.ConfigManager.get(
                "new-release-features-desktop",
                !0,
              );
              const {
                assets: t = null,
    ...
    7026: function (t, e, n) {
      ...
      var r = function () {
          ...
          return n("transition", { attrs: { name: "fade", appear: "" } }, [
            t.isUpdateAvailable && t.releaseNotes
              ? n(
                  "div",
                  {
                    ...
                    class: {
                      ...
                      "updates--minimum__restart":
                        t.isMinimumScreen && "restart" === t.status,
                    },
                  },
                  [
                    t.isMinimumScreen && "downloading" === t.status
                      ? n(
                          "div",
                          {
                          ...
                          [
                            n(
                              ...
                              [
                                ...
                                n(
                                  ...
                                  [
                                    t._v(
                                      t._s(t.$t("updatesPopup.downloading")),
                                    ),
                                  ],
                                ),
                              ],
                            ...
                            t._v(" "),
                            n("div", { staticClass: "updates__progress" }, [
                              n("span", { style: { width: t.percent + "%" } }),
                            ]),
                          ],
                        )
                      : t.isMinimumScreen && "restart" === t.status
                        ? n("div", { staticClass: "position-bottom flex" }, [
                            n(
                              "button",
                              {
                                staticClass:
                                  "new-button new-button-large new-button-yellow new-button-max300",
                                on: { click: t.restart },
                              },
                              [
                                t._v(
                                  "\n        " +
                                    t._s(
                                      t.$t(
                                        "updatesPopup.restartAtomicWalletToUpdate",
                                      ),
                                    ) +
                                    "\n      ",
                                ),
                        ...
                        : n("div", [
                            n("div", { staticClass: "flex space-between" }, [
                              n("div", { staticClass: "new-title-large" }, [
                                t._v(
                                  "\n          " +
                                    t._s(
                                      t.$t("updatesPopup.newVersionAvailable", {
                                        version: t.version,
                                      }),
                                    ) +
                                    "\n        ",
                              ...
                              n(
                                ...
                                {
                                  staticClass:
                                    "hover-opacity new-text-large close",
                                  on: { click: t.close },
                                },
                                [t._v("\n          ✕\n        ")],
                              ),
                              ...
                              ? n("div", { staticClass: "m-t-20" }, [
                                  n(
                                    ...
                                    [
                                      t._v(
                                        t._s(
                                          t.$t("updatesPopup.assetsUpdated"),
                                        ),
                                      ),
                                    ],
                                  ),
                                  ...
                                  n(
                                    ...
                                    {
                                      staticClass:
                                        "updates-assets__coin-container",
                                    },
                                    t._l(t.assets, function (e) {
                                      return n(
                                        "div",
                                        {
                                          key: e,
                                          staticClass:
                                            "updates-asset__coin-wrap",
                                        },
                                        [
                                          n("coin-icon", {
                                            attrs: {
                                              wallet:
                                                t.$wallets.getWallet(e) || e,
                                            },
                                          }),
                                          t._v(" "),
                                          n("span", [
                            ...
                            t.features && t.features.length > 0
                              ? n("div", { staticClass: "border-line m-t-20" })
                              : t._e(),
                            t._v(" "),
                            t.features && t.features.length > 0
                              ? n("div", { staticClass: "m-t-20" }, [
                                  n(
                                    ...
                                    [
                                      t._v(
                                        t._s(t.$t("updatesPopup.newFeatures")),
                                      ),
                                    ],
                                  ),
                                  t._v(" "),
                              ...
                              : t._e(),
                            t._v(" "),
                            t.bugsFixed && t.bugsFixed.length > 0
                              ? n("div", { staticClass: "border-line m-t-20" })
                              : t._e(),
                            t._v(" "),
                            t.bugsFixed && t.bugsFixed.length > 0
                              ? n("div", { staticClass: "m-t-20" }, [
                                  n(
                                    "div",
                                    { staticClass: "new-title-medium" },
                                    [t._v(t._s(t.$t("updatesPopup.bugFixes")))],
                                  ),
                                  t._v(" "),
                                  n("div", {
                                    directives: [
                              ...
                              : t._e(),
                            t._v(" "),
                            "downloading" === t.status
                              ? n("div", { staticClass: "position-bottom" }, [
                                  n(
                                    "div",
                                ...
                                ? n("div", { staticClass: "position-bottom" }, [
                                    n("div", { staticClass: "flex" }, [
                                      n(
                                        ...
                                        {
                                          staticClass:
                                            "new-button new-button-large new-button-blue new-button-max30vw",
                                          on: { click: t.restart },
                                        },
                                        [
                                          t._v(
                                            "\n            " +
                                              t._s(t.$t("button.restart")) +
                                              "\n          ",
                                          ),
                                        ],
                                      ),
                                ...
                                : n(
                                    ...
                                    [
                                      ...
                                      n(
                                        ...
                                        {
                                          staticClass:
                                            "new-button new-button-large new-button-blue m-l-20",
                                          on: { click: t.close },
                                        },
                                        [
                                          t._v(
                                            "\n          " +
                                              t._s(t.$t("button.remindLater")) +
                                              "\n        ",
                                          ),
                                        ],
                                      ),
                                      ...
                                      n(
                                        ...
                                        {
                                          staticClass:
                                            "new-button new-button-large new-button-transparent m-l-20",
                                          on: {
                                            click: function (e) {
