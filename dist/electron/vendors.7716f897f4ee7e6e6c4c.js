  ...
  [384],
  {
    2731: function (n, t, e) {
      ...
      var p = !1,
        ...
        m = null,
        f = null,
        d = Object(s["a"])(o.a, r["a"], r["b"], p, c, m, f);
      t["default"] = d.exports;
    },
    5289: function (n, t, e) {
      "use strict";
      ...
      t.default = {
        ...
        data: () => ({ showWarning: !1, nextRoute: "", loading: !0 }),
        mounted() {
          setTimeout(() => {
            this.loading = !1;
          }, 200);
        ...
        methods: {
          showMnemonicWarning(n) {
            ((this.showWarning = !0), (this.nextRoute = n));
          },
          closeWarningPopup() {
            this.showWarning = !1;
          },
          ...
          return a(
            ...
            [
              a(
                "div",
                [
                  a("img", { staticClass: "logo", attrs: { src: e(868) } }),
                  n._v(" "),
                  a("router-view", {
                    key: n.$route.fullPath,
                    attrs: { mnemonic: n.mnemonic },
                    on: { "show-mnemonic-warning": n.showMnemonicWarning },
                  }),
                ],
                1,
              ),
                        ...
                        on: {
                          click: function (t) {
                            return t.target !== t.currentTarget
                              ? null
                              : n.closeWarningPopup.apply(null, arguments);
                          },
                        },
                      },
                      [
                        a("div", { staticClass: "content loginPage" }, [
                          a("h2", [
                            n._v(
                              n._s(
                                n.$t(
                                  "loginPage.walletAvailabilityWarningTitle",
                                ),
                              ),
                            ),
                          ]),
                          ...
                          a("p", [
                            n._v(
                              n._s(n.$t("loginPage.walletAvailabilityWarning")),
                            ),
                          ]),
                          n._v(" "),
