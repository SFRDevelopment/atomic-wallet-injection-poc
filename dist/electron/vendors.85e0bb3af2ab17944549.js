  ...
  [104],
  {
    ...
    1345: function (e, t, r) {
      ...
      class FixedNumber {
        ...
        static fromString(e, t) {
          ...
          !r.signed &&
            i.lt(f) &&
            h("unsigned value cannot be negative", "overflow", "value", e);
          let o = null;
          r.signed
    ...
    1360: function (e, t, r) {
      ...
      function c(e) {
        ...
        for (let i = 0; i < t.length; i++) {
          const e = t[i];
          46 === e && (r.push(h(t.slice(n, i))), (n = i + 1));
        }
      ...
      function o(e, t, r, o, s) {
        ...
        for (let d = 1; d <= u; d++) {
          ((l[t.length] = (d >> 24) & 255),
            ...
            (l[t.length + 3] = 255 & d));
          let p = (0, n.arrayify)((0, i.computeHmac)(s, e, l));
          (a ||
            ((a = p.length),
            (c = new Uint8Array(a)),
            (u = Math.ceil(o / a)),
      ...
      (function (e) {
          ...
          (m.prototype._wnafMulAdd = function (e, t, r, n, i) {
            ...
            for (o = n - 1; o >= 1; o -= 2) {
              ...
              if (1 === u[m] && 1 === u[g]) {
                ...
                ((l[m] = c(r[m], u[m], this._bitLength)),
                  (l[g] = c(r[g], u[g], this._bitLength)),
        ...
        ((b.prototype._getEndomorphism = function (e) {
          ...
          (b.prototype._getEndoBasis = function (e) {
            ...
            while (0 !== c.cmpn(0)) {
              var A = d.div(c);
              ((f = d.sub(A.mul(c))), (l = g.sub(A.mul(p))));
              var b = y.sub(A.mul(m));
              if (!n && f.cmp(h) < 0)
                ((t = u.neg()), (r = p), (n = f.neg()), (o = l));
              else if (n && 2 === ++v) break;
              ((u = f), (d = c), (c = f), (g = p), (p = l), (y = m), (m = b));
            }
            ((s = f.neg()), (a = l));
          ...
          (b.prototype._endoWnafMulAdd = function (e, t, r) {
            ...
            for (
              var f = this._wnafMulAdd(1, n, i, 2 * o, r), l = 0;
              l < 2 * o;
              l++
            )
              ((n[l] = null), (i[l] = null));
        ...
        ((B.fromPublic = function (e, t, r) {
          return t instanceof B ? t : new B(e, { pub: t, pubEnc: r });
        }),
          (B.fromPrivate = function (e, t, r) {
            return t instanceof B ? t : new B(e, { priv: t, privEnc: r });
          }),
          ...
          (B.prototype.verify = function (e, t, r) {
        ...
        ((O.prototype._importDER = function (e, t) {
          ...
          (O.prototype.toDER = function (e) {
            ...
            var i = n.concat(r),
              o = [48];
            return (T(o, i.length), (o = o.concat(i)), h.encode(o, e));
          }));
        var D = function () {
        ...
        ((L.prototype.keyPair = function (e) {
          ...
          (L.prototype.verify = function (e, t, r, n, i) {
            ...
            return this.curve._maxwellTrick
              ? ((a = this.g.jmulAdd(f, r.getPublic(), l)),
                !a.isInfinity() && a.eqXToP(o))
              : ((a = this.g.mulAdd(f, r.getPublic(), l)),
    ...
    1383: function (e, t, r) {
      ...
      var i = n(r(161)),
        ...
        c = r(507),
        d = r(508);
      const p = new h.Logger(c.version);
      class CrowdsaleAccount extends l.Description {
      ...
      function m(e, t) {
        ...
        const n = (0, o.getAddress)((0, d.searchPath)(r, "ethaddr")),
          l = (0, d.looseArrayify)((0, d.searchPath)(r, "encseed"));
        (l && l.length % 16 === 0) ||
          p.throwArgumentError("invalid encseed", "json", e);
        const h = (0, s.arrayify)((0, u.pbkdf2)(t, t, 2e3, 32, "sha256")).slice(
            0,
            16,
          ),
          c = l.slice(0, 16),
          m = l.slice(16),
          g = new i.default.ModeOfOperation.cbc(h, c),
    ...
    1385: function (e, t, r) {
      ...
      function w(e, t) {
        ...
        const l = t.slice(32, 64),
          h = (0, d.computeAddress)(o);
        if (e.address) {
        ...
        if ("0.1" === (0, p.searchPath)(e, "x-ethers/version")) {
          const t = (0, p.looseArrayify)(
            ...
            o = new i.default.ModeOfOperation.ctr(l, n),
            s = (0, p.searchPath)(e, "x-ethers/path") || u.defaultPath,
            f = (0, p.searchPath)(e, "x-ethers/locale") || "en",
            h = (0, a.arrayify)(o.decrypt(t));
          try {
            const e = (0, u.entropyToMnemonic)(h, f),
      ...
      function M(e, t, r, n, i) {
        return (0, a.arrayify)((0, l.pbkdf2)(e, t, r, n, i));
      }
      ...
      function S(e, t, r, n, i) {
        ...
        if (s && "string" === typeof s) {
          ...
          if ("scrypt" === s.toLowerCase()) {
            ...
            const l = parseInt((0, p.searchPath)(e, "crypto/kdfparams/dklen"));
            return (32 !== l && t("dklen", l), n(o, r, a, u, f, 64, i));
          }
      ...
      function C(e, t, r, n) {
        ...
        const l = (0, a.arrayify)(e.privateKey),
          c = (0, p.getPassword)(t);
        let m = null,
          g = null,
          y = null;
        ...
        v || (v = "ethers.js");
        let b = null;
        b = r.salt ? (0, a.arrayify)(r.salt) : (0, h.randomBytes)(32);
        let w = null;
        if (r.iv) {
          if (((w = (0, a.arrayify)(r.iv)), 16 !== w.length))
            throw new Error("invalid iv");
        } else w = (0, h.randomBytes)(16);
        let M = null;
        if (r.uuid) {
          if (((M = (0, a.arrayify)(r.uuid)), 16 !== M.length))
            throw new Error("invalid uuid");
        } else M = (0, h.randomBytes)(16);
        let E = 1 << 17,
          S = 8,
          P = 1;
        return (
    ...
    269: function (e, t, r) {
      ...
      class SigningKey {
        constructor(e) {
          ...
          const t = l().keyFromPrivate((0, i.arrayify)(this.privateKey));
          ((0, o.defineReadOnly)(
            this,
            "publicKey",
        ...
        _addPoint(e) {
          const t = l().keyFromPublic((0, i.arrayify)(this.publicKey)),
            r = l().keyFromPublic((0, i.arrayify)(e));
        ...
        computeSharedSecret(e) {
          const t = l().keyFromPrivate((0, i.arrayify)(this.privateKey)),
            r = l().keyFromPublic((0, i.arrayify)(c(e)));
      ...
      function c(e, t) {
        ...
        if (32 === r.length) {
          ...
          return t
            ? "0x" + l().keyFromPrivate(r).getPublic(!0, "hex")
            : e.publicKey;
        }
        return 33 === r.length
          ? t
    ...
    270: function (e, t, r) {
      ...
      function F(e) {
        ...
        return (
          8 === t.length ||
            ((r.hash = (0, a.keccak256)(e)), I(r, t.slice(8), C)),
          r
        );
      }
      function k(e) {
    ...
    34: function (e, t, r) {
      ...
      ((t.Logger = Logger), (Logger.errors = c), (Logger.levels = h));
    },
    492: function (e, t, r) {
      "use strict";
      (Object.defineProperty(t, "__esModule", { value: !0 }),
      ...
      class Wallet extends o.Signer {
        constructor(e, t) {
          if ((super(), A(e))) {
            const t = new c.SigningKey(e.privateKey);
            if (
              ((0, l.defineReadOnly)(this, "_signingKey", () => t),
              (0, l.defineReadOnly)(
                this,
                "address",
              ...
              const t = e.mnemonic;
              (0, l.defineReadOnly)(this, "_mnemonic", () => ({
                phrase: t.phrase,
              ...
              (0, p.computeAddress)(n.privateKey) !== this.address &&
                v.throwArgumentError(
                  "mnemonic/address mismatch",
                  "privateKey",
                  "[REDACTED]",
                );
            } else (0, l.defineReadOnly)(this, "_mnemonic", () => null);
          } else {
            if (c.SigningKey.isSigningKey(e))
              ("secp256k1" !== e.curve &&
                v.throwArgumentError(
                ...
                (0, l.defineReadOnly)(this, "_signingKey", () => e));
            else {
              "string" === typeof e &&
                e.match(/^[0-9a-f]*$/i) &&
                64 === e.length &&
                (e = "0x" + e);
              const t = new c.SigningKey(e);
              (0, l.defineReadOnly)(this, "_signingKey", () => t);
            }
            ((0, l.defineReadOnly)(this, "_mnemonic", () => null),
              (0, l.defineReadOnly)(
                this,
                "address",
                (0, p.computeAddress)(this.publicKey),
          ...
          (t &&
            !i.Provider.isProvider(t) &&
            v.throwArgumentError("invalid provider", "provider", t),
            (0, l.defineReadOnly)(this, "provider", t || null));
        }
        get mnemonic() {
        ...
        signTransaction(e) {
          return (0, l.resolveProperties)(e).then((t) => {
            null != t.from &&
            ...
            const r = this._signingKey().signDigest(
              (0, f.keccak256)((0, p.serialize)(t)),
            );
            return (0, p.serialize)(t, r);
          });
        }
        signMessage(e) {
          return y(this, void 0, void 0, function* () {
        ...
        _signTypedData(e, t, r) {
          return y(this, void 0, void 0, function* () {
            const n = yield a._TypedDataEncoder.resolveNames(
              e,
              t,
              r,
              (e) => (
            ...
            return (0, s.joinSignature)(
              this._signingKey().signDigest(
                a._TypedDataEncoder.hash(n.domain, t, n.value),
              ),
            );
          });
        }
        encrypt(e, t, r) {
          ...
          return (t || (t = {}), (0, d.encryptKeystore)(this, e, t, r));
        }
        static createRandom(e) {
          ...
          (e || (e = {}),
            e.extraEntropy &&
              (t = (0, s.arrayify)(
                (0, s.hexDataSlice)(
                  (0, f.keccak256)((0, s.concat)([t, e.extraEntropy])),
                  0,
                  16,
                ),
              )));
        ...
        static fromEncryptedJson(e, t, r) {
          return (0, d.decryptJsonWallet)(e, t, r).then((e) => new Wallet(e));
        }
        static fromEncryptedJsonSync(e, t) {
          return new Wallet((0, d.decryptJsonWalletSync)(e, t));
        }
        static fromMnemonic(e, t, r) {
          return (
            t || (t = u.defaultPath),
            new Wallet(u.HDNode.fromMnemonic(e, null, r).derivePath(t))
          );
        }
      }
      function w(e, t) {
        return (0, p.recoverAddress)((0, a.hashMessage)(e), t);
      }
      function M(e, t, r, n) {
        return (0, p.recoverAddress)(a._TypedDataEncoder.hash(e, t, r), n);
      }
      t.Wallet = Wallet;
    },
    493: function (e, t, r) {
        ...
        (function (e, t) {
          ...
          ((o.prototype.toString = function (e, t) {
            ...
            if (e === (0 | e) && e >= 2 && e <= 36) {
              ...
              h.negative = 0;
              while (!h.isZero()) {
                var m = h.modrn(l).toString(e);
                ((h = h.idivn(l)),
                  (r = h.isZero() ? m + r : c[f - m.length] + m + r));
              }
              this.isZero() && (r = "0" + r);
              while (r.length % t !== 0) r = "0" + r;
              return (0 !== this.negative && (r = "-" + r), r);
          ...
          (Math.imul || (v = y),
            ...
            (o.prototype._wordDiv = function (e, t) {
              ...
              0 === h.negative && ((n = h), u && (u.words[f] = 1));
              for (var c = f - 1; c >= 0; c--) {
                var d =
          ...
          ((E.prototype._tmp = function () {
            ...
            (B.prototype.sqrt = function (e) {
              ...
              while (0 !== this.pow(l, f).cmp(u)) l.redIAdd(u);
              var h = this.pow(l, i),
            ...
            (B.prototype.pow = function (e, t) {
              ...
              for (0 === f && (f = 26), i = t.length - 1; i >= 0; i--) {
                for (var l = t.words[i], h = f - 1; h >= 0; h--) {
                  var c = (l >> h) & 1;
                  (s !== n[0] && (s = this.sqr(s)),
                    0 !== c || 0 !== a
                      ? ((a <<= 1),
    ...
    502: function (e, t, r) {
      ...
      function M(e) {
        return n.Base58.encode(
          (0, i.concat)([
            e,
            (0, i.hexDataSlice)((0, l.sha256)((0, l.sha256)(e)), 0, 4),
          ]),
        );
      }
      function E(e) {
      ...
      class HDNode {
        constructor(e, t, r, n, o, s, a, c) {
          ...
          ((0, u.defineReadOnly)(this, "parentFingerprint", n),
            (0, u.defineReadOnly)(
              ...
              "fingerprint",
              (0, i.hexDataSlice)(
                (0, l.ripemd160)((0, l.sha256)(this.publicKey)),
                0,
                4,
              ),
            ),
        ...
        _derive(e) {
          ...
          return (
            ...
            new HDNode(S, u, h, this.fingerprint, w(a), e, this.depth + 1, c)
          );
        }
        derivePath(e) {
          const t = e.split("/");
        ...
        static _fromSeed(e, t) {
          ...
          const n = (0, i.arrayify)(
            (0, l.computeHmac)(l.SupportedAlgorithm.sha512, y, r),
          );
          return new HDNode(
            S,
            w(n.slice(0, 32)),
      ...
      function x(e, t) {
        ...
        const s = (32 * r.length) / 3,
          a = r.length / 3,
          u = A(a),
          f = (0, i.arrayify)((0, l.sha256)(n.slice(0, s / 8)))[0] & u;
        ...
        for (let i = 0; i < e.length; i++)
          n > 8
            ...
            : ((r[r.length - 1] <<= n),
              ...
              (n += 3));
        const o = e.length / 4,
          s = (0, i.arrayify)((0, l.sha256)(e))[0] & A(o);
        return (
          (r[r.length - 1] <<= o),
          (r[r.length - 1] |= s >> (8 - o)),
