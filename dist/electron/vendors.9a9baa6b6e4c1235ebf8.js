  ...
  [377, 32],
  {
    2697: function (e, t, s) {
      ...
      var n = r(s(230)),
        ...
        o = s(27),
        c = s(2806);
      const l = "m/44'/2301'/0'/0/0",
        u = 8,
        d = "0",
        { BITCOINJS: f } = o.LIB_NAME_INDEX;
      class QTUMCoin extends (0, c.BitcoinJSMixin)(
        (0, c.BitcoinLikeFeeMixin)(n.default),
      ) {
        constructor(e) {
          const t = {
              MAINNET: {
          ...
          (super({
            ...
            derivation: l,
            dependencies: {
              [f]: new i.default(() => s.e(19).then(s.t.bind(null, 3218, 7))),
            },
          }),
            (this.derivation = l),
        ...
        setFeeData(e) {
          ...
          (void 0 === e && (e = {}),
            ...
            (this.coefficient =
              null !== (t = e.coefficient) && void 0 !== t ? t : 1),
            (this.unspendableBalance =
              null !== (s = e.unspendableBalance) && void 0 !== s ? s : d));
        }
      }
      t.default = QTUMCoin;
    },
