  ...
  [192, 45, 410],
  {
    2659: function (t, e, a) {
      ...
      var r = a(6978),
        ...
        l = null,
        d = null,
        f = Object(o["a"])(n.a, r["a"], r["b"], c, u, l, d);
      e["default"] = f.exports;
    },
    2780: function (t, e, a) {
      "use strict";
    ...
    2821: function (t, e, a) {
      ...
      (Object.defineProperty(e, "__esModule", { value: !0 }),
        (e.default = void 0));
      var i = a(2837);
      const n = "appRate::disabled",
        s = 4,
        r = 1e3;
      e.default = {
        name: "RateStars",
        components: { RateStart: i.RateStart },
        props: {
        ...
        methods: {
          fetchRatingDisabled() {
            ((this.isRateStars = !localStorage.getItem(n)),
              clearTimeout(this.fetchRatingDisabledTimeout),
    ...
    2942: function (t, e, a) {
      ...
      e.default = {
        name: "SendCoinResult",
        components: { CoinIcon: n.default, RateStars: s.default },
        props: {
        ...
        computed: {
          ...
          successfulMessage() {
            ...
            let a = this.$t("sendCoin.successfulMessage", {
              amount: this.amount,
              ticker: e,
            ...
            return (
              "DOGE" === e &&
                (a += ", " + this.$t("sendCoin.DOGEsuccessfulMessagePostfix")),
              a
            );
          },
          buttonTitle() {
        ...
        methods: {
          ...
          talkWithSupport() {
            ...
            void 0 === a
              ? void 0
              : a.length) > 0 && (o.tags = this.contactData.tags),
              r[this.sendType] &&
            ...
            [
              t.isSuccess && !t.isError
                ? i(
                    ...
                    [
                      "DOGE" !== t.coin.ticker
                        ? i("CoinIcon", { attrs: { wallet: t.coin } })
                        : i("img", {
                            staticClass: "doge",
                            class: t.icon,
                            attrs: { src: a(3240) },
              ...
              t._v(" "),
              t.isError
                ? i("div", { staticClass: "submit failed" }, [
                    i(
                      "button",
                      {
                    ...
                    t.currentComponent === t.COMPONENT_TYPES.activate
                      ? a(
                          ...
                          [
                            ...
                            t._v(" "),
                            a("div", { staticClass: "activate-coin__info" }, [
                              a(
                                "h2",
                                {
                                  staticClass:
                      ...
                      : t.currentComponent === t.COMPONENT_TYPES.password
                        ? a(
                            ...
                            [
                              a("h2", { staticClass: "new-text-extra-large" }, [
    ...
    4894: function (t, e, a) {
      ...
      e.default = {
        ...
        components: { WrapperActivate: r.default },
        mixins: [o.ActivateCoinMixin],
        data() {
          return { fee: "--.--", feeFromPlugin: 0, feeFromConfig: 0 };
        },
        computed: {
          ...
          isActivateAutoclaimDrops() {
            ...
            return (
              ...
              void 0 === e
                ? void 0
                : e.activeAutoClaim) ||
              this.$store.getters.hasAutoclaimAirdropByTicker({
                ticker: this.ticker,
              })
            );
          },
          dropsName() {
            return this.$t("autoClaimDrops.dropsName", {
              coinName: this.coin.name,
            });
          },
          headline() {
            return this.isActivateAutoclaimDrops
              ? this.$t("autoClaimDrops.autoClaimIsActive", {
                  dropsName: this.dropsName,
                })
              : this.$t("autoClaimDrops.activatingAutoClaim", {
                  dropsName: this.dropsName,
                });
          },
          text() {
            const t = this.$t("autoClaimDrops.textInfoA", {
              ticker: this.ticker,
            });
            return this.isActivateAutoclaimDrops
              ? t +
                  "\n \n" +
                  this.$t("autoClaimDrops.textInfoB", {
                    nextDrop: this.nextDrop,
                  })
              : t;
          },
          nextDrop() {
            return this.$formatDate(
              new Date(this.coin.getNextDropDate()),
              "DD-MMM-YYYY",
            );
          },
          transactionAdditionalInfo() {
            return {
              icon: this.icon,
              coin: this.coin,
              message: this.$t("autoClaimDrops.dropsNameAutoClaim", {
                dropsName: this.dropsName,
              }),
              sendType: "ActivateAutoclaim",
              contactData: { issue: this.$t("supportPopup.transactionIssue") },
            };
          },
          customSuccessfulMessage() {
            return `${this.$t("autoClaimDrops.coinAutoClaimIsActive", { coinName: this.coin.name })}<br/>\n      ${this.$t("autoClaimDrops.nextDropPlace", { nextDrop: this.nextDrop })}`;
          },
        },
        async created() {
          var t;
          const { balances: e = {} } = await this.coin.getInfo();
          this.feeFromConfig = this.coin.toCurrencyUnit(
            null === (t = e.additional) || void 0 === t
              ? void 0
              : t.autoClaimFee,
          );
          const a = new s.FeePlugin(this.coin);
          (a.setCustomGas([null, this.coin.autoClaimGasLimit]),
            (this.feeFromPlugin = (
              await (await a.init(!0)).calculate(this.feeFromConfig)
            ).toCurrency()),
            await this.setFee());
        },
        methods: {
          async setFee() {
            this.feeFromConfig &&
              this.feeFromPlugin &&
              ((this.fee = +(+this.feeFromConfig + +this.feeFromPlugin).toFixed(
                6,
              )),
          ...
          async handleActivateCoin() {
            await this.handleActivate(async () => {
              ...
              return (
                this.$store.dispatch("updateAutoclaimAirdrop", {
                  ticker: this.ticker,
                  value: !0,
                }),
                e
          ...
          return i("WrapperActivate", {
            attrs: {
              ...
              transaction: Object.assign(
                ...
                { customSuccessfulMessage: t.customSuccessfulMessage },
              ),
            },
            on: {
              ...
              [
                {
                  ...
                  fn: function () {
                    return [
                      i("div", { staticClass: "activate-coin__icon--gift" }, [
                        i("img", {
                          attrs: { src: a(860), width: "32", height: "32" },
                        }),
                      ]),
                    ];
                  },
                          ...
                          i(
                            ...
                            [
                              ...
                              i(
                                ...
                                {
                                  staticClass:
                                    "new-text-medium flex align-center",
                                },
                                [
                                  i("span", [
                                    t._v(
                            ...
                            [
                              i(
                                ...
                                [
                                  t._v(
                                    "\n        " +
                                      t._s(t.$t("autoClaimDrops.nextDrop")) +
                                      "\n      ",
                                  ),
                                ],
                              ),
                                      ...
                                      on: {
                                        click: function (e) {
                                          return t.$electron.openExternal(
                                            "https://support.atomicwallet.io/article/355-how-do-i-claim-flaredrops ",
                                          );
                                        },
                                      },
                                    },
                    ...
                    },
                {
                  ...
                  fn: function () {
                    return [
                      t.feeEnough || t.isActivateAutoclaimDrops
                        ? t._e()
                        : [
                            t._v(
                              "\n      " +
                  ...
                  fn: function () {
                    return [
                        ...
                        : i(
                            "BaseButton",
                            {
                              attrs: {
                                ...
                                disabled: !t.feeEnough || isNaN(t.fiatFee),
                              },
                              on: {
                                click: function (e) {
                                  t.feeEnough &&
                                    t.handleChangeStage("password");
                                },
                              },
                            },
                            [
                      ...
                      i(
                        ...
                        {
                          attrs: {
                            type: t.isActivateAutoclaimDrops
                              ? "primary-desktop"
                              : "secondary-desktop",
                          },
