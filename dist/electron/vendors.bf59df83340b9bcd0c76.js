  ...
  [255, 334],
  {
    11699: function (t, e, s) {
      ...
      var l = s(11700),
        ...
        c = null,
        d = null,
        p = Object(r["a"])(i.a, l["a"], l["b"], o, u, c, d);
      e["default"] = p.exports;
    },
    11700: function (t, e, s) {
      "use strict";
      (s.d(e, "a", function () {
        return a;
      }),
            ...
            [
              t.sending
                ...
                : s(
                    ...
                    {
                      staticClass: "close",
                      attrs: { "data-test-id": "claim_ada_close" },
                ...
                : s(
                    ...
                    [
                      s("div", { staticClass: "info" }, [
                        s("div", { class: ["icon", t.icon] }),
                        t._v(" "),
                        s("p", [
                          t._v(t._s(t.$t("popups.claimADA.fromOldAddress"))),
                        ]),
                      ]),
                      t._v(" "),
                      s("Edit", {
                        attrs: {
                          ...
                          readonly: "",
                          placeholder: t.$t("input.myShelleyAddress"),
                          ...
                          s("transition", { attrs: { name: "page-fade" } }, [
                            t.isClaimAvailable
                              ...
                              : s(
                                  ...
                                  {
                                    staticClass: "error",
                                    attrs: { "data-test-id": "wall_clnothing" },
                                  },
                                  [
                                    t._v(
                                      "\n          " +
                              ...
                              : s(
                                  "button",
                                  {
                                    ...
                                    class: {
                                      disabled:
                                        !t.isClaimAvailable ||
                                        0 === Number(t.inputs.amount),
                                    },
                                    attrs: { "data-test-id": "wall_clbutton" },
              ...
              t.isPasswordShow
                ? s(
                    ...
                    [
                      s("div", { staticClass: "info" }, [
                        s("p", [t._v(t._s(t.$t("popups.claimADA.title")))]),
                      ]),
                      t._v(" "),
                      s("Edit", {
                        ref: "confirmPassword",
              ...
              t.sending
                ? s("div", { staticClass: "sending" }, [
                    s("div", { staticClass: "info" }, [
                      ...
                      t._v(" "),
                      s("p", [t._v(t._s(t.$t("popups.claimADA.claiming")))]),
                    ]),
                    t._v(" "),
              ...
              t.sending
                ...
                : s("SendCoinResult", {
                    attrs: {
                      ...
                      buttonName: {
                        back: t.$t("sendCoin.buttonBack"),
                        repeat: t.$t("sendCoin.buttonRepeat"),
                      },
                      coin: t.coin,
                      icon: t.icon,
                      isError: t.isError,
                      ...
                      txid: t.txid,
                      contactData: {
                        issue: t.$t("supportPopup.transactionIssue"),
                        tags: ["send_tag"],
                      },
      ...
      e.default = {
        ...
        methods: {
          ...
          talkWithSupport() {
            ...
            void 0 === s
              ? void 0
              : s.length) > 0 && (r.tags = this.contactData.tags),
              l[this.sendType] &&
                (r.additionalText = `${this.$t("sendProcess." + this.sendType)} ${this.$t("sendProcess.unsuccess")}${n}`),
              ["Activate", "ActivateAutoclaim"].includes(this.sendType) &&
                (r.additionalText = `${this.$t("supportPopup.unsuccessActivation")}${n}`),
    ...
    3001: function (t, e, s) {
      ...
      e.default = {
        ...
        components: {
          ...
          CurrencyInput: () => s.e(408).then(s.bind(null, 4605)),
        },
        props: {
          readonly: { type: Boolean, default: !1 },
        ...
        methods: {
          ...
          onInputFiat(t) {
            ...
            const e = 20,
              ...
              a = s[this.fiatRate].rate,
              i = this.coinWithWholeNumber((t / a).toFixed(e)),
              n =
          ...
          onInput(t) {
            const e = this.modelValue.endsWith(".") && "0" === t.target.value,
              s = e ? "" : t.target.value;
            let a = (0, l.maskInput)(s, this.decimals);
      ...
      function r(t, e, s) {
        ...
        return (
          ...
          s
            ? r
            : (u.splice(0, 1, r),
              d && d.length >= e && u.splice(1, 2, d.slice(0, e)),
              u.join("."))
        );
      }
    },
    ...
    3363: function (t, e, s) {
      ...
      e.default = {
        ...
        components: { LoadingEllipsis: l.default },
        props: {
        ...
        methods: { getValueFiat: n.getValueFiat, formatFinance: r.default },
      };
    },
    3381: function (t, e, s) {
      "use strict";
    ...
    5830: function (t, e, s) {
      ...
      e.default = {
        ...
        async mounted() {
          ((this.inputs.address = String(this.coin.address)),
            (this.legacyUtxo =
              await this.coin.getLegacyAddressUnspentOutputs()));
          const t = this.legacyUtxo.reduce(
              (t, e) => t.add(new this.coin.BN(e.amount)),
              new this.coin.BN("0"),
            ),
            e = await this.coin.getFee({
              amount: t,
              address: this.coin.address,
              utxos: this.legacyUtxo,
            });
          this.feeBalance = this.coin.toCurrencyUnit(e);
          const s = await this.coin.getLegacyAddressAvailableBalance({
            legacyUtxo: this.legacyUtxo,
            address: this.coin.address,
          });
          ((this.isClaimAvailable = Number(s) > 0),
            (this.availableBalance = this.isClaimAvailable
              ? this.coin.toCurrencyUnit(s)
              : 0),
            (this.inputs.amount = String(this.availableBalance)),
