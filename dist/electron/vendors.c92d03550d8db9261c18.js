  ...
  [346],
  {
    2716: function (e, t, s) {
      ...
      const i = "Osmosis",
        ...
        y = "10000",
        x = 0.01;
      class OSMOCoin extends (0, o.CosmosMixinV2)(
            ...
            async getSocketTransaction(e) {
              ...
              (await r.default.filterAndUpdateTransactions([c]),
                ...
                a.forEach((e) => {
                  o === e &&
                    this.eventEmitter.emit(
                      `${this.wallet.parent}::confirmed-${o}`,
                      c || {},
                    );
                }));
            }
        ...
        u.CosmosNodeTransactionTypeMixin)(a.default) {
          ...
          async getTransactions(e) {
            ...
            (a.tx_responses.forEach((e) => {
              i.set(e.txhash, { ...e, direction: !1 });
            }),
              o.tx_responses.forEach((e) => {
                i.set(e.txhash, { ...e, direction: !0 });
              }));
            const c = [];
            for (const [, r] of i.entries()) c.push(r);
                  ...
                  ...e.tx.body.messages.map((t) => {
                    ...
                    const i =
                      ...
                      void 0 === a
                        ...
                        : a.amount;
                    var c, u, l;
                    i && Array.isArray(e.tx.auth_info.fee.amount)
                      ? (o = e.tx.auth_info.fee.amount.reduce(
