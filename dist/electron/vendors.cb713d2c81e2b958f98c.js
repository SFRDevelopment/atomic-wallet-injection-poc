  ...
  [19, 195, 196],
  {
    ...
    2819: function (e, t, r) {
      (function (t) {
        ...
        function v(e) {
          return !!S(e) && e.compare(u) > 0 && e.compare(a) < 0;
        }
        function k(e) {
        ...
        function M(e, r, n) {
          if (!S(e)) throw new TypeError(w);
          if (!v(r)) throw new TypeError(l);
          if (void 0 !== n && !S(n)) throw new TypeError(_);
          const i = P(r),
            s = P(e);
          let u, a;
          const c = function (e) {
    ...
    3111: function (e, t, r) {
      ...
      const n = r(2775),
        ...
        T = r(3727),
        b = r(3728),
        v = { unsignedTx: s, globalXpub: i, checkPubkey: S.makeChecker([]) };
      t.globals = v;
      const k = {
        nonWitnessUtxo: a,
        partialSig: c,
      ...
      const I = {
        ...
        checkPubkey: S.makeChecker([n.OutputTypes.BIP32_DERIVATION]),
              ...
              const t = h.signature.decode(p.signature),
                { hash: n, script: i } =
                  a !== t.hashType
                    ...
                    : { hash: o, script: u };
              ((a = t.hashType), (o = n), (u = i), U(p.pubkey, i, "verify"));
      ...
      (function (e) {
        ...
        class TransactionBuilder {
          ...
          __addInputUnsafe(e, t, r) {
            ...
            let i = {};
            if (
              (void 0 !== r.script && (i = S(r.script, r.witness || [])),
        ...
        function S(e, t, r, n) {
          ...
          if (r === d.P2SH) {
            const { output: r, redeem: n } = a.p2sh({ input: e, witness: t }),
              i = s.output(n.output),
              o = S(n.input, n.witness, i, n.output);
          ...
          if (r === d.P2WSH) {
            ...
            return (
              (o =
                i === d.P2WPKH
                  ? S(n.input, n.witness, i)
                  : S(c.compile(n.witness), [], i, n.output)),
              o.prevOutType
                ? {
                    prevOutScript: r,
                    prevOutType: d.P2WSH,
