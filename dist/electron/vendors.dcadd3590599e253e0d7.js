  ...
  [183],
  {
    11121: function (e, a, c) {
      ...
      const t = d(c(11122)),
        ...
        i = d(c(11125));
      a.testnet = {
        exceptions: t.default,
        genesisBlock: f.default,
        milestones: b.default,
        network: i.default,
      };
    },
    11124: function (e) {
      e.exports = JSON.parse(
        '[{"height":1,"reward":0,"activeDelegates":51,"blocktime":8,"block":{"version":0,"maxTransactions":150,"maxPayload":2097152},"epoch":"2017-03-21T13:00:00.000Z","fees":{"staticFees":{"transfer":10000000,"secondSignature":500000000,"delegateRegistration":2500000000,"vote":100000000,"multiSignature":500000000,"ipfs":500000000,"multiPayment":10000000,"delegateResignation":2500000000,"htlcLock":10000000,"htlcClaim":0,"htlcRefund":0}},"vendorFieldLength":64,"multiPaymentLimit":256},{"height":2,"aip11":true,"htlcEnabled":true},{"height":75600,"reward":200000000},{"height":100000,"vendorFieldLength":255},{"height":1000000000,"block":{"idFullSha256":true}}]',
      );
    },
    11125: function (e) {
      e.exports = JSON.parse(
        '{"name":"testnet","messagePrefix":"TEST message:\\n","bip32":{"public":70617039,"private":70615956},"pubKeyHash":23,"nethash":"d9acd04bde4234a81addb8482333b4ac906bed7be5a9970ce8ada428bd083192","wif":186,"slip44":1,"aip20":0,"client":{"token":"TARK","symbol":"TѦ","explorer":"http://texplorer.ark.io"}}',
      );
    },
    11126: function (e, a, c) {
      "use strict";
      var d =
        (this && this.__importDefault) ||
        function (e) {
    ...
    11258: function (e, a, c) {
      ...
      a.isLocalHost = function (e, a) {
        ...
        try {
          ...
          if (
            "loopback" === c.range() ||
            e.startsWith("0") ||
            ["127.0.0.1", "::ffff:127.0.0.1"].includes(e)
          )
            return !0;
          if (a) {
            const a = f.default.networkInterfaces();
            return Object.keys(a).some((c) =>
              a[c].some((a) => a.address === e),
            );
          }
          return !1;
        } catch (c) {
      ...
      const b = (e) => {
        try {
          return t.process(e).toString();
        } catch (a) {
          return;
        }
      };
      a.isValidPeer = function (e, c) {
        return (
          void 0 === c && (c = !0),
          (e.ip = b(e.ip)),
          !!e.ip && !a.isLocalHost(e.ip, c)
        );
      };
    },
    11260: function (e, a, c) {
      "use strict";
      function d(e) {
        for (var c in e) a.hasOwnProperty(c) || (a[c] = e[c]);
      }
      Object.defineProperty(a, "__esModule", { value: !0 });
      const t = c(11261),
        f = c(11273),
      ...
      class BuilderFactory {
        ...
        static secondSignature() {
          return new u.SecondSignatureBuilder();
        }
        static delegateRegistration() {
          return new t.DelegateRegistrationBuilder();
        }
        static vote() {
          return new l.VoteBuilder();
        }
        static multiSignature() {
          return new o.MultiSignatureBuilder();
        }
        static ipfs() {
          return new r.IPFSBuilder();
        }
        static multiPayment() {
          return new s.MultiPaymentBuilder();
        }
        static delegateResignation() {
          return new f.DelegateResignationBuilder();
        }
        static htlcLock() {
          return new i.HtlcLockBuilder();
        }
        static htlcClaim() {
          return new b.HtlcClaimBuilder();
        }
        static htlcRefund() {
          return new n.HtlcRefundBuilder();
        }
      }
      a.BuilderFactory = BuilderFactory;
    },
    11261: function (e, a, c) {
      "use strict";
      Object.defineProperty(a, "__esModule", { value: !0 });
      const d = c(2963),
        t = c(3070),
        f = c(3233);
      class DelegateRegistrationBuilder extends f.TransactionBuilder {
        constructor() {
          (super(),
            (this.data.type = t.DelegateRegistrationTransaction.type),
            (this.data.typeGroup = t.DelegateRegistrationTransaction.typeGroup),
            (this.data.fee = t.DelegateRegistrationTransaction.staticFee()),
            (this.data.amount = d.BigNumber.ZERO),
            (this.data.recipientId = void 0),
            (this.data.senderPublicKey = void 0),
        ...
        getStruct() {
          ...
          return (
            ...
            (e.recipientId = this.data.recipientId),
            (e.asset = this.data.asset),
            e
          );
        }
        instance() {
      ...
      a.DelegateRegistrationBuilder = DelegateRegistrationBuilder;
    },
    11262: function (e, a, c) {
      "use strict";
      var d =
          (this && this.__importDefault) ||
          function (e) {
        ...
        t =
          ...
          function (e) {
            ...
            if (null != e)
              for (var c in e)
                Object.hasOwnProperty.call(e, c) && (a[c] = e[c]);
      ...
      const f = d(c(3057)),
        ...
        r = t(c(3232)),
        s = c(3231);
      class TransferTransaction extends s.Transaction {
        static getSchema() {
          return r.transfer;
        }
        hasVendorField() {
        ...
        serialize(e) {
          const { data: a } = this,
            c = new f.default(24, !0);
          (c.writeUint64(a.amount.toString()),
            c.writeUint32(a.expiration || 0));
          const { addressBuffer: d, addressError: t } = i.Address.toBuffer(
            a.recipientId,
          );
          return ((e.addressError = t), c.append(d), c);
        }
        deserialize(e) {
          const { data: a } = this;
          ((a.amount = n.BigNumber.make(e.readUint64().toString())),
            (a.expiration = e.readUint32()),
            (a.recipientId = i.Address.fromBuffer(e.readBytes(21).toBuffer())));
        }
      }
      ((a.TransferTransaction = TransferTransaction),
        (TransferTransaction.typeGroup = b.TransactionTypeGroup.Core),
        (TransferTransaction.type = b.TransactionType.Transfer),
        (TransferTransaction.key = "transfer"),
        (TransferTransaction.defaultStaticFee = n.BigNumber.make("10000000")));
    },
    11263: function (e, a, c) {
      "use strict";
      var d =
          (this && this.__importDefault) ||
          function (e) {
      ...
      const f = d(c(3057)),
        ...
        n = t(c(3232)),
        r = c(3231);
      class SecondSignatureRegistrationTransaction extends r.Transaction {
        static getSchema() {
          return n.secondSignature;
        }
        serialize(e) {
          const { data: a } = this,
            c = new f.default(33, !0);
          return (c.append(a.asset.signature.publicKey, "hex"), c);
        }
        deserialize(e) {
          const { data: a } = this;
          a.asset = {
            signature: { publicKey: e.readBytes(33).toString("hex") },
          };
        }
      }
      ((a.SecondSignatureRegistrationTransaction =
        SecondSignatureRegistrationTransaction),
        (SecondSignatureRegistrationTransaction.typeGroup =
          b.TransactionTypeGroup.Core),
        (SecondSignatureRegistrationTransaction.type =
          b.TransactionType.SecondSignature),
        (SecondSignatureRegistrationTransaction.key = "secondSignature"),
        (SecondSignatureRegistrationTransaction.defaultStaticFee =
          i.BigNumber.make("500000000")));
    },
    11264: function (e, a, c) {
      "use strict";
      (function (e) {
        var d =
            (this && this.__importDefault) ||
        ...
        const f = d(c(3057)),
          ...
          n = t(c(3232)),
          r = c(3231);
        class DelegateRegistrationTransaction extends r.Transaction {
          static getSchema() {
            return n.delegateRegistration;
          }
          serialize(a) {
            const { data: c } = this,
              d = e.from(c.asset.delegate.username, "utf8"),
              t = new f.default(d.length, !0);
            return (t.writeByte(d.length), t.append(d, "hex"), t);
          }
          deserialize(e) {
            const { data: a } = this,
              c = e.readUint8();
            a.asset = { delegate: { username: e.readString(c) } };
          }
        }
        ((a.DelegateRegistrationTransaction = DelegateRegistrationTransaction),
          (DelegateRegistrationTransaction.typeGroup =
            b.TransactionTypeGroup.Core),
          (DelegateRegistrationTransaction.type =
            b.TransactionType.DelegateRegistration),
          (DelegateRegistrationTransaction.key = "delegateRegistration"),
          (DelegateRegistrationTransaction.defaultStaticFee =
            i.BigNumber.make("2500000000")));
      }).call(this, c(2).Buffer);
    },
    11265: function (e, a, c) {
      "use strict";
      var d =
          (this && this.__importDefault) ||
          function (e) {
      ...
      const f = d(c(3057)),
        ...
        n = t(c(3232)),
        r = c(3231);
      class VoteTransaction extends r.Transaction {
        static getSchema() {
          return n.vote;
        }
        serialize(e) {
          const { data: a } = this,
            c = new f.default(24, !0),
            d = a.asset.votes
              .map((e) => ("+" === e[0] ? "01" : "00") + e.slice(1))
              .join("");
          return (c.writeByte(a.asset.votes.length), c.append(d, "hex"), c);
        }
        deserialize(e) {
          const { data: a } = this,
            c = e.readUint8();
          a.asset = { votes: [] };
          for (let d = 0; d < c; d++) {
            let c = e.readBytes(34).toString("hex");
            ((c = ("1" === c[1] ? "+" : "-") + c.slice(2)),
              a.asset.votes.push(c));
          }
        }
      }
      ((a.VoteTransaction = VoteTransaction),
        (VoteTransaction.typeGroup = b.TransactionTypeGroup.Core),
        (VoteTransaction.type = b.TransactionType.Vote),
        (VoteTransaction.key = "vote"),
        (VoteTransaction.defaultStaticFee = i.BigNumber.make("100000000")));
    },
    11266: function (e, a, c) {
      "use strict";
      (function (e) {
        var d =
            (this && this.__importDefault) ||
        ...
        const f = d(c(3057)),
          ...
          s = t(c(3232)),
          o = c(3231);
        class MultiSignatureRegistrationTransaction extends o.Transaction {
          static getSchema() {
            return s.multiSignature;
          }
          static staticFee(e) {
            void 0 === e && (e = {});
            const a = super.staticFee(e),
              c = e.data;
            return c
              ? 2 === c.version
                ? a.times(c.asset.multiSignature.publicKeys.length + 1)
                : a.times(c.asset.multiSignatureLegacy.keysgroup.length + 1)
              : a;
          }
          verify() {
            return (
              n.isException(this.data) ||
              (i.configManager.getMilestone().aip11 && super.verify())
            );
          }
          serialize(a) {
            const { data: c } = this;
            let d;
            if (2 === c.version) {
              const { min: e, publicKeys: a } = c.asset.multiSignature;
              ((d = new f.default(2 + 33 * a.length)),
                d.writeUint8(e),
                d.writeUint8(a.length));
              for (const c of a) d.append(c, "hex");
            } else {
              const a = c.asset.multiSignatureLegacy.keysgroup
                  .map((e) => ("+" === e[0] ? e.slice(1) : e))
                  .join(""),
                t = e.from(a, "hex");
              ((d = new f.default(t.length + 3, !0)),
                d.writeByte(c.asset.multiSignatureLegacy.min),
                d.writeByte(c.asset.multiSignatureLegacy.keysgroup.length),
                d.writeByte(c.asset.multiSignatureLegacy.lifetime),
                d.append(t, "hex"));
            }
            return d;
          }
          deserialize(e) {
            const { data: a } = this;
            if (2 === a.version) {
              const c = { publicKeys: [], min: 0 };
              c.min = e.readUint8();
              const d = e.readUint8();
              for (let a = 0; a < d; a++) {
                const a = e.readBytes(33).toString("hex");
                c.publicKeys.push(a);
              }
              a.asset = { multiSignature: c };
            } else {
              const c = { keysgroup: [], lifetime: 0, min: 0 };
              c.min = e.readUint8();
              const d = e.readUint8();
              c.lifetime = e.readUint8();
              for (let a = 0; a < d; a++) {
                const a = e.readBytes(33).toString("hex");
                c.keysgroup.push(a);
              }
              a.asset = { multiSignatureLegacy: c };
            }
          }
        }
        ((a.MultiSignatureRegistrationTransaction =
          ...
          (MultiSignatureRegistrationTransaction.type =
            b.TransactionType.MultiSignature),
          (MultiSignatureRegistrationTransaction.key = "multiSignature"),
          (MultiSignatureRegistrationTransaction.defaultStaticFee =
            r.BigNumber.make("500000000")));
      }).call(this, c(2).Buffer);
    },
    11267: function (e, a, c) {
      "use strict";
      (function (e) {
        var d =
            (this && this.__importDefault) ||
        ...
        const f = c(6849),
          ...
          s = t(c(3232)),
          o = c(3231);
        class IpfsTransaction extends o.Transaction {
          static getSchema() {
            return s.ipfs;
          }
          verify() {
            return n.configManager.getMilestone().aip11 && super.verify();
          }
          serialize(e) {
            const { data: a } = this,
              c = f.base58.decode(a.asset.ipfs),
              d = new b.default(c.length, !0);
            return (d.append(c, "hex"), d);
          }
          deserialize(a) {
            const { data: c } = this,
              d = a.readUint8(),
              t = a.readUint8(),
              b = a.readBytes(t).toBuffer(),
              i = e.alloc(t + 2);
            (i.writeUInt8(d, 0),
              i.writeUInt8(t, 1),
              i.fill(b, 2),
              (c.asset = { ipfs: f.base58.encode(i) }));
          }
        }
        ((a.IpfsTransaction = IpfsTransaction),
          (IpfsTransaction.typeGroup = i.TransactionTypeGroup.Core),
          (IpfsTransaction.type = i.TransactionType.Ipfs),
          (IpfsTransaction.key = "ipfs"),
          (IpfsTransaction.defaultStaticFee = r.BigNumber.make("500000000")));
      }).call(this, c(2).Buffer);
    },
    11268: function (e, a, c) {
      "use strict";
      var d =
          (this && this.__importDefault) ||
          function (e) {
      ...
      const f = d(c(3057)),
        ...
        s = t(c(3232)),
        o = c(3231);
      class MultiPaymentTransaction extends o.Transaction {
        static getSchema() {
          return s.multiPayment;
        }
        verify() {
          return n.configManager.getMilestone().aip11 && super.verify();
        }
        ...
        serialize(e) {
          const { data: a } = this,
            c = new f.default(2 + 29 * a.asset.payments.length, !0);
          c.writeUint16(a.asset.payments.length);
          for (const d of a.asset.payments) {
            c.writeUint64(d.amount.toString());
            const { addressBuffer: a, addressError: t } = i.Address.toBuffer(
              d.recipientId,
            );
            ((e.addressError = t || e.addressError), c.append(a));
          }
          return c;
        }
        deserialize(e) {
          ...
          for (let t = 0; t < d; t++)
            c.push({
              amount: r.BigNumber.make(e.readUint64().toString()),
              recipientId: i.Address.fromBuffer(e.readBytes(21).toBuffer()),
            });
          ((a.amount = r.BigNumber.ZERO), (a.asset = { payments: c }));
        }
      }
      ((a.MultiPaymentTransaction = MultiPaymentTransaction),
        (MultiPaymentTransaction.typeGroup = b.TransactionTypeGroup.Core),
        (MultiPaymentTransaction.type = b.TransactionType.MultiPayment),
        (MultiPaymentTransaction.key = "multiPayment"),
        (MultiPaymentTransaction.defaultStaticFee =
          r.BigNumber.make("10000000")));
    },
    11269: function (e, a, c) {
      "use strict";
      var d =
          (this && this.__importDefault) ||
          function (e) {
      ...
      const f = d(c(3057)),
        ...
        r = t(c(3232)),
        s = c(3231);
      class DelegateResignationTransaction extends s.Transaction {
        static getSchema() {
          return r.delegateResignation;
        }
        verify() {
          return i.configManager.getMilestone().aip11 && super.verify();
        }
        serialize(e) {
      ...
      ((a.DelegateResignationTransaction = DelegateResignationTransaction),
        (DelegateResignationTransaction.typeGroup =
          b.TransactionTypeGroup.Core),
        (DelegateResignationTransaction.type =
          b.TransactionType.DelegateResignation),
        (DelegateResignationTransaction.key = "delegateResignation"),
        (DelegateResignationTransaction.defaultStaticFee =
          n.BigNumber.make("2500000000")));
    },
    11270: function (e, a, c) {
      "use strict";
      (function (e) {
        var d =
            (this && this.__importDefault) ||
        ...
        const f = d(c(3057)),
          ...
          s = t(c(3232)),
          o = c(3231);
        class HtlcLockTransaction extends o.Transaction {
          static getSchema() {
            return s.htlcLock;
          }
          verify() {
            const e = n.configManager.getMilestone();
          ...
          serialize(a) {
            const { data: c } = this,
              d = new f.default(66, !0);
            return (
              d.writeUint64(c.amount.toString()),
              d.append(e.from(c.asset.lock.secretHash, "hex")),
              d.writeUint8(c.asset.lock.expiration.type),
              d.writeUint32(c.asset.lock.expiration.value),
              d.append(i.Address.toBuffer(c.recipientId).addressBuffer),
              d
            );
          }
          deserialize(e) {
            const { data: a } = this,
              c = r.BigNumber.make(e.readUint64().toString()),
              d = e.readBytes(32).toString("hex"),
              t = e.readUint8(),
              f = e.readUint32(),
              b = i.Address.fromBuffer(e.readBytes(21).toBuffer());
            ((a.amount = c),
              (a.recipientId = b),
              (a.asset = {
                lock: { secretHash: d, expiration: { type: t, value: f } },
              }));
          }
        }
        ((a.HtlcLockTransaction = HtlcLockTransaction),
          (HtlcLockTransaction.typeGroup = b.TransactionTypeGroup.Core),
          (HtlcLockTransaction.type = b.TransactionType.HtlcLock),
          (HtlcLockTransaction.key = "htlcLock"),
          (HtlcLockTransaction.defaultStaticFee =
            r.BigNumber.make("10000000")));
      }).call(this, c(2).Buffer);
    },
    11271: function (e, a, c) {
      "use strict";
      (function (e) {
        var d =
            (this && this.__importDefault) ||
        ...
        const f = d(c(3057)),
          ...
          r = t(c(3232)),
          s = c(3231);
        class HtlcClaimTransaction extends s.Transaction {
          static getSchema() {
            return r.htlcClaim;
          }
          verify() {
            const e = i.configManager.getMilestone();
            return !0 === e.aip11 && !0 === e.htlcEnabled && super.verify();
          }
          serialize(a) {
            const { data: c } = this,
              d = new f.default(64, !0);
            return (
              d.append(e.from(c.asset.claim.lockTransactionId, "hex")),
              d.append(e.from(c.asset.claim.unlockSecret, "hex")),
              d
            );
          }
          deserialize(e) {
            const { data: a } = this,
              c = e.readBytes(32).toString("hex"),
              d = e.readBytes(32).toString("hex");
            a.asset = { claim: { lockTransactionId: c, unlockSecret: d } };
          }
        }
        ((a.HtlcClaimTransaction = HtlcClaimTransaction),
          (HtlcClaimTransaction.typeGroup = b.TransactionTypeGroup.Core),
          (HtlcClaimTransaction.type = b.TransactionType.HtlcClaim),
          (HtlcClaimTransaction.key = "htlcClaim"),
          (HtlcClaimTransaction.defaultStaticFee = n.BigNumber.ZERO));
      }).call(this, c(2).Buffer);
    },
    11272: function (e, a, c) {
      "use strict";
      (function (e) {
        var d =
            (this && this.__importDefault) ||
        ...
        const f = d(c(3057)),
          ...
          r = t(c(3232)),
          s = c(3231);
        class HtlcRefundTransaction extends s.Transaction {
          static getSchema() {
            return r.htlcRefund;
          }
          verify() {
          ...
          serialize(a) {
            const { data: c } = this,
              d = new f.default(32, !0);
            return (
              d.append(e.from(c.asset.refund.lockTransactionId, "hex")),
              d
            );
          }
          deserialize(e) {
            const { data: a } = this,
              c = e.readBytes(32).toString("hex");
            a.asset = { refund: { lockTransactionId: c } };
          }
        }
        ((a.HtlcRefundTransaction = HtlcRefundTransaction),
          (HtlcRefundTransaction.typeGroup = b.TransactionTypeGroup.Core),
          (HtlcRefundTransaction.type = b.TransactionType.HtlcRefund),
          (HtlcRefundTransaction.key = "htlcRefund"),
          (HtlcRefundTransaction.defaultStaticFee = n.BigNumber.ZERO));
      }).call(this, c(2).Buffer);
    },
    11273: function (e, a, c) {
      "use strict";
      Object.defineProperty(a, "__esModule", { value: !0 });
      const d = c(2963),
        t = c(3070),
        f = c(3233);
      class DelegateResignationBuilder extends f.TransactionBuilder {
        constructor() {
          (super(),
            (this.data.type = t.DelegateResignationTransaction.type),
            (this.data.typeGroup = t.DelegateResignationTransaction.typeGroup),
            (this.data.version = 2),
            (this.data.fee = t.DelegateResignationTransaction.staticFee()),
            (this.data.amount = d.BigNumber.ZERO),
            (this.data.senderPublicKey = void 0));
        }
        getStruct() {
      ...
      a.DelegateResignationBuilder = DelegateResignationBuilder;
    },
    11274: function (e, a, c) {
      "use strict";
      Object.defineProperty(a, "__esModule", { value: !0 });
      const d = c(2963),
        t = c(3070),
        f = c(3233);
      class HtlcClaimBuilder extends f.TransactionBuilder {
        constructor() {
          (super(),
            (this.data.type = t.HtlcClaimTransaction.type),
            (this.data.typeGroup = t.HtlcClaimTransaction.typeGroup),
            (this.data.fee = t.HtlcClaimTransaction.staticFee()),
            (this.data.amount = d.BigNumber.ZERO),
            (this.data.asset = {}));
        }
        htlcClaimAsset(e) {
          return ((this.data.asset = { claim: e }), this);
        }
        getStruct() {
          const e = super.getStruct();
          return (
      ...
      a.HtlcClaimBuilder = HtlcClaimBuilder;
    },
    11275: function (e, a, c) {
      "use strict";
      Object.defineProperty(a, "__esModule", { value: !0 });
      const d = c(2963),
        t = c(3070),
        f = c(3233);
      class HtlcLockBuilder extends f.TransactionBuilder {
        constructor() {
          (super(),
            (this.data.type = t.HtlcLockTransaction.type),
            (this.data.typeGroup = t.HtlcLockTransaction.typeGroup),
            (this.data.recipientId = void 0),
            (this.data.amount = d.BigNumber.ZERO),
            (this.data.fee = t.HtlcLockTransaction.staticFee()),
            (this.data.vendorField = void 0),
            (this.data.asset = {}));
        }
        htlcLockAsset(e) {
          return ((this.data.asset = { lock: e }), this);
        }
        getStruct() {
          const e = super.getStruct();
          return (
            (e.recipientId = this.data.recipientId),
            (e.amount = this.data.amount),
            (e.vendorField = this.data.vendorField),
            (e.asset = this.data.asset),
            e
          );
        }
      ...
      a.HtlcLockBuilder = HtlcLockBuilder;
    },
    11276: function (e, a, c) {
      "use strict";
      Object.defineProperty(a, "__esModule", { value: !0 });
      const d = c(2963),
        t = c(3070),
        f = c(3233);
      class HtlcRefundBuilder extends f.TransactionBuilder {
        constructor() {
          (super(),
            (this.data.type = t.HtlcRefundTransaction.type),
            (this.data.typeGroup = t.HtlcRefundTransaction.typeGroup),
            (this.data.fee = t.HtlcRefundTransaction.staticFee()),
            (this.data.amount = d.BigNumber.ZERO),
            (this.data.asset = {}));
        }
        htlcRefundAsset(e) {
          return ((this.data.asset = { refund: e }), this);
        }
        getStruct() {
          const e = super.getStruct();
          return (
      ...
      a.HtlcRefundBuilder = HtlcRefundBuilder;
    },
    11277: function (e, a, c) {
      "use strict";
      Object.defineProperty(a, "__esModule", { value: !0 });
      const d = c(2963),
        t = c(3070),
        f = c(3233);
      class IPFSBuilder extends f.TransactionBuilder {
        constructor() {
          (super(),
            (this.data.type = t.IpfsTransaction.type),
            (this.data.typeGroup = t.IpfsTransaction.typeGroup),
            (this.data.fee = t.IpfsTransaction.staticFee()),
            (this.data.amount = d.BigNumber.ZERO),
            (this.data.asset = {}));
        }
        ipfsAsset(e) {
          return ((this.data.asset = { ipfs: e }), this);
        }
        getStruct() {
          const e = super.getStruct();
          return (
      ...
      a.IPFSBuilder = IPFSBuilder;
    },
    11278: function (e, a, c) {
      "use strict";
      Object.defineProperty(a, "__esModule", { value: !0 });
      const d = c(3033),
        t = c(3013),
        ...
        b = c(3070),
        i = c(3233);
      class MultiPaymentBuilder extends i.TransactionBuilder {
        constructor() {
          (super(),
            (this.data.type = b.MultiPaymentTransaction.type),
            (this.data.typeGroup = b.MultiPaymentTransaction.typeGroup),
            (this.data.fee = b.MultiPaymentTransaction.staticFee()),
            (this.data.vendorField = void 0),
            (this.data.asset = { payments: [] }),
            (this.data.amount = f.BigNumber.make(0)));
        }
        addPayment(e, a) {
          const c = t.configManager.getMilestone().multiPaymentLimit || 500;
          if (this.data.asset.payments.length >= c)
            throw new d.MaximumPaymentCountExceededError(c);
          return (
            this.data.asset.payments.push({
              amount: f.BigNumber.make(a),
              recipientId: e,
            }),
            this
          );
        ...
        getStruct() {
          if (
            ...
            throw new d.MinimumPaymentCountSubceededError();
          const e = super.getStruct();
          return (
            (e.senderPublicKey = this.data.senderPublicKey),
            (e.vendorField = this.data.vendorField),
            (e.amount = this.data.amount),
            (e.asset = this.data.asset),
            e
      ...
      a.MultiPaymentBuilder = MultiPaymentBuilder;
    },
    11279: function (e, a, c) {
      "use strict";
      Object.defineProperty(a, "__esModule", { value: !0 });
      const d = c(2963),
        t = c(3070),
        f = c(3233);
      class MultiSignatureBuilder extends f.TransactionBuilder {
        constructor() {
          (super(),
            (this.data.type = t.MultiSignatureRegistrationTransaction.type),
            (this.data.typeGroup =
              t.MultiSignatureRegistrationTransaction.typeGroup),
            (this.data.version = 2),
            (this.data.fee = d.BigNumber.ZERO),
            (this.data.amount = d.BigNumber.ZERO),
            (this.data.recipientId = void 0),
            (this.data.senderPublicKey = void 0),
        ...
        participant(e) {
          const { publicKeys: a } = this.data.asset.multiSignature;
          return (
            a.length <= 16 &&
              (a.push(e),
              (this.data.fee =
                t.MultiSignatureRegistrationTransaction.staticFee({
                  data: this.data,
                }))),
            this
          );
        ...
        multiSignatureAsset(e) {
          return (
            (this.data.asset.multiSignature = e),
            (this.data.fee = t.MultiSignatureRegistrationTransaction.staticFee({
              data: this.data,
            })),
            this
          );
      ...
      a.MultiSignatureBuilder = MultiSignatureBuilder;
    },
    11280: function (e, a, c) {
      "use strict";
      Object.defineProperty(a, "__esModule", { value: !0 });
      const d = c(3401),
        t = c(2963),
        f = c(3070),
        b = c(3233);
      class SecondSignatureBuilder extends b.TransactionBuilder {
        constructor() {
          (super(),
            (this.data.type = f.SecondSignatureRegistrationTransaction.type),
            (this.data.typeGroup =
              f.SecondSignatureRegistrationTransaction.typeGroup),
            (this.data.fee =
              f.SecondSignatureRegistrationTransaction.staticFee()),
            (this.data.amount = t.BigNumber.ZERO),
            (this.data.recipientId = void 0),
            (this.data.senderPublicKey = void 0),
        ...
        signatureAsset(e) {
          return (
            (this.data.asset.signature.publicKey =
              d.Keys.fromPassphrase(e).publicKey),
            this
          );
        }
        getStruct() {
      ...
      a.SecondSignatureBuilder = SecondSignatureBuilder;
    },
    11281: function (e, a, c) {
      "use strict";
      Object.defineProperty(a, "__esModule", { value: !0 });
      const d = c(2963),
        t = c(3070),
        f = c(3233);
      class TransferBuilder extends f.TransactionBuilder {
        constructor() {
          (super(),
            (this.data.type = t.TransferTransaction.type),
            (this.data.typeGroup = t.TransferTransaction.typeGroup),
            (this.data.fee = t.TransferTransaction.staticFee()),
            (this.data.amount = d.BigNumber.ZERO),
            (this.data.recipientId = void 0),
            (this.data.senderPublicKey = void 0),
        ...
        getStruct() {
          ...
          return (
            ...
            (e.asset = this.data.asset),
            (e.vendorField = this.data.vendorField),
            (e.expiration = this.data.expiration),
            e
          );
        }
        instance() {
      ...
      a.TransferBuilder = TransferBuilder;
    },
    11282: function (e, a, c) {
      "use strict";
      Object.defineProperty(a, "__esModule", { value: !0 });
      const d = c(2963),
        t = c(3070),
        f = c(3233);
      class VoteBuilder extends f.TransactionBuilder {
        constructor() {
          (super(),
            (this.data.type = t.VoteTransaction.type),
            (this.data.typeGroup = t.VoteTransaction.typeGroup),
            (this.data.fee = t.VoteTransaction.staticFee()),
            (this.data.amount = d.BigNumber.ZERO),
            (this.data.recipientId = void 0),
            (this.data.senderPublicKey = void 0),
      ...
      a.VoteBuilder = VoteBuilder;
    },
    11283: function (e, a, c) {
      "use strict";
      Object.defineProperty(a, "__esModule", { value: !0 });
      const d = c(3033),
        t = c(2963),
      ...
      class TransactionFactory {
        ...
        static fromBytes(e, a) {
          return (
            void 0 === a && (a = !0),
            this.fromSerialized(e ? e.toString("hex") : void 0, a)
          );
        }
        static fromBytesUnsafe(e, a) {
          try {
            const c = { acceptLegacyVersion: !0 },
              d = f.Deserializer.deserialize(e, c);
            return (
              (d.data.id = a || n.Utils.getId(d.data, c)),
              (d.isVerified = !0),
              d
            );
          } catch (c) {
            throw new d.InvalidTransactionBytesError(c.message);
          }
        }
        static fromJson(e) {
          const a = { ...e };
          return (
            (a.amount = t.BigNumber.make(a.amount)),
            (a.fee = t.BigNumber.make(a.fee)),
            this.fromData(a)
          );
        }
        static fromData(e, a) {
          void 0 === a && (a = !0);
          const { value: c, error: n } = r.Verifier.verifySchema(e, a);
          if (n && !t.isException(c)) throw new d.TransactionSchemaError(n);
          const s = i.TransactionTypeFactory.create(c),
            { version: o } = s.data;
          return (
            1 === o && f.Deserializer.applyV1Compatibility(s.data),
            b.Serializer.serialize(s),
            this.fromBytes(s.serialized, a)
          );
        }
        static fromSerialized(e, a) {
          void 0 === a && (a = !0);
          try {
            const c = f.Deserializer.deserialize(e);
            c.data.id = n.Utils.getId(c.data);
            const { value: b, error: i } = r.Verifier.verifySchema(c.data, a);
            if (i && !t.isException(b)) throw new d.TransactionSchemaError(i);
            return ((c.isVerified = c.verify()), c);
          } catch (c) {
            if (
              c instanceof d.TransactionVersionError ||
              c instanceof d.TransactionSchemaError ||
              c instanceof d.DuplicateParticipantInMultiSignatureError
            )
              throw c;
            throw new d.InvalidTransactionBytesError(c.message);
          }
      ...
      a.TransactionFactory = TransactionFactory;
    },
    11284: function (e, a, c) {
      "use strict";
      Object.defineProperty(a, "__esModule", { value: !0 });
      const d = c(3014),
        t = c(3033),
      ...
      class TransactionRegistry {
        constructor() {
          ((this.transactionTypes = new Map()),
            f.TransactionTypeFactory.initialize(this.transactionTypes),
            this.registerTransactionType(f.TransferTransaction),
            this.registerTransactionType(
              f.SecondSignatureRegistrationTransaction,
            ),
            this.registerTransactionType(f.DelegateRegistrationTransaction),
            this.registerTransactionType(f.VoteTransaction),
            this.registerTransactionType(
              f.MultiSignatureRegistrationTransaction,
            ),
            this.registerTransactionType(f.IpfsTransaction),
            this.registerTransactionType(f.MultiPaymentTransaction),
            this.registerTransactionType(f.DelegateResignationTransaction),
            this.registerTransactionType(f.HtlcLockTransaction),
            this.registerTransactionType(f.HtlcClaimTransaction),
            this.registerTransactionType(f.HtlcRefundTransaction));
        }
        registerTransactionType(e) {
          const { typeGroup: a, type: c } = e,
            d = b.InternalTransactionType.from(c, a);
          if (this.transactionTypes.has(d))
            throw new t.TransactionAlreadyRegisteredError(e.name);
          if (
            Array.from(this.transactionTypes.values()).some((a) => {
              let { key: c } = a;
              return c === e.key;
            })
          )
            throw new t.TransactionKeyAlreadyRegisteredError(e.key);
          (this.transactionTypes.set(d, e), this.updateSchemas(e));
        }
        deregisterTransactionType(e) {
          const { typeGroup: a, type: c } = e,
            f = b.InternalTransactionType.from(c, a);
          if (!this.transactionTypes.has(f))
            throw new t.UnkownTransactionError(f.toString());
          if (a === d.TransactionTypeGroup.Core)
            throw new t.CoreTransactionTypeGroupImmutableError();
          const i = this.transactionTypes.get(f);
          (this.updateSchemas(i, !0), this.transactionTypes.delete(f));
        }
        updateSchemas(e, a) {}
      }
      a.transactionRegistry = new TransactionRegistry();
    },
    11287: function (e, a, c) {
      "use strict";
      Object.defineProperty(a, "__esModule", { value: !0 });
    },
    2963: function (e, a, c) {
      ...
      a.Base58 = i.Base58;
      const n = c(3203);
      a.BigNumber = n.BigNumber;
      const r = c(11258);
      ((a.isLocalHost = r.isLocalHost), (a.isValidPeer = r.isValidPeer));
      const s = t.default((e) => {
          const a = new Set(),
            c = b.configManager.get("exceptions.blocks") || [],
            d = b.configManager.get("exceptions.transactions") || [];
          for (const t of c) a.add(t);
          for (const t of d) a.add(t);
          return a;
        }),
        o = t.default((e) => {
          const a = new Set(),
            c = b.configManager.get("genesisBlock.transactions") || [];
          for (const d of c) a.add(d.id);
          return a;
        });
      ((a.formatSatoshi = (e) => {
        const a = (+e / f.SATOSHI).toLocaleString("en", {
          minimumFractionDigits: 0,
          maximumFractionDigits: 8,
        });
        return `${a} ${b.configManager.get("network.client.symbol")}`;
      }),
        (a.isException = (e) => {
          const a = b.configManager.get("network");
          return s(a).has(e.id);
        }),
        (a.isGenesisTransaction = (e) => {
          const a = b.configManager.get("network");
          return o(a).has(e);
        }),
        (a.numberToHex = function (e, a) {
          void 0 === a && (a = 2);
          const c = Number(e).toString(16);
          return "0".repeat(a - c.length) + c;
        }),
        (a.maxVendorFieldLength = (e) =>
          b.configManager.getMilestone(e).vendorFieldLength),
        (a.isSupportedTransactionVersion = (e) => {
          const a = b.configManager.getMilestone().aip11;
          return (!a || 2 === e) && !(!a && 1 !== e);
        }));
    },
    3070: function (e, a, c) {
      ...
      var t =
        ...
        function (e) {
          ...
          var a = {};
          if (null != e)
            for (var c in e) Object.hasOwnProperty.call(e, c) && (a[c] = e[c]);
          return ((a["default"] = e), a);
        };
      (Object.defineProperty(a, "__esModule", { value: !0 }),
        d(c(3231)),
    ...
    3231: function (e, a, c) {
      ...
      class Transaction {
        ...
        static staticFee(e) {
          void 0 === e && (e = {});
          const a = f.configManager.getMilestone(e.height);
          if (a.fees && a.fees.staticFees) {
            const e = a.fees.staticFees[this.key];
            if (void 0 !== e) return b.BigNumber.make(e);
          }
          return this.defaultStaticFee;
        }
        verify() {
          return i.Verifier.verify(this.data);
        }
        verifySecondSignature(e) {
          return i.Verifier.verifySecondSignature(this.data, e);
        }
        verifySchema() {
          return i.Verifier.verifySchema(this.data);
        }
        toJson() {
          const e = JSON.parse(JSON.stringify(this.data));
          return (
            e.typeGroup === d.TransactionTypeGroup.Core && delete e.typeGroup,
            1 === e.version ? delete e.nonce : delete e.timestamp,
            e
          );
        }
        hasVendorField() {
      ...
      ((a.Transaction = Transaction),
        (Transaction.type = void 0),
        (Transaction.typeGroup = void 0),
        (Transaction.key = void 0),
        (Transaction.defaultStaticFee = b.BigNumber.ZERO));
    },
    3232: function (e, a, c) {
      "use strict";
      Object.defineProperty(a, "__esModule", { value: !0 });
      ...
      ((a.transactionBaseSchema = {
        $id: void 0,
        type: "object",
        if: {
          properties: { version: { anyOf: [{ type: "null" }, { const: 1 }] } },
        },
        then: {
        ...
        properties: {
          ...
          amount: { bignumber: { minimum: 1, bypassGenesis: !0 } },
          fee: { bignumber: { minimum: 0, bypassGenesis: !0 } },
        ...
        (a.extend = (e, a) => d(e, a)),
        (a.signedSchema = (e) => {
          const c = a.extend(e, f);
          return ((c.$id = e.$id + "Signed"), c);
        }),
        (a.strictSchema = (e) => {
          const c = a.signedSchema(e),
            d = a.extend(c, b);
          return ((d.$id = e.$id + "Strict"), d);
        }),
        (a.transfer = a.extend(a.transactionBaseSchema, {
          $id: "transfer",
          required: ["recipientId"],
          properties: {
            type: { transactionType: t.TransactionType.Transfer },
            fee: { bignumber: { minimum: 1, bypassGenesis: !0 } },
            vendorField: {
              anyOf: [
                { type: "null" },
        ...
        (a.secondSignature = a.extend(a.transactionBaseSchema, {
          $id: "secondSignature",
          required: ["asset"],
          properties: {
            type: { transactionType: t.TransactionType.SecondSignature },
        ...
        (a.delegateRegistration = a.extend(a.transactionBaseSchema, {
          $id: "delegateRegistration",
          required: ["asset"],
          properties: {
            type: { transactionType: t.TransactionType.DelegateRegistration },
            amount: { bignumber: { minimum: 0, maximum: 0 } },
            fee: { bignumber: { minimum: 1, bypassGenesis: !0 } },
            asset: {
              type: "object",
        ...
        (a.vote = a.extend(a.transactionBaseSchema, {
          $id: "vote",
          required: ["asset"],
          properties: {
            type: { transactionType: t.TransactionType.Vote },
            amount: { bignumber: { minimum: 0, maximum: 0 } },
            fee: { bignumber: { minimum: 1 } },
            recipientId: { $ref: "address" },
            asset: {
        ...
        (a.multiSignature = a.extend(a.transactionBaseSchema, {
          $id: "multiSignature",
          required: ["asset", "signatures"],
          properties: {
            type: { transactionType: t.TransactionType.MultiSignature },
            amount: { bignumber: { minimum: 0, maximum: 0 } },
            fee: { bignumber: { minimum: 1 } },
            asset: {
              type: "object",
      ...
      const i = a.extend(a.transactionBaseSchema, {});
      (delete i.properties.signatures,
        (a.multiSignatureLegacy = a.extend(i, {
              ...
              properties: {
                multiSignatureLegacy: {
                  ...
                  properties: {
                    ...
                    lifetime: { type: "integer", minimum: 1, maximum: 72 },
                    keysgroup: {
                      type: "array",
                      minItems: 1,
                      maxItems: 16,
        ...
        (a.ipfs = a.extend(a.transactionBaseSchema, {
          $id: "ipfs",
          properties: {
            type: { transactionType: t.TransactionType.Ipfs },
            amount: { bignumber: { minimum: 0, maximum: 0 } },
            fee: { bignumber: { minimum: 1 } },
            asset: {
              type: "object",
        ...
        (a.htlcLock = a.extend(a.transactionBaseSchema, {
          $id: "htlcLock",
          properties: {
            type: { transactionType: t.TransactionType.HtlcLock },
        ...
        (a.htlcClaim = a.extend(a.transactionBaseSchema, {
          $id: "htlcClaim",
          properties: {
            type: { transactionType: t.TransactionType.HtlcClaim },
            amount: { bignumber: { minimum: 0, maximum: 0 } },
        ...
        (a.htlcRefund = a.extend(a.transactionBaseSchema, {
          $id: "htlcRefund",
          properties: {
            type: { transactionType: t.TransactionType.HtlcRefund },
            amount: { bignumber: { minimum: 0, maximum: 0 } },
            fee: { bignumber: { minimum: 0, maximum: 0 } },
            asset: {
              type: "object",
              ...
              properties: {
                refund: {
                  ...
                  properties: { lockTransactionId: { $ref: "transactionId" } },
                },
              },
            },
          },
        })),
        (a.multiPayment = a.extend(a.transactionBaseSchema, {
          $id: "multiPayment",
          properties: {
            type: { transactionType: t.TransactionType.MultiPayment },
            amount: { bignumber: { minimum: 0, maximum: 0 } },
            fee: { bignumber: { minimum: 1 } },
            vendorField: {
              anyOf: [
        ...
        (a.delegateResignation = a.extend(a.transactionBaseSchema, {
          $id: "delegateResignation",
          properties: {
            type: { transactionType: t.TransactionType.DelegateResignation },
            amount: { bignumber: { minimum: 0, maximum: 0 } },
            fee: { bignumber: { minimum: 1 } },
          },
        })));
    ...
    3233: function (e, a, c) {
      ...
      (function (e) {
        ...
        class TransactionBuilder {
          constructor() {
            ((this.signWithSenderAsRecipient = !1),
              (this.data = {
                id: void 0,
                timestamp: t.Slots.getTime(),
                typeGroup: f.TransactionTypeGroup.Test,
                nonce: r.BigNumber.ZERO,
                version: n.configManager.getMilestone().aip11 ? 2 : 1,
              }));
          }
          build(e) {
            return (
              void 0 === e && (e = {}),
              d.TransactionFactory.fromData({ ...this.data, ...e }, !1)
            );
          }
          version(e) {
          ...
          nonce(e) {
            return (
              e && (this.data.nonce = r.BigNumber.make(e)),
              this.instance()
            );
          }
          network(e) {
          ...
          fee(e) {
            return (
              e && (this.data.fee = r.BigNumber.make(e)),
              this.instance()
            );
          }
          amount(e) {
            return ((this.data.amount = r.BigNumber.make(e)), this.instance());
          }
          recipientId(e) {
          ...
          vendorField(a) {
            const c = r.maxVendorFieldLength();
            if (a) {
              if (e.from(a).length > c)
                throw new b.VendorFieldLengthExceededError(c);
              this.data.vendorField = a;
            }
            return this.instance();
          }
          sign(e) {
            const a = i.Keys.fromPassphrase(e);
            return this.signWithKeyPair(a);
          }
          signWithWif(e, a) {
            const c = i.Keys.fromWIF(e, {
              wif: a || n.configManager.get("network.wif"),
            });
            return this.signWithKeyPair(c);
          }
          secondSign(e) {
            return this.secondSignWithKeyPair(i.Keys.fromPassphrase(e));
          }
          secondSignWithWif(e, a) {
            const c = i.Keys.fromWIF(e, {
              wif: a || n.configManager.get("network.wif"),
            });
            return this.secondSignWithKeyPair(c);
          }
          multiSign(e, a) {
            const c = i.Keys.fromPassphrase(e);
            return this.multiSignWithKeyPair(a, c);
          }
          multiSignWithWif(e, a, c) {
            const d = i.Keys.fromWIF(a, {
              wif: c || n.configManager.get("network.wif"),
            });
            return this.multiSignWithKeyPair(e, d);
          }
          verify() {
            return o.Verifier.verifyHash(this.data);
          }
          getStruct() {
            if (
              !this.data.senderPublicKey ||
              (!this.data.signature && !this.data.signatures)
            )
              throw new b.MissingTransactionSignatureError();
            const e = {
              id: d.Utils.getId(this.data).toString(),
            ...
            return (
              1 === this.data.version
                ? (e.timestamp = this.data.timestamp)
                : ((e.typeGroup = this.data.typeGroup),
                  (e.nonce = this.data.nonce)),
              Array.isArray(this.data.signatures) &&
                (e.signatures = this.data.signatures),
              e
            );
          }
          signWithKeyPair(e) {
            return (
              (this.data.senderPublicKey = e.publicKey),
              this.signWithSenderAsRecipient &&
                (this.data.recipientId = i.Address.fromPublicKey(
                  e.publicKey,
                  this.data.network,
                )),
              (this.data.signature = s.Signer.sign(this.getSigningObject(), e)),
              this.instance()
            );
          }
          secondSignWithKeyPair(e) {
            return (
              (this.data.secondSignature = s.Signer.secondSign(
          ...
          multiSignWithKeyPair(e, a) {
            return (
              this.data.signatures || (this.data.signatures = []),
              this.version(2),
              s.Signer.multiSign(this.getSigningObject(), a, e),
              this.instance()
            );
          }
          getSigningObject() {
            ...
            for (const a of Object.keys(e))
              ["model", "network", "id"].includes(a) && delete e[a];
            return e;
          }
        }
        a.TransactionBuilder = TransactionBuilder;
      }).call(this, c(2).Buffer);
    },
    4858: function (e, a, c) {
      "use strict";
      ...
      (Object.defineProperty(a, "__esModule", { value: !0 }),
        ...
        d(c(4859)));
      var t = c(11284);
      a.TransactionRegistry = t.transactionRegistry;
    },
    4859: function (e, a, c) {
      "use strict";
      (function (e) {
        ...
        class Verifier {
          static verify(e) {
            return (
              !!b.isException(e) ||
              (!(
                f.configManager.getMilestone().aip11 &&
                (!e.version || 1 === e.version)
              ) &&
                Verifier.verifyHash(e))
            );
          }
          static verifySecondSignature(e, a) {
            const c = e.secondSignature || e.signSignature;
            if (!c) return !1;
            const d = i.Utils.toHash(e, { excludeSecondSignature: !0 });
            return this.internalVerifySignature(d, c, a);
          }
          static verifySignatures(e, a) {
            if (!a) throw new t.InvalidMultiSignatureAssetError();
            const { publicKeys: c, min: f } = a,
              { signatures: b } = e,
              n = i.Utils.toHash(e, {
                excludeSignature: !0,
            ...
            for (let i = 0; i < b.length; i++) {
              const e = b[i],
                a = parseInt(e.slice(0, 2), 16);
              if (r[a]) throw new t.DuplicateParticipantInMultiSignatureError();
              r[a] = !0;
              const u = e.slice(2, 130),
                p = c[a];
              if ((d.Hash.verifySchnorr(n, u, p) && o++, o === f)) {
                s = !0;
                break;
              }
              if (b.length - (i + 1 - o) < f) break;
            }
            return s;
          }
          static verifyHash(e) {
            const { signature: a, senderPublicKey: c } = e;
            if (!a) return !1;
            const d = i.Utils.toHash(e, {
              excludeSignature: !0,
              excludeSecondSignature: !0,
            });
            return this.internalVerifySignature(d, a, c);
          }
          static verifySchema(e, a) {
            return (void 0 === a && (a = !0), !0);
          }
          static internalVerifySignature(a, c, t) {
            const f = 64 === e.from(c, "hex").byteLength;
            return f
              ? d.Hash.verifySchnorr(a, c, t)
              : d.Hash.verifyECDSA(a, c, t);
          }
        }
        a.Verifier = Verifier;
      }).call(this, c(2).Buffer);
    ...
    4860: function (e, a, c) {
      ...
      class Utils {
        static toBytes(e) {
          return i.Serializer.serialize(n.TransactionTypeFactory.create(e));
        }
        static toHash(e, a) {
          return d.HashAlgorithms.sha256(i.Serializer.getBytes(e, a));
        }
        static getId(e, a) {
          void 0 === a && (a = {});
          const c = Utils.toHash(e, a).toString("hex");
          if (a.addressError && !b.isException({ id: c }))
            throw new t.AddressNetworkError(a.addressError);
          const { transactionIdFixTable: d } =
            f.configManager.get("exceptions");
          return d && d[c] ? d[c] : c;
        }
      }
      a.Utils = Utils;
    ...
    5674: function (e, a, c) {
      ...
      (function (e) {
        ...
        const t = c(6849),
          ...
          b = c(3400),
          i = (a) => {
            const c = b.HashAlgorithms.hash256(a);
            return t.base58.encode(e.concat([a, c], a.length + 4));
          },
          n = (e) => {
            const a = t.base58.decode(e),
              c = a.slice(0, -4),
              d = b.HashAlgorithms.hash256(c);
            if (d.readUInt32LE(0) !== a.slice(-4).readUInt32LE(0))
              throw new Error("Invalid checksum");
            return c;
          };
        a.Base58 = { encodeCheck: f.default(i), decodeCheck: f.default(n) };
      }).call(this, c(2).Buffer);
    },
    5692: function (e, a, c) {
      "use strict";
      (function (e) {
        ...
        class Serializer {
          static getBytes(e, a) {
            void 0 === a && (a = {});
            const c = e.version || 1;
            if (a.acceptLegacyVersion || s.isSupportedTransactionVersion(c))
              return 1 === c
                ? this.getBytesV1(e, a)
                : this.serialize(o.TransactionTypeFactory.create(e), a);
            throw new i.TransactionVersionError(c);
          }
          static serialize(e, a) {
            void 0 === a && (a = {});
            const c = new t.default(512, !0);
            (this.serializeCommon(e.data, c), this.serializeVendorField(e, c));
            const d = e.serialize(a).flip();
            (c.append(d), this.serializeSignatures(e.data, c, a));
            const f = c.flip().toBuffer();
            return ((e.serialized = f), f);
          }
          static getBytesV1(a, c) {
            void 0 === c && (c = {});
            let d,
              f = 0;
            switch (a.type) {
              case b.TransactionType.SecondSignature: {
                const { signature: c } = a.asset,
                  b = new t.default(33, !0),
                  i = e.from(c.publicKey, "hex");
                for (const e of i) b.writeByte(e);
                (b.flip(),
                  (d = new Uint8Array(b.toArrayBuffer())),
                  (f = d.length));
                break;
              }
              case b.TransactionType.DelegateRegistration:
                ((d = e.from(a.asset.delegate.username, "utf8")),
                  (f = d.length));
                break;
              case b.TransactionType.Vote:
                a.asset.votes &&
                  ((d = e.from(a.asset.votes.join(""), "utf8")),
                  (f = d.length));
                break;
              case b.TransactionType.MultiSignature: {
                const c = e.from(
                    a.asset.multiSignatureLegacy.keysgroup.join(""),
                    "utf8",
                  ),
                  b = new t.default(2 + c.length, !0);
                (b.writeByte(a.asset.multiSignatureLegacy.min),
                  b.writeByte(a.asset.multiSignatureLegacy.lifetime));
                for (const e of c) b.writeByte(e);
                (b.flip(), (d = b.toBuffer()), (f = d.length));
                break;
              }
            }
            const i = new t.default(266 + f, !0);
            (i.writeByte(a.type), i.writeInt(a.timestamp));
            const s = e.from(a.senderPublicKey, "hex");
            for (const e of s) i.writeByte(e);
            const { transactionIdFixTable: o } =
                r.configManager.get("exceptions"),
              u = o && Object.values(o).includes(a.id);
            if (u || (a.recipientId && 1 !== a.type && 4 !== a.type)) {
              const e =
                  a.recipientId ||
                  n.Address.fromPublicKey(a.senderPublicKey, a.network),
                c = n.Address.toBuffer(e).addressBuffer;
              for (const a of c) i.writeByte(a);
            } else for (let e = 0; e < 21; e++) i.writeByte(0);
            if (a.vendorField) {
              const c = e.from(a.vendorField),
                d = c.length;
              for (let e = 0; e < d; e++) i.writeByte(c[e]);
              for (let e = d; e < 64; e++) i.writeByte(0);
            } else for (let e = 0; e < 64; e++) i.writeByte(0);
            if (
              (i.writeInt64(a.amount.toString()),
              i.writeInt64(a.fee.toString()),
              f > 0)
            )
              for (let e = 0; e < f; e++) i.writeByte(d[e]);
            if (!c.excludeSignature && a.signature) {
              const c = e.from(a.signature, "hex");
              for (const e of c) i.writeByte(e);
            }
            if (!c.excludeSecondSignature && a.secondSignature) {
              const c = e.from(a.secondSignature, "hex");
              for (const e of c) i.writeByte(e);
            }
            i.flip();
            const p = new Uint8Array(i.toArrayBuffer()),
              l = [];
            for (let e = 0; e < p.length; e++) l[e] = p[e];
            return e.from(l);
          }
          static serializeCommon(e, a) {
            ((e.version = e.version || 1),
              void 0 === e.typeGroup &&
                (e.typeGroup = b.TransactionTypeGroup.Core),
              a.writeByte(255),
              a.writeByte(e.version),
              a.writeByte(
                e.network || r.configManager.get("network.pubKeyHash"),
              ),
              1 === e.version
                ? (a.writeByte(e.type), a.writeUint32(e.timestamp))
                : (a.writeUint32(e.typeGroup),
                  a.writeUint16(e.type),
                  a.writeUint64(e.nonce.toString())),
              a.append(e.senderPublicKey, "hex"),
              a.writeUint64(e.fee.toString()));
          }
          static serializeVendorField(a, c) {
            if (a.hasVendorField()) {
              const { data: d } = a;
              if (d.vendorField) {
                const a = e.from(d.vendorField, "utf8");
                (c.writeByte(a.length), c.append(a));
              } else c.writeByte(0);
            } else c.writeByte(0);
          }
          static serializeSignatures(e, a, c) {
            (void 0 === c && (c = {}),
              e.signature &&
                !c.excludeSignature &&
                a.append(e.signature, "hex"));
            const d = e.secondSignature || e.signSignature;
            (d && !c.excludeSecondSignature && a.append(d, "hex"),
              e.signatures &&
                (1 === e.version && f.Utils.isException(e)
                  ? (a.append("ff", "hex"),
                    a.append(e.signatures.join(""), "hex"))
                  : c.excludeMultiSignature ||
                    a.append(e.signatures.join(""), "hex")));
          }
        }
    ...
    5693: function (e, a, c) {
      ...
      class InternalTransactionType {
        constructor(e, a) {
          ((this.type = e), (this.typeGroup = a));
        }
        static from(e, a) {
          void 0 === a && (a = d.TransactionTypeGroup.Core);
          const c = `${a}-${e}`;
          return (
            this.types.has(c) ||
              this.types.set(c, new InternalTransactionType(e, a)),
            this.types.get(c)
          );
        }
        toString() {
          return this.typeGroup === d.TransactionTypeGroup.Core
            ? "Core/" + this.type
            : `${this.typeGroup}/${this.type}`;
        }
      }
      ((a.InternalTransactionType = InternalTransactionType),
    ...
    6879: function (e, a, c) {
      ...
      class TransactionTypeFactory {
        ...
        static create(e) {
          const a = new (this.get(e.type, e.typeGroup))();
          return ((a.data = e), (a.data.version = e.version || 1), a);
        }
        static get(e, a) {
          const c = t.InternalTransactionType.from(e, a);
          if (this.transactionTypes.has(c)) return this.transactionTypes.get(c);
          throw new d.UnkownTransactionError(c.toString());
        }
      }
      a.TransactionTypeFactory = TransactionTypeFactory;
    },
    6880: function (e, a, c) {
      "use strict";
      Object.defineProperty(a, "__esModule", { value: !0 });
      ...
      class Signer {
        static sign(e, a, c) {
          c = c || { excludeSignature: !0, excludeSecondSignature: !0 };
          const t = f.Utils.toHash(e, c),
            b =
              e.version > 1 ? d.Hash.signSchnorr(t, a) : d.Hash.signECDSA(t, a);
          return (
            e.signature || c.excludeMultiSignature || (e.signature = b),
            b
          );
        }
        static secondSign(e, a) {
          const c = f.Utils.toHash(e, { excludeSecondSignature: !0 }),
            t =
              e.version > 1 ? d.Hash.signSchnorr(c, a) : d.Hash.signECDSA(c, a);
          return (e.secondSignature || (e.secondSignature = t), t);
        }
        static multiSign(e, a, c) {
          (void 0 === c && (c = -1),
            e.signatures || (e.signatures = []),
            (c = -1 === c ? e.signatures.length : c));
          const b = f.Utils.toHash(e, {
              excludeSignature: !0,
              excludeSecondSignature: !0,
              excludeMultiSignature: !0,
            }),
            i = d.Hash.signSchnorr(b, a),
            n = `${t.numberToHex(c)}${i}`;
          return (e.signatures.push(n), n);
        }
      }
      a.Signer = Signer;
    },
    6881: function (e, a, c) {
      ...
      (function (e) {
        ...
        const t = d(c(3057)),
          ...
          r = c(3070);
        class Deserializer {
          static deserialize(e, a) {
            void 0 === a && (a = {});
            const c = {},
              d = this.getByteBuffer(e);
            this.deserializeCommon(c, d);
            const t = r.TransactionTypeFactory.create(c);
            if (
              (this.deserializeVendorField(t, d),
              t.deserialize(d),
              this.deserializeSignatures(c, d),
              !a.acceptLegacyVersion &&
                !n.isSupportedTransactionVersion(c.version))
            )
              throw new b.TransactionVersionError(c.version);
            return (
              1 === c.version && this.applyV1Compatibility(c),
              (t.serialized = d.flip().toBuffer()),
              t
            );
          }
          static deserializeCommon(e, a) {
            (a.skip(1),
              (e.version = a.readUint8()),
              (e.network = a.readUint8()),
              1 === e.version
                ? ((e.type = a.readUint8()), (e.timestamp = a.readUint32()))
                : ((e.typeGroup = a.readUint32()),
                  (e.type = a.readUint16()),
                  (e.nonce = n.BigNumber.make(a.readUint64().toString()))),
              (e.senderPublicKey = a.readBytes(33).toString("hex")),
              (e.fee = n.BigNumber.make(a.readUint64().toString())),
              (e.amount = n.BigNumber.ZERO));
          }
          static deserializeVendorField(e, a) {
            const c = a.readUint8();
            if (c > 0)
              if (e.hasVendorField()) {
                const d = a.readBytes(c).toBuffer();
                e.data.vendorField = d.toString("utf8");
              } else a.skip(c);
          }
          static deserializeSignatures(e, a) {
            1 === e.version
              ? this.deserializeECDSA(e, a)
              : this.deserializeSchnorrOrECDSA(e, a);
          }
          static deserializeSchnorrOrECDSA(e, a) {
            this.detectSchnorr(a)
              ? this.deserializeSchnorr(e, a)
              : this.deserializeECDSA(e, a);
          }
          static deserializeECDSA(e, a) {
            const c = () => {
              a.mark();
              const e = a.skip(1).readBytes(1).toString("hex");
              return (a.reset(), parseInt(e, 16) + 2);
            };
            if (a.remaining()) {
              const d = c();
              e.signature = a.readBytes(d).toString("hex");
            }
            const d = () => {
              a.mark();
              const e = a.readUint8();
              return (a.reset(), 255 === e);
            };
            if (a.remaining() && !d()) {
              const d = c();
              e.secondSignature = a.readBytes(d).toString("hex");
            }
            if (a.remaining() && d()) {
              a.skip(1);
              const c = a.readBytes(a.limit - a.offset).toString("hex");
              e.signatures = [c];
            }
            if (a.remaining())
              throw new b.InvalidTransactionBytesError(
                "signature buffer not exhausted",
              );
          }
          static deserializeSchnorr(e, a) {
            const c = () =>
              a.remaining() &&
              (a.remaining() % 64 === 0 || a.remaining() % 65 !== 0);
            if (
              (c() && (e.signature = a.readBytes(64).toString("hex")),
              c() && (e.secondSignature = a.readBytes(64).toString("hex")),
              a.remaining())
            ) {
              if (a.remaining() % 65 !== 0)
                throw new b.InvalidTransactionBytesError(
              ...
              {
                e.signatures = [];
                const c = a.remaining() / 65,
                  d = {};
                for (let t = 0; t < c; t++) {
                  const c = a.readBytes(65).toString("hex"),
                    t = parseInt(c.slice(0, 2), 16);
                  if (d[t])
                    throw new b.DuplicateParticipantInMultiSignatureError();
                  ((d[t] = !0), e.signatures.push(c));
                }
              }
            }
          }
          ...
          static applyV1Compatibility(e) {
            ((e.secondSignature = e.secondSignature || e.signSignature),
              (e.typeGroup = f.TransactionTypeGroup.Core),
              e.type === f.TransactionType.Vote
                ? (e.recipientId = i.Address.fromPublicKey(
                    e.senderPublicKey,
                    e.network,
                  ))
                : e.type === f.TransactionType.MultiSignature &&
                  (e.asset.multiSignatureLegacy.keysgroup =
                    e.asset.multiSignatureLegacy.keysgroup.map((e) =>
                      e.startsWith("+") ? e : "+" + e,
                    )));
          }
          static getByteBuffer(a) {
            a instanceof e || (a = e.from(a, "hex"));
            const c = new t.default(a.length, !0);
            return (c.append(a), c.reset(), c);
          }
        }
