(this["webpackJsonp"] = this["webpackJsonp"] || []).push([
  [45, 410],
  {
    ...
    2821: function (t, e, n) {
      ...
      e.default = {
        name: "RateStars",
        components: { RateStart: s.RateStart },
        props: {
    ...
    2843: function (t, e, n) {
      ...
      var i = n(2857),
        ...
        l = null,
        d = null,
        f = Object(u["a"])(r.a, i["a"], i["b"], o, c, l, d);
      e["default"] = f.exports;
    },
    2857: function (t, e, n) {
      "use strict";
    ...
    2942: function (t, e, n) {
      ...
      e.default = {
        name: "SendCoinResult",
        components: { CoinIcon: r.default, RateStars: a.default },
        props: {
        ...
        methods: {
          ...
          talkWithSupport() {
            ...
            const s =
              ...
              u = {
                isNotText: !0,
                additionalText: `${this.$t("supportPopup.unsuccessSending")}${a}`,
                subject: s,
              };
            ...
            void 0 === n
              ? void 0
              : n.length) > 0 && (u.tags = this.contactData.tags),
              i[this.sendType] &&
                (u.additionalText = `${this.$t("sendProcess." + this.sendType)} ${this.$t("sendProcess.unsuccess")}${a}`),
              ["Activate", "ActivateAutoclaim"].includes(this.sendType) &&
                (u.additionalText = `${this.$t("supportPopup.unsuccessActivation")}${a}`),
              this.$bus.$emit("openSupportPopup", u));
          },
        },
      };
    },
            ...
            [
              t.isSuccess && !t.isError
                ? s(
                    ...
                    [
                      "DOGE" !== t.coin.ticker
                        ? s("CoinIcon", { attrs: { wallet: t.coin } })
                        : s("img", {
                            staticClass: "doge",
                            class: t.icon,
                            attrs: { src: n(3240) },
              ...
              t._v(" "),
              t.isError
                ? s("div", { staticClass: "submit failed" }, [
                    s(
                      "button",
                      {
