  ...
  [320],
  {
    3124: function (t, i, e) {
      ...
      (function (t) {
        ...
        (Object.defineProperty(i, "__esModule", { value: !0 }),
          (i.isValidXAddress =
            i.decodeXAddress =
            i.xAddressToClassicAddress =
            i.encodeXAddress =
            i.classicAddressToXAddress =
            i.isValidClassicAddress =
            i.decodeAccountPublic =
            i.encodeAccountPublic =
            i.decodeNodePublic =
            i.encodeNodePublic =
            i.decodeAccountID =
            i.encodeAccountID =
        ...
        const h = o(e(229)),
          s = e(5537);
        (Object.defineProperty(i, "codec", {
          enumerable: !0,
          get: function () {
            return s.codec;
          },
        }),
          Object.defineProperty(i, "encodeSeed", {
            enumerable: !0,
            get: function () {
              return s.encodeSeed;
            },
          }),
          Object.defineProperty(i, "decodeSeed", {
            enumerable: !0,
            get: function () {
              return s.decodeSeed;
            },
          }),
          Object.defineProperty(i, "encodeAccountID", {
            enumerable: !0,
            get: function () {
              return s.encodeAccountID;
            },
          }),
          Object.defineProperty(i, "decodeAccountID", {
            enumerable: !0,
            get: function () {
              return s.decodeAccountID;
            },
          }),
          Object.defineProperty(i, "encodeNodePublic", {
            enumerable: !0,
            get: function () {
              return s.encodeNodePublic;
            },
          }),
          Object.defineProperty(i, "decodeNodePublic", {
            enumerable: !0,
            get: function () {
              return s.decodeNodePublic;
            },
          }),
          Object.defineProperty(i, "encodeAccountPublic", {
            enumerable: !0,
            get: function () {
              return s.encodeAccountPublic;
            },
          }),
          Object.defineProperty(i, "decodeAccountPublic", {
            enumerable: !0,
            get: function () {
              return s.decodeAccountPublic;
            },
          }),
          Object.defineProperty(i, "isValidClassicAddress", {
            enumerable: !0,
            get: function () {
              return s.isValidClassicAddress;
            },
          }));
        const u = { main: t.from([5, 68]), test: t.from([4, 147]) },
          a = 4294967295;
        function l(t, i, e) {
          const r = (0, s.decodeAccountID)(t);
          return d(r, i, e);
        }
        function d(i, e, r) {
          if (20 !== i.length) throw new Error("Account ID must be 20 bytes");
          if (e > a) throw new Error("Invalid tag");
          const n = e || 0,
            o = !1 === e || null == e ? 0 : 1,
            h = t.concat([
              r ? u.test : u.main,
          ...
          return s.codec.encodeChecked(h);
        }
        function c(t) {
          const { accountId: i, tag: e, test: r } = f(t),
            n = (0, s.encodeAccountID)(i);
          return { classicAddress: n, tag: e, test: r };
        }
        function f(t) {
          const i = s.codec.decodeChecked(t),
            e = m(i),
            r = i.slice(2, 22),
            n = p(i);
          return { accountId: r, tag: n, test: e };
        }
        function m(t) {
          const i = t.slice(0, 2);
          if (u.main.equals(i)) return !1;
          if (u.test.equals(i)) return !0;
          throw new Error("Invalid X-address: bad prefix");
        }
        function p(i) {
          const e = i[22];
          if (e >= 2) throw new Error("Unsupported X-address");
          return 1 === e
            ? i[23] + 256 * i[24] + 65536 * i[25] + 16777216 * i[26]
            : (h.strictEqual(e, 0, "flag must be zero to indicate no tag"),
              h.ok(
                t.from("0000000000000000", "hex").equals(i.slice(23, 31)),
        ...
        ((i.classicAddressToXAddress = l),
          (i.encodeXAddress = d),
          (i.xAddressToClassicAddress = c),
          (i.decodeXAddress = f),
          (i.isValidXAddress = v));
    ...
    3602: function (t, i, e) {
      ...
      (function (i) {
        ...
        function m(t) {
          ...
          const i = t.entropy ? t.entropy.slice(0, 16) : n(16),
            e = "ed25519" === t.algorithm ? "ed25519" : "secp256k1";
          return s.encodeSeed(i, e);
        }
        function p(t) {
        ...
        const v = {
            deriveKeypair(t, i) {
              const e = "00",
                r = e + u.derivePrivateKey(t, i).toString(16, 64).toUpperCase(),
                n = f(
                  d.keyFromPrivate(r.slice(2)).getPublic().encodeCompressed(),
                );
              return { privateKey: r, publicKey: n };
            },
            sign(t, i) {
              return f(d.sign(p(t), c(i), { canonical: !0 }).toDER());
            },
            verify(t, i, e) {
              return d.verify(p(t), i, c(e));
            },
          },
          g = {
            deriveKeypair(t) {
              const i = "ED",
                e = p(t),
                r = i + f(e),
                n = i + f(l.keyFromSecret(e).pubBytes());
              return { privateKey: r, publicKey: n };
            },
            sign(t, i) {
              return (
                r(Array.isArray(t), "message must be array of octets"),
                f(l.sign(t, c(i).slice(1)).toBytes())
              );
            },
            verify(t, i, e) {
              return l.verify(t, c(i), c(e).slice(1));
            },
          };
        function M(t) {
          const i = { "ecdsa-secp256k1": v, ed25519: g };
          return i[t];
        }
        function y(t, i) {
          const e = s.decodeSeed(t),
            r = "ed25519" === e.type ? "ed25519" : "ecdsa-secp256k1",
            n = M(r),
            o = n.deriveKeypair(e.bytes, i),
            h = p("This test message should verify."),
            u = n.sign(h, o.privateKey);
          if (!0 !== n.verify(h, u, o.publicKey))
            throw new Error(
        ...
        function w(t) {
          const i = c(t);
          return 33 === i.length && 237 === i[0]
            ? "ed25519"
            : "ecdsa-secp256k1";
        }
        function b(t, i) {
          const e = w(i);
          return M(e).sign(c(t), i);
        }
        function _(t, i, e) {
          const r = w(e);
          return M(r).verify(c(t), i, e);
        }
        function A(t) {
          return s.encodeAccountID(a.computePublicKeyHash(t));
        }
        function k(t) {
          return A(i.from(c(t)));
        }
        function P(t) {
          const i = s.decodeNodePublic(t),
            e = u.accountPublicFromPublicGenerator(i);
          return A(e);
        }
        const { decodeSeed: x } = s;
        t.exports = {
          generateSeed: m,
          deriveKeypair: y,
          sign: b,
    ...
    4547: function (t, i, e) {
      (function (t) {
        (function (t, i) {
          ...
          function u(t, i, e) {
            var r = s(t, e);
            return (e - 1 >= i && (r |= s(t, e - 1) << 4), r);
          }
          function a(t, i, e, n) {
            for (
              var o = 0, h = 0, s = Math.min(t.length, e), u = i;
              u < s;
              u++
            ) {
          ...
          if (
            ...
            (o.prototype._parseHex = function (t, i, e) {
              ...
              var n,
                ...
                h = 0;
              if ("be" === e)
                for (r = t.length - 1; r >= i; r -= 2)
                  ((n = u(t, i, r) << o),
                    (this.words[h] |= 67108863 & n),
                    o >= 18
                      ? ((o -= 18), (h += 1), (this.words[h] |= n >>> 26))
                      : (o += 8));
              else {
                var s = t.length - i;
                for (r = s % 2 === 0 ? i + 1 : i; r < t.length; r += 2)
                  ((n = u(t, i, r) << o),
                    (this.words[h] |= 67108863 & n),
                    o >= 18
                      ? ((o -= 18), (h += 1), (this.words[h] |= n >>> 26))
            ...
            (o.prototype._parseBase = function (t, i, e) {
              ...
              for (var r = 0, n = 1; n <= 67108863; n *= i) r++;
              (r--, (n = (n / i) | 0));
              for (
                var o = t.length - e,
                  h = o % r,
              ...
              if (0 !== h) {
                var d = 1;
                for (u = a(t, l, t.length, i), l = 0; l < h; l++) d *= i;
                (this.imuln(d),
                  this.words[0] + u < 67108864
                    ? (this.words[0] += u)
                    : this._iaddn(u));
          ...
          ((o.prototype.toString = function (t, i) {
            ...
            if (t === (0 | t) && t >= 2 && t <= 36) {
              ...
              d.negative = 0;
              while (!d.isZero()) {
                var p = d.modrn(l).toString(t);
                ((d = d.idivn(l)),
                  (e = d.isZero() ? p + e : c[a - p.length] + p + e));
              }
              this.isZero() && (e = "0" + e);
              while (e.length % i !== 0) e = "0" + e;
              return (0 !== this.negative && (e = "-" + e), e);
          ...
          ((o.prototype.toArrayLike = function (t, i, e) {
            ...
            var h = p(t, o),
              s = "le" === i ? "LE" : "BE";
            return (this["_toArrayLike" + s](h, n), h);
          }),
            (o.prototype._toArrayLikeLE = function (t, i) {
              for (var e = 0, r = 0, n = 0, o = 0; n < this.length; n++) {
                var h = (this.words[n] << o) | r;
                ((t[e++] = 255 & h),
                  e < t.length && (t[e++] = (h >> 8) & 255),
                  e < t.length && (t[e++] = (h >> 16) & 255),
                  6 === o
                    ? (e < t.length && (t[e++] = (h >> 24) & 255),
                      (r = 0),
                      (o = 0))
                    : ((r = h >>> 24), (o += 2)));
              }
            ...
            (o.prototype.iuxor = function (t) {
              ...
              for (var r = 0; r < e.length; r++)
                this.words[r] = i.words[r] ^ e.words[r];
              if (this !== i)
                for (; r < i.length; r++) this.words[r] = i.words[r];
              return ((this.length = i.length), this._strip());
            }),
            ...
            (o.prototype.isub = function (t) {
              ...
              for (var o = 0, h = 0; h < r.length; h++)
                ((i = (0 | e.words[h]) - (0 | r.words[h]) + o),
                  (o = i >> 26),
                  (this.words[h] = 67108863 & i));
          ...
          function y(t, i, e) {
            ...
            for (var r = 0, n = 0, o = 0; o < e.length - 1; o++) {
              var h = n;
              n = 0;
              for (
                var s = 67108863 & r,
          ...
          (Math.imul || (M = g),
            ...
            (b.prototype.makeRBT = function (t) {
              for (
                var i = new Array(t), e = o.prototype._countBits(t) - 1, r = 0;
                r < t;
                r++
              )
                i[r] = this.revBin(r, e, t);
              return i;
            }),
            (b.prototype.revBin = function (t, i, e) {
              if (0 === t || t === e - 1) return t;
              for (var r = 0, n = 0; n < i; n++)
                ((r |= (1 & t) << (i - n - 1)), (t >>= 1));
              return r;
            }),
            (b.prototype.permute = function (t, i, e, r, n, o) {
              for (var h = 0; h < o; h++) ((r[h] = i[t[h]]), (n[h] = e[t[h]]));
            }),
            (b.prototype.transform = function (t, i, e, r, n, o) {
              this.permute(o, t, i, e, r, n);
              for (var h = 1; h < n; h <<= 1)
                for (
                  var s = h << 1,
            ...
            (b.prototype.conjugate = function (t, i, e) {
              if (!(e <= 1))
                for (var r = 0; r < e / 2; r++) {
                  var n = t[r];
                  ((t[r] = t[e - r - 1]),
            ...
            (b.prototype.normalize13b = function (t, i) {
              for (var e = 0, r = 0; r < i / 2; r++) {
                var n =
                  8192 * Math.round(t[2 * r + 1] / i) +
                  Math.round(t[2 * r] / i) +
                  e;
                ((t[r] = 67108863 & n),
            ...
            (b.prototype.convert13b = function (t, i, e, n) {
            ...
            (b.prototype.mulp = function (t, i, e) {
              var r = 2 * this.guessLen13b(t.length, i.length),
                n = this.makeRBT(r),
                o = this.stub(r),
                h = new Array(r),
                s = new Array(r),
              ...
              ((c.length = r),
                ...
                this.convert13b(i.words, i.length, a, r),
                this.transform(h, o, s, u, r, n),
                this.transform(a, o, l, d, r, n));
              for (var f = 0; f < r; f++) {
                var m = s[f] * l[f] - u[f] * d[f];
                ((u[f] = s[f] * d[f] + u[f] * l[f]), (s[f] = m));
              }
              return (
                this.conjugate(s, u, r),
                this.transform(s, u, c, o, r, n),
                this.conjugate(c, o, r),
            ...
            (o.prototype.pow = function (t) {
              ...
              for (var e = this, r = 0; r < i.length; r++, e = e.sqr())
                if (0 !== i[r]) break;
              if (++r < i.length)
                for (var n = e.sqr(); r < i.length; r++, n = n.sqr())
                  0 !== i[r] && (e = e.mul(n));
              return e;
            }),
              ...
              if (0 !== e) {
                ...
                for (i = 0; i < this.length; i++) {
                  var s = this.words[i] & o,
                    u = ((0 | this.words[i]) - s) << e;
                  ((this.words[i] = u | h), (h = s >>> (26 - e)));
                }
            ...
            (o.prototype._wordDiv = function (t, i) {
              ...
              var d = r.clone()._ishlnsubmul(n, 1, a);
              0 === d.negative && ((r = d), u && (u.words[a] = 1));
              for (var c = a - 1; c >= 0; c--) {
                var f =
                  67108864 * (0 | r.words[n.length + c]) +
                  (0 | r.words[n.length + c - 1]);
                ((f = Math.min((f / h) | 0, 67108863)),
                  r._ishlnsubmul(n, f, c));
                while (0 !== r.negative)
                  (f--,
                    (r.negative = 0),
            ...
            (o.prototype.egcd = function (t) {
              ...
              var n = new o(1),
                ...
                u = new o(1),
                a = 0;
              while (i.isEven() && e.isEven()) (i.iushrn(1), e.iushrn(1), ++a);
              var l = e.clone(),
                d = i.clone();
              while (!i.isZero()) {
                for (
                ...
                i.cmp(e) >= 0
                  ? (i.isub(e), n.isub(s), h.isub(u))
                  : (e.isub(i), s.isub(n), u.isub(h));
              }
            ...
            (o.prototype._invmp = function (t) {
              ...
              while (i.cmpn(1) > 0 && e.cmpn(1) > 0) {
                ...
                if (a > 0) {
                  i.iushrn(a);
                  while (a-- > 0) (h.isOdd() && h.iadd(u), h.iushrn(1));
                }
                for (
                  var d = 0, c = 1;
                  0 === (e.words[0] & c) && d < 26;
                ...
                if (d > 0) {
                  e.iushrn(d);
                  while (d-- > 0) (s.isOdd() && s.iadd(u), s.iushrn(1));
                }
            ...
            (o.prototype.gcd = function (t) {
              ...
              for (var r = 0; i.isEven() && e.isEven(); r++)
          ...
          ((A.prototype._tmp = function () {
            ...
            (A.prototype.ireduce = function (t) {
              ...
              var r = i < this.n ? -1 : e.ucmp(this.p);
              return (
                0 === r
            ...
            (k.prototype.split = function (t, i) {
              for (
                var e = 4194303, r = Math.min(t.length, 9), n = 0;
                n < r;
                n++
              )
                i.words[n] = t.words[n];
              ...
              var o = t.words[9];
              for (i.words[i.length++] = o & e, n = 10; n < t.length; n++) {
                var h = 0 | t.words[n];
                ((t.words[n - 10] = ((h & e) << 4) | (o >>> 22)), (o = h));
              }
              ((o >>>= 22),
                (t.words[n - 10] = o),
            ...
            (S.prototype.imulK = function (t) {
              for (var i = 0, e = 0; e < t.length; e++) {
                var r = 19 * (0 | t.words[e]) + i,
                  n = 67108863 & r;
                ((r >>>= 26), (t.words[e] = n), (i = r));
              }
            ...
            (B.prototype.sqrt = function (t) {
              ...
              var n = this.m.subn(1),
                h = 0;
              while (!n.isZero() && 0 === n.andln(1)) (h++, n.iushrn(1));
              r(!n.isZero());
              ...
              var d = this.pow(l, n),
                ...
                m = h;
              while (0 !== f.cmp(s)) {
                for (var p = f, v = 0; 0 !== p.cmp(s); v++) p = p.redSqr();
                r(v < m);
                var g = this.pow(d, new o(1).iushln(m - v - 1));
                ((c = c.redMul(g)),
                  (d = g.redSqr()),
                  (f = f.redMul(d)),
                  (m = v));
            ...
            (B.prototype.pow = function (t, i) {
              ...
              var h = r[0],
                ...
                u = 0,
                a = i.bitLength() % 26;
              for (0 === a && (a = 26), n = i.length - 1; n >= 0; n--) {
                for (var l = i.words[n], d = a - 1; d >= 0; d--) {
                  var c = (l >> d) & 1;
                  (h !== r[0] && (h = this.sqr(h)),
                    0 !== c || 0 !== s
                      ? ((s <<= 1),
    ...
    5537: function (t, i, e) {
      ...
      (function (t) {
        ...
        class Codec {
          constructor(t) {
            ((this._sha256 = t.sha256),
              (this._alphabet = t.alphabet),
              (this._codec = r(this._alphabet)));
          }
          encode(t, i) {
            const e = i.versions;
            return this._encodeVersioned(t, e, i.expectedLength);
          }
          decode(t, i) {
            var e;
            const r = i.versions,
              n = i.versionTypes,
              h = this.decodeChecked(t);
            if (r.length > 1 && !i.expectedLength)
              throw new Error(
                "expectedLength is required because there are >= 2 possible versions",
              );
            const s = "number" === typeof r[0] ? 1 : r[0].length,
              u =
                null !== (e = i.expectedLength) && void 0 !== e
                  ? e
                  : h.length - s,
              a = h.slice(0, -u),
              l = h.slice(-u);
            for (let d = 0; d < r.length; d++) {
              const t = Array.isArray(r[d]) ? r[d] : [r[d]];
              if ((0, o.seqEqual)(a, t))
                return { version: t, bytes: l, type: n ? n[d] : null };
            }
            throw new Error(
          ...
          encodeChecked(i) {
            const e = this._sha256(this._sha256(i)).slice(0, 4);
            return this._encodeRaw(t.from((0, o.concatArgs)(i, e)));
          }
          decodeChecked(t) {
            const i = this._decodeRaw(t);
            if (i.length < 5)
              throw new Error(
                "invalid_input_size: decoded data must have length >= 5",
              );
            if (!this._verifyCheckSum(i)) throw new Error("checksum_invalid");
            return i.slice(0, -4);
          }
          _encodeVersioned(i, e, r) {
            if (r && i.length !== r)
              throw new Error(
                "unexpected_payload_length: bytes.length does not match expectedLength. Ensure that the bytes are a Buffer.",
              );
            return this.encodeChecked(t.from((0, o.concatArgs)(e, i)));
          }
          _encodeRaw(t) {
            return this._codec.encode(t);
          }
          _decodeRaw(t) {
            return this._codec.decode(t);
          }
          _verifyCheckSum(t) {
            const i = this._sha256(this._sha256(t.slice(0, -4))).slice(0, 4),
              e = t.slice(-4);
            return (0, o.seqEqual)(i, e);
          }
        }
        const h = 0,
          s = 35,
          ...
          d = {
            sha256(i) {
              return n("sha256").update(t.from(i)).digest();
            },
            alphabet:
        ...
        function f(t, i) {
          ...
          const e = { expectedLength: 16, versions: "ed25519" === i ? l : [u] };
          return c.encode(t, e);
        }
        function m(t, i) {
          return (
        ...
        function p(t) {
          const i = { versions: [h], expectedLength: 20 };
          return c.encode(t, i);
        }
        function v(t) {
          const i = { versions: [h], expectedLength: 20 };
          return c.decode(t, i).bytes;
        }
        function g(t) {
          const i = { versions: [a], expectedLength: 33 };
          return c.decode(t, i).bytes;
        }
        function M(t) {
          const i = { versions: [a], expectedLength: 33 };
        ...
        function y(t) {
          const i = { versions: [s], expectedLength: 33 };
          return c.encode(t, i);
        }
        function w(t) {
          const i = { versions: [s], expectedLength: 33 };
        ...
        ((i.codec = c),
          ...
          (i.decodeAccountID = v),
          (i.decodeAddress = v),
          (i.decodeNodePublic = g),
          (i.encodeNodePublic = M),
          (i.encodeAccountPublic = y),
          (i.decodeAccountPublic = w),
          (i.isValidClassicAddress = b));
      }).call(this, e(2).Buffer);
    },
    5538: function (t, i, e) {
      "use strict";
      ...
      function o() {
        ...
        return (
          e.forEach((i) => {
            if (n(i)) for (const e of i) t.push(e);
            else t.push(i);
          }),
          t
        );
      ...
      (Object.defineProperty(i, "__esModule", { value: !0 }),
        (i.concatArgs = i.seqEqual = void 0),
        (i.seqEqual = r),
        (i.concatArgs = o));
    },
    5539: function (t, i, e) {
      "use strict";
      (Object.defineProperty(i, "__esModule", { value: !0 }),
        (i.accountPublicFromPublicGenerator = i.derivePrivateKey = void 0));
      const r = e(795),
        n = e(5540),
        o = r.ec("secp256k1");
      function h(t, i) {
        ...
        for (let r = 0; r <= 4294967295; r++) {
          ...
          (void 0 !== i && o.addU32(i), o.addU32(r));
          const h = o.first256BN();
          if (h.cmpn(0) > 0 && h.cmp(e) < 0) return h;
        }
      ...
      function s(t, i) {
        ...
        const s = o.g.mul(n),
          u = i.accountIndex || 0;
        return h(s.encodeCompressed(), u).add(n).mod(r);
      }
      function u(t) {
        const i = o.curve.decodePoint(t),
          e = h(t, 0),
          r = o.g.mul(e),
          n = i.add(r);
        return n.encodeCompressed();
      }
      ((i.derivePrivateKey = s), (i.accountPublicFromPublicGenerator = u));
    },
    5540: function (t, i, e) {
      "use strict";
      Object.defineProperty(i, "__esModule", { value: !0 });
    ...
    5542: function (t, i, e) {
      ...
      (function (t) {
        (Object.defineProperty(i, "__esModule", { value: !0 }),
          (i.computePublicKeyHash = i.hexToBytes = i.bytesToHex = void 0));
        const r = e(229),
          n = e(43),
          o = e(4547);
        function h(t) {
        ...
        function s(t) {
          return (
            r(t.length % 2 === 0),
            new o(t, 16).toArray(null, t.length / 2)
          );
        }
        function u(i) {
          const e = n.sha256().update(i).digest(),
            r = n.ripemd160().update(e).digest();
          return t.from(r);
        }
        ((i.bytesToHex = h), (i.hexToBytes = s), (i.computePublicKeyHash = u));
      }).call(this, e(2).Buffer);
    },
  },
]);
